...
EVERY_DAY_STAY_TIME = 180 * 60; --每天累计进入时间(单位:秒)
...
EMPEROR_PREPARE_MSG = 
{
	...
	[true] = {
		szTitle="女帝复苏",
		szContent = "诸位侠士，通往女帝疑塚深处的通道已被发现，诸位可火速前往，占得先机。",
		},
}
...
EMPEROR_ROOM_RECORD_MSG = 
{
	...
	[true] =  "玄武门竟忽然闭合，侠士本次女帝疑塚之旅，无法再前往其他[FFFE0D]【天后神都】[-]！",
}

EMPEROR_TICKET_MSG = 
{
	[false] = "秦始皇重现于世，墓中毒雾更甚，不可视物，请先寻找[FFFE0D]%s颗夜明珠[-]",
	[true] =  "女帝复苏，疑塚乌云密布，不可视物，难觅其踪，需备[FFFE0D]%s颗夜明珠[-]",
}

EMPEROR_BOSS_CALL_MSG = 
{
	[false] = "诸位侠士，秦始皇陵三层均出现暴动，秦之栋梁重生，可速速寻找入口，将之剿灭",
	[true] =  "诸位侠士，疑塚中有若干路口已然开启，幽暗隐秘，不知通往何处，可速速前去一探",
}

EMPEROR_CALL_MSG = 
{
	[false] = "如今天时已到，始皇已然苏醒，在皇陵最深处等待诸位觐见，还请诸位侠士通过三层入口前往永生台",
	[true] =  "如今天时已到，女帝已然复苏，降临於世，还请诸位找到真正的行宫入口，使之安息",
}
...
{
	[false] = "皇陵中竟设有疑塚，伪帝同样身怀重宝，尽可能击败他寻找出路！",
	[true] =  "无即是有，有即是无，虚幻真假，天象难测！尔等岂能窥破天机？",
}

EMPEROR_MIRROR_OUT_MSG = 
{
	[false] = "诸位侠士成功破解疑塚，始皇遭受重创，可乘机乘胜追击！",
