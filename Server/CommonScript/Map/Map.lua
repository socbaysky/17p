...
Map.tbMapList = Map.tbMapList or LoadTabFile("Setting/Map/maplist.tab", "dsssdsdddddddddsdddddsdddddsdddd", "TemplateId",
	...
	"CamDistance", "CamLookDownAngle", "CamFOV", "Excercise", "FightState", "MiniMap", "FocusAllPet", "ForbidTransEnter", "ForbidPeeking", "UiTopButtonType"});
