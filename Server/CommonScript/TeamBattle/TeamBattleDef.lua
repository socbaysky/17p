...
TeamBattle.nMinTeamCount = 2;		--最小开启队伍数量
...
TeamBattle.szTopKinNotify = "恭喜本帮派成员「%s」成功登顶通天塔第七层！";
TeamBattle.szTopKinNotify_Cross = "恭喜本帮派成员「%s」成功登顶跨服通天塔第八层！";
...
{
	[TeamBattle.TYPE_MONTHLY] = "恭喜本帮派成员「%s」成功登顶月度通天塔第八层！";
	[TeamBattle.TYPE_QUARTERLY] = "恭喜本帮派成员「%s」成功登顶季度通天塔第八层！";
	[TeamBattle.TYPE_YEAR] = "恭喜本帮派成员「%s」成功登顶年度通天塔第八层！";
}
...
·从通天塔的底层开始，每轮会随机匹配同处於本层的另一个队伍来进行挑战
...
TeamBattle.tbLeagueAward = {
	[TeamBattle.TYPE_MONTHLY] = {
		[1] = {{"BasicExp", 100}, {"Energy", 1500}, {"Gold", 300000}},
		[2] = {{"BasicExp", 120}, {"Energy", 1800}, {"Gold", 400000}},
		[3] = {{"BasicExp", 140}, {"Energy", 2000}, {"Gold", 500000}},
		[4] = {{"BasicExp", 150}, {"Energy", 2500}, {"Gold", 600000}},
		[5] = {{"BasicExp", 160}, {"Energy", 3000}, {"Gold", 800000}},
		[6] = {{"BasicExp", 180}, {"Energy", 4000}, {"Gold", 1000000}},
		[7] = {{"BasicExp", 200}, {"Energy", 5000}, {"Gold", 1500000}},
		[8] = {{"BasicExp", 220}, {"Energy", 7000}, {"Gold", 2000000}},
	};
	[TeamBattle.TYPE_QUARTERLY] = {
		[1] = {{"BasicExp", 100}, {"Energy", 3000}, {"Gold", 300000}},
		[2] = {{"BasicExp", 120}, {"Energy", 3500}, {"Gold", 400000}},
		[3] = {{"BasicExp", 140}, {"Energy", 4000}, {"Gold", 500000}},
		[4] = {{"BasicExp", 150}, {"Energy", 5000}, {"Gold", 600000}},
		[5] = {{"BasicExp", 160}, {"Energy", 6000}, {"Gold", 800000}},
		[6] = {{"BasicExp", 180}, {"Energy", 8000}, {"Gold", 1000000}},
		[7] = {{"BasicExp", 200}, {"Energy", 10000}, {"Gold", 1500000}},
		[8] = {{"BasicExp", 220}, {"Energy", 15000}, {"Gold", 2000000}},
	};
	[TeamBattle.TYPE_YEAR] = {
		[1] = {{"BasicExp", 100}, {"Energy", 9000}, {"Gold", 300000}},
		[2] = {{"BasicExp", 120}, {"Energy", 10500}, {"Gold", 400000}},
		[3] = {{"BasicExp", 140}, {"Energy", 12000}, {"Gold", 500000}},
		[4] = {{"BasicExp", 150}, {"Energy", 15000}, {"Gold", 600000}},
		[5] = {{"BasicExp", 160}, {"Energy", 18000}, {"Gold", 800000}},
		[6] = {{"BasicExp", 180}, {"Energy", 24000}, {"Gold", 1000000}},
		[7] = {{"BasicExp", 200}, {"Energy", 30000}, {"Gold", 1500000}},
		[8] = {{"BasicExp", 220}, {"Energy", 45000}, {"item", 7320, 1}, {"item", 7321, 1}, {"Gold", 2000000}},
	};
};

TeamBattle.tbStartFailMailInfo = {
	[TeamBattle.TYPE_MONTHLY] = {"月度通天塔开启失败", "      很遗憾，由於本场月度通天塔竞技比赛晋级玩家不足，导致不能正常举行比赛。现已为您准备了月度通天塔的最高奖励作为补偿，请查收。\n      望少侠再度征战通天塔，下一次能遇到旗鼓相当的对手，勇夺殊荣！"},
	[TeamBattle.TYPE_QUARTERLY] = {"季度通天塔开启失败", "      很遗憾，由於本场季度通天塔竞技比赛晋级玩家不足，导致不能正常举行比赛。现已为您准备了季度通天塔的最高奖励作为补偿，请查收。\n      望少侠再度征战通天塔，下一次能遇到旗鼓相当的对手，勇夺殊荣！"},
	[TeamBattle.TYPE_YEAR] = {"年度通天塔开启失败", "      很遗憾，由於本场年度通天塔竞技比赛晋级玩家不足，导致不能正常举行比赛。现已为您准备了年度通天塔的最高奖励作为补偿，请查收。\n      望少侠再度征战通天塔，下一次能遇到旗鼓相当的对手，勇夺殊荣！"},
};

TeamBattle.tbSpaceTipsMailInfo = {
	[TeamBattle.TYPE_MONTHLY] = {"月度通天塔参与失败", "      很遗憾，由於您在月度通天塔竞技比赛中，未能组满队伍，导致不能正常参与比赛。现已为您准备了月度通天塔的基础奖励，请查收。\n      望少侠下次准备充分，携手队友，再度征战通天塔！"},
	[TeamBattle.TYPE_QUARTERLY] = {"季度通天塔参与失败", "      很遗憾，由於您在季度通天塔竞技比赛中，未能组满队伍，导致不能正常参与比赛。现已为您准备了季度通天塔的基础奖励，请查收。\n      望少侠下次准备充分，携手队友，再度征战通天塔！"},
	[TeamBattle.TYPE_YEAR] = {"年度通天塔参与失败", "      很遗憾，由於您在年度通天塔竞技比赛中，未能组满队伍，导致不能正常参与比赛。现已为您准备了年度通天塔的基础奖励，请查收。\n      望少侠下次准备充分，携手队友，再度征战通天塔！"},
}
...
TeamBattle.STATE_TRANS =  --战场流程控制
{
	...
	{nSeconds = 20,   	szFunc = "ClcResult",		szDesc = "等待配对"},
}
...
TeamBattle.tbMsg =
{
	...
	[TeamBattle.emMsgMemberOffline]			= "有队员不线上，无法报名！";
	...
	[TeamBattle.emMsgSafeMap]				= "目前地图无法报名！";
	...
	[TeamBattle.emMsgSystemSwitch]			= "你目前状态不允许报名";
	[TeamBattle.emMsgMemberSystemSwitch]	= "「%s」目前状态不允许报名";
}
