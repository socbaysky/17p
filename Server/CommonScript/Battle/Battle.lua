...
Battle.tbAllBattleSetting = {
	...
	["BattleMonth"] =
	{
		...
		szQUalifyNotifyMsg = "恭喜您获得下个月的月度战场资格"; --获取资格时的提示文字
...
Battle.tbAllAwardSet = {
	...
	tbExtRandomAward = { --打完可能获得的随机奖励道具, 从高时间轴到低填写
		...
		{nRandEnd = 1,  Award = {{"BasicExp", 80}, {"BattleHonor", 2000}, {"Gold", 500000} } },  				--第1名的奖励
		{nRandEnd = 2,  Award = {{"BasicExp", 76}, {"BattleHonor", 1500}, {"Gold", 300000} } }, 						--第2名的奖励
		{nRandEnd = 5,  Award = {{"BasicExp", 72}, {"BattleHonor", 1200}, {"Gold", 200000} } },  				--第3-5名的奖励
		{nRandEnd = 10,  Award = {{"BasicExp", 68},{"BattleHonor", 1000}, {"Gold", 100000} } },  				--第6-10名的奖励
		{nRandEnd = 15,  Award = {{"BasicExp", 64},{"BattleHonor", 900}, {"Gold", 100000} } },   				--第11-15名的奖励
		{nRandEnd = 20,  Award = {{"BasicExp", 60},{"BattleHonor", 850}, {"Gold", 100000} } },    				--第16-20名的奖励
		{nRandEnd = 25,  Award = {{"BasicExp", 58},{"BattleHonor", 800}, {"Gold", 100000} } },    				--第21-25名的奖励
		{nRandEnd = 30,  Award = {{"BasicExp", 56},{"BattleHonor", 750}, {"Gold", 100000} } },   				--第26-30名的奖励
		{nRandEnd = 35,  Award = {{"BasicExp", 52},{"BattleHonor", 700}, {"Gold", 100000} } },   				--第31-35名的奖励
		{nRandEnd = 40,  Award = {{"BasicExp", 48},{"BattleHonor", 650}, {"Gold", 100000} } },  				--第36-40名的奖励
	},

	BattleAwardCross = { --如果分时间轴就后面带_1， 对应几档时间轴, 不分就不加
		{nRandEnd = 1,  Award = {{"BasicExp", 80}, {"BattleHonor", 3000}, {"Gold", 500000} } },   				--第1名的奖励
		{nRandEnd = 2,  Award = {{"BasicExp", 76}, {"BattleHonor", 2500}, {"Gold", 300000} } },   				--第2名的奖励
		{nRandEnd = 5,  Award = {{"BasicExp", 72}, {"BattleHonor", 2000}, {"Gold", 200000} } },    				--第3-5名的奖励
		{nRandEnd = 10,  Award = {{"BasicExp", 70},{"BattleHonor", 1600}, {"Gold", 100000} } },    				--第6-10名的奖励
		{nRandEnd = 15,  Award = {{"BasicExp", 68},{"BattleHonor", 1400}, {"Gold", 100000} } },    				--第11-15名的奖励
		{nRandEnd = 20,  Award = {{"BasicExp", 66},{"BattleHonor", 1300}, {"Gold", 100000} } },   				--第16-20名的奖励
		{nRandEnd = 25,  Award = {{"BasicExp", 64},{"BattleHonor", 1200}, {"Gold", 100000} } },    				--第21-25名的奖励
		{nRandEnd = 30,  Award = {{"BasicExp", 62},{"BattleHonor", 1100}, {"Gold", 100000} } },   				--第26-30名的奖励
		{nRandEnd = 35,  Award = {{"BasicExp", 60},{"BattleHonor", 1000}, {"Gold", 100000} } },   				--第31-35名的奖励
		{nRandEnd = 40,  Award = {{"BasicExp", 58},{"BattleHonor", 950}, {"Gold", 100000} } },   				--第36-40名的奖励
		{nRandEnd = 45,  Award = {{"BasicExp", 56},{"BattleHonor", 900}, {"Gold", 100000} } },   				--第41-45名的奖励
		{nRandEnd = 50,  Award = {{"BasicExp", 54},{"BattleHonor", 850}, {"Gold", 100000} } },   				--第46-50名的奖励
		{nRandEnd = 55,  Award = {{"BasicExp", 52},{"BattleHonor", 800}, {"Gold", 100000} } },   				--第51-55名的奖励
		{nRandEnd = 60,  Award = {{"BasicExp", 50},{"BattleHonor", 750}, {"Gold", 100000} } },  				--第56-60名的奖励
	},

	BattleAwardHundred = { --如果分时间轴就后面带_1， 对应几档时间轴, 不分就不加
		{nRandEnd = 1,  Award = {{"BasicExp", 80}, {"BattleHonor", 4000}, {"Gold", 500000} } },    				--第1名的奖励
		{nRandEnd = 2,  Award = {{"BasicExp", 78}, {"BattleHonor", 3500}, {"Gold", 300000} } },    				--第2名的奖励
		{nRandEnd = 5,  Award = {{"BasicExp", 76}, {"BattleHonor", 3000}, {"Gold", 200000} } },   				--第3-5名的奖励
		{nRandEnd = 10,  Award = {{"BasicExp", 74},{"BattleHonor", 2500}, {"Gold", 100000} } },    				--第6-10名的奖励
		{nRandEnd = 15,  Award = {{"BasicExp", 72},{"BattleHonor", 2000}, {"Gold", 100000} } },    				--第11-15名的奖励
		{nRandEnd = 20,  Award = {{"BasicExp", 70},{"BattleHonor", 1800}, {"Gold", 100000} } },   				--第16-20名的奖励
		{nRandEnd = 30,  Award = {{"BasicExp", 68},{"BattleHonor", 1600}, {"Gold", 100000} } },   				--第21-25名的奖励
		{nRandEnd = 40,  Award = {{"BasicExp", 66},{"BattleHonor", 1400}, {"Gold", 100000} } },  				--第26-30名的奖励
		{nRandEnd = 50,  Award = {{"BasicExp", 64},{"BattleHonor", 1300}, {"Gold", 100000} } },  				--第31-35名的奖励
		{nRandEnd = 60,  Award = {{"BasicExp", 62},{"BattleHonor", 1200}, {"Gold", 100000} } },  				--第36-40名的奖励
		{nRandEnd = 70,  Award = {{"BasicExp", 60},{"BattleHonor", 1100}, {"Gold", 100000} } },  				--第41-45名的奖励
		{nRandEnd = 80,  Award = {{"BasicExp", 58},{"BattleHonor", 1000}, {"Gold", 100000} } },  				--第46-50名的奖励
		{nRandEnd = 90,  Award = {{"BasicExp", 54},{"BattleHonor", 900}, {"Gold", 100000} } },  				--第51-55名的奖励
		{nRandEnd = 100,  Award = {{"BasicExp", 50},{"BattleHonor", 800}, {"Gold", 100000} } },  				--第56-60名的奖励
	},

	BattleAwardMonth = { --如果分时间轴就后面带_1， 对应几档时间轴, 不分就不加
		{nRandEnd = 1,  Award = {{"BasicExp", 80}, {"Energy", 10000}, {"Gold", 500000} } },  				--第1名的奖励
		{nRandEnd = 2,  Award = {{"BasicExp", 78}, {"Energy", 8500}, {"Gold", 300000} } },  				--第2名的奖励
		{nRandEnd = 5,  Award = {{"BasicExp", 76}, {"Energy", 7000}, {"Gold", 200000} } }, 				--第3-5名的奖励
		{nRandEnd = 10,  Award = {{"BasicExp", 74},{"Energy", 6000}, {"Gold", 100000} } },   				--第6-10名的奖励
		{nRandEnd = 15,  Award = {{"BasicExp", 72},{"Energy", 5000}, {"Gold", 100000} } },   				--第11-15名的奖励
		{nRandEnd = 20,  Award = {{"BasicExp", 70},{"Energy", 4000}, {"Gold", 100000} } },   				--第16-20名的奖励
		{nRandEnd = 25,  Award = {{"BasicExp", 68},{"Energy", 3000}, {"Gold", 100000} } },   				--第21-25名的奖励
		{nRandEnd = 30,  Award = {{"BasicExp", 66},{"Energy", 2500}, {"Gold", 100000} } },  				--第26-30名的奖励
		{nRandEnd = 35,  Award = {{"BasicExp", 64},{"Energy", 2000}, {"Gold", 100000} } },  				--第31-35名的奖励
		{nRandEnd = 40,  Award = {{"BasicExp", 62},{"Energy", 1600}, {"Gold", 100000} } },  				--第36-40名的奖励

	},

	BattleAwardSeason = {
		{nRandEnd = 1,  Award = {{"BasicExp", 120}, {"Energy", 25000}, {"Gold", 500000} } },              --第1名的奖励
        {nRandEnd = 2,  Award = {{"BasicExp", 114}, {"Energy", 21250}, {"Gold", 300000} } },               --第2名的奖励
        {nRandEnd = 5,  Award = {{"BasicExp", 108}, {"Energy", 17500}, {"Gold", 200000} } },               --第3-5名的奖励
        {nRandEnd = 10,  Award = {{"BasicExp", 102},{"Energy", 15000}, {"Gold", 100000} } },                 --第6-10名的奖励
        {nRandEnd = 15,  Award = {{"BasicExp", 96},{"Energy", 12500}, {"Gold", 100000} } },                 --第11-15名的奖励
        {nRandEnd = 20,  Award = {{"BasicExp", 90},{"Energy", 10000}, {"Gold", 100000} } },                 --第16-20名的奖励
        {nRandEnd = 25,  Award = {{"BasicExp", 87},{"Energy", 7500}, {"Gold", 100000} } },                 --第21-25名的奖励
        {nRandEnd = 30,  Award = {{"BasicExp", 84},{"Energy", 6250}, {"Gold", 100000} } },                 --第26-30名的奖励
        {nRandEnd = 35,  Award = {{"BasicExp", 78},{"Energy", 5000}, {"Gold", 100000} } },                 --第31-35名的奖励
        {nRandEnd = 40,  Award = {{"BasicExp", 72},{"Energy", 4000}, {"Gold", 100000} } },                 --第36-40名的奖励
        {nRandEnd = 60,  Award = {{"BasicExp", 70},{"Energy", 3000}, {"Gold", 100000} } },                 --第41-60名的奖励
	},

	BattleAwardYear = {
		{nRandEnd = 1,  Award = {{"BasicExp", 120}, {"Energy", 30000}, {"AddTimeTitle", 225, 3600*24*365, true}, {"Gold", 500000} } }, --第1名的奖励
		{nRandEnd = 2,  Award = {{"BasicExp", 114}, {"Energy", 28000}, {"Gold", 300000} } },                		  --第2名的奖励
		{nRandEnd = 5,  Award = {{"BasicExp", 108}, {"Energy", 26000}, {"Gold", 200000} } },              
		{nRandEnd = 10,  Award = {{"BasicExp", 102},{"Energy", 25000}, {"Gold", 100000} } },                 
		{nRandEnd = 15,  Award = {{"BasicExp", 96},{"Energy", 22000}, {"Gold", 100000} } },                 
		{nRandEnd = 20,  Award = {{"BasicExp", 90},{"Energy", 20000}, {"Gold", 100000} } },                 
		{nRandEnd = 30,  Award = {{"BasicExp", 90},{"Energy", 18000}, {"Gold", 100000} } },                 
		{nRandEnd = 40,  Award = {{"BasicExp", 90},{"Energy", 16000}, {"Gold", 100000} } },                 
		{nRandEnd = 50,  Award = {{"BasicExp", 90},{"Energy", 14000}, {"Gold", 100000} } },                 
		{nRandEnd = 60,  Award = {{"BasicExp", 90},{"Energy", 12000}, {"Gold", 100000} } },                 
		{nRandEnd = 70,  Award = {{"BasicExp", 90},{"Energy", 10000}, {"Gold", 100000} } },                 
		{nRandEnd = 80,  Award = {{"BasicExp", 90},{"Energy", 8000}, {"Gold", 100000} } },                 
		{nRandEnd = 90,  Award = {{"BasicExp", 90},{"Energy", 6000}, {"Gold", 100000} } },                 
		{nRandEnd = 100, Award = {{"BasicExp", 90},{"Energy", 5000}, {"Gold", 100000} } },                 
	},
}
...
function Battle:GetQualifyMatchTimeSeason(bNext)
	...
	if not self.nCahcheMatchTimeSeason then
    	...
    	self.nCahcheMatchTimeSeason = Lib:GetTimeByWeekInMonth(nSec, -1, 7, tbOpemTime.hour, tbOpemTime.min, 0)

    	local nSeason = math.ceil(tbTimeNow.month / 3)  + 1
    	local nSec = os.time({year = tbTimeNow.year, month = nSeason * 3, day = 1, hour = tbOpemTime.hour, min = tbOpemTime.min, sec = 0});
    	self.nCahcheMatchTimeSeasonNext = Lib:GetTimeByWeekInMonth(nSec, -1, 7, tbOpemTime.hour, tbOpemTime.min, 0)
	end
