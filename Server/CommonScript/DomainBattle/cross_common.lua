...
tbKinAward =
{
	["OpenLevel119"] =
	{
		...
		{szDesc="初级魂石·虞允文", nId=7377, nFactor = 2.0/12, nValue=4050000, Guarantee = 1},
		...
		{szDesc="帝皇令", nId=1396, nFactor = 1.5/12, nValue=3000000},
		--{szDesc="传说令", nId=1397, nFactor = 0.0/12, nValue=3600000},
		{szDesc="完颜洪烈(SSS)", nId=4056, nFactor = 3.0/12, nValue=18000000, Guarantee = 1},
	...
	["OpenLevel129"] =
	{
		...
		{szDesc="传说令", 					nId=1397, nFactor = 2.5/12, nValue=3600000, Guarantee = 1, SilverBoard = 1},
		{szDesc="完颜洪烈(SSS)", 			nId=4056, nFactor = 2.0/12, nValue=18000000},
		{szDesc="完颜洪烈本命武器", 		nId=4057, nFactor = 1.0/12, nValue=10000000},
	},
}
