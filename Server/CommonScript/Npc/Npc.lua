...
function Npc:OnDialog(szClassName, szParam)
	...
	local szDefaultText = Lib:IsEmptyStr(him.szDefaultDialogInfo) and "你找我什麽事？" or him.szDefaultDialogInfo
...
function Npc:ShowDefaultDialog(szClassName, szParam)
	if  Lib:IsEmptyStr(szClassName) or not self.tbClass[szClassName] then
		...
		if not szText then
			szText = Lib:IsEmptyStr(him.szDefaultDialogInfo) and "你找我什麽事？" or him.szDefaultDialogInfo;
		end
