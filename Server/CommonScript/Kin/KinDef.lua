...
nCreationCost            = 3888888; -- 家族创建开销，单位元宝
nChangeNameCost			 = 100000; --修改家族名开销，单位元宝
...
Kin.Def.CareerAuthorityName = {
	...
	[Kin.Def.Authority_EditRecuitInfo]    = "修改帮派宣言",
	[Kin.Def.Authority_Promotion]         = "小弟转正",
	[Kin.Def.Authority_Retire]            = "强制退隐",
	[Kin.Def.Authority_Building]          = "建筑升级",
	[Kin.Def.Authority_ChatForbid]        = "帮派禁言",
	[Kin.Def.Authority_Mail]              = "发送帮派信件",
	[Kin.Def.Authority_EditKinTitle]      = "修改职位称谓",
	[Kin.Def.Authority_EditPubilcDeclare] = "修改帮派公告",
	[Kin.Def.Authority_ChangeCamp]        = "修改帮派阵营";
};
...
Kin.GatherDef = {
	...
	MaxExtraExpBuff = 300;  --篝火经验的最大奖励倍数
	MaxExtraMemberExpBuff = 150; -- 篝火人数最大奖励倍数
	DrinkCost = 60; -- 喝酒价格，单位Gold
	DrinkReward = {{"Gold", 30000}};  --喝酒后的奖励
	...
	DicePriceMail = {
		To = nil; -- 手动填
		Title = "帮派骰子奖励";
		Text = "    恭喜少侠在帮派烤火活动中获得骰子排名奖励，附件是你的奖励。";
		From = "帮派总管";
		tbAttach = {
			{"item", 1307, 1},
		};
	...
	AnswerWrongRewardContrib = 5000; --答错奖励
