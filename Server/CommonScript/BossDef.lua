...
tbKinRewardRankScore = {
	...
	};
	{
		...
		tbRankScore = {
			...
			{Rank = 18, Score = 75000};
			{Rank = 24, Score = 65000};
			{Rank = math.huge, Score = 55000}; -- 41-无穷  0.6
		};
	};
	{
		...
		tbRankScore = {
			...
			{Rank = 8, Score = 110000};
			{Rank = 12, Score = 100000};
			{Rank = 18, Score = 80000};
			{Rank = 24, Score = 70000};
			{Rank = math.huge, Score = 60000}; -- 41-无穷  0.6
		};
	};
};
...
tbPlayerBoxRankScore = {
	{Rank = 1, Honor = 500000};  -- 第一名
	{Rank = 2, Honor = 300000};  -- 第二名
	{Rank = 10, Honor = 200000};
	{Rank = 20, Honor = 90000};
	{Rank = 50, Honor = 80000};
	{Rank = 100, Honor = 70000};
	{Rank = 200, Honor = 60000};
	{Rank = 400, Honor = 50000};
	{Rank = 700, Honor = 40000};
	{Rank = 1000, Honor = 30000};
	{Rank = math.huge, Honor = 20000};
};

-- 家族排名奖励
tbKinBoxRankScore = {
	{Rank = 1, Honor = 300000};  -- 第一名
	{Rank = 2, Honor = 240000};  -- 第二名
	{Rank = 4, Honor = 200000};  -- 第三名
	{Rank = 8, Honor = 170000};
	{Rank = 12, Honor = 150000};
	{Rank = 18, Honor = 120000};
	{Rank = 24, Honor = 100000};
...
tbAuctionRewards = {
	...
	};
	{
		...
		Rewards = {
					...
					{nRate = 0.1/5.5, Items = {4309}},						--4级金属
					{nRate = 0.25/5.5, Items = {4310}},						--5级金属							
					{nRate = 0.2/5.5, Items = {5822}},						--T12稀有衣服碎片
					{nRate = 1.55/5.5, Items = {1396}},						--帝皇令					
					{nRate = 1/5.5, Items = {3462}},						--赤金驭天绳碎片
					{nRate = 0.15/5.5, Items = {3461}},						--苍虹降龙绳碎片
					{nBossId = 634, nRate = 0.5/5.5, Items = {2668}},		--独孤剑魂石
	...
	};
	{
		...
		Rewards = {
					...
					{nRate = 0.1/5.5, Items = {4309}},						--4级金属
					{nRate = 0.25/5.5, Items = {4310}},						--5级金属							
					{nRate = 0.2/5.5, Items = {5823}},						--T13稀有衣服碎片
					{nRate = 1.55/5.5, Items = {1396}},						--帝皇令					
					{nRate = 1/5.5, Items = {3462}},						--赤金驭天绳碎片
					{nRate = 0.15/5.5, Items = {3461}},						--苍虹降龙绳碎片
					{nBossId = 634, nRate = 0.5/5.5, Items = {2668}},		--独孤剑魂石
	...
	};
	{
		...
		Rewards = {
					...
					{nRate = 0.1/5.5, Items = {4309}},						--4级金属
					{nRate = 0.25/5.5, Items = {4310}},						--5级金属							
					{nRate = 0.2/5.5, Items = {5824}},						--T14稀有衣服碎片
					{nRate = 1.55/5.5, Items = {1396}},						--帝皇令					
					{nRate = 1/5.5, Items = {3462}},						--赤金驭天绳碎片
					{nRate = 0.15/5.5, Items = {3461}},						--苍虹降龙绳碎片
					{nBossId = 634, nRate = 0.5/5.5, Items = {2668}},		--独孤剑魂石
