...
{
	[5] = {szKinMsg = "帮派成员[FFFE0D]「%s」[-]大显身手，在群英会中获得了[FFFE0D]5连胜[-]！#49"};
	[10] = {szKinMsg = "帮派成员[FFFE0D]「%s」[-]英勇无敌，在群英会中获得了[FFFE0D]10连胜[-]！#49#49"};
	[20] = {szKinMsg = "帮派成员[FFFE0D]「%s」[-]冠绝群雄，在群英会中获得了[FFFE0D]20连胜[-]！#49#49#49"};
}
...
QunYingHuiCross.szRankKinMsg = "恭喜帮派成员[FFFE0D]「%s」[-]英勇无敌！在群英会中荣获[FFFE0D]第%d名[-]！#49#49#49"
...
QunYingHuiCross.tbShowAward = {
	{{"ZhenQi", 500}, "[FFFE0D]目标奖励·首胜[-]\n获得1场胜利\n真气*500"};
	{{"ZhenQi", 500}, "[FFFE0D]目标奖励·十战[-]\n完成10场对战\n真气*500"};	
	{{"item", 2424, 1}, "[FFFE0D]胜负奖励·胜利[-]\n门派信物*2\n大量经验"};
	{{"item", 2424, 1}, "[FFFE0D]胜负奖励·惜败[-]\n门派信物*1\n大量经验"};	
	{{"item", 7380, 1}, "[FFFE0D]排名奖励[-]\n群英会黄金宝箱"};
}
