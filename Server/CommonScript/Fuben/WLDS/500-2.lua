...
tbFubenSetting.LOCK = 
{
	...
	[101] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"PlayerBubbleTalk", "霜儿，你怎麽了？看来霜儿受伤了，我们还是撤退吧！"},
		},
	},
	[102] = {nTime = 3, nNum = 0,
		tbPrelock = {{100, 101}},
	...
	[21] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "npc1", "吁，终於把这个大家伙打败了！", 3, 0, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[25] = {nTime = 5, nNum = 0,
		...
		tbStartEvent = 
		{
			{"OpenWindow", "StoryBlackBg", "你和霜儿终於护送丞相的棺椁冲过了这片艰险之地，临安就在眼前...", nil, 5, 1, 0},
		},
		tbUnLockEvent = 
		{
			{"GameWin"},
