...
tbFubenSetting.LOCK = 
{
	...
	[15] = {nTime = 3, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "Start_Npc2", "没事，外强中乾而已！", 3, 3.5, 1},
		},
	},
	[16] = {nTime = 0, nNum = 1,
		tbPrelock = {15},
	...
	[20] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "Start_Npc1", "这里什麽都没有的样子，好无聊！", 3, 0, 1},
			{"NpcBubbleTalk", "Start_Npc2", "真儿，你在找什麽呀？", 3, 1, 1},
		},
		tbUnLockEvent = 
		{
		},
	...
	[24] = {nTime = 2, nNum = 0,
		...
		tbStartEvent = 
		{
			{"NpcBubbleTalk", "Start_Npc1", "咦？这是什麽？", 3, 0, 1},
...
-------------------------------变身玩法---------------
	...
	[36] = {nTime = 4, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "Start_Npc2", "好像有什麽声音？", 3, 2.5, 1},
		},
		tbUnLockEvent = 
		{	
		},
