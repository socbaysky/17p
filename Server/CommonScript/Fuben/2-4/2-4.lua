...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{	
			...
			{"NpcBubbleTalk", "Yangyingfeng", "卓非凡！不必在我面前伪装了，我们刀剑下见真章！", 3, 2, 1},
			...
			{"NpcBubbleTalk", "Yangyingfeng", "废话少说，我们今日就来做个了断吧！", 4, 13, 1},
		},
	},
	[4] = {nTime = 10, nNum = 0,
		tbPrelock = {3},
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "继续探索心魔阵！"},
			{"NpcBubbleTalk", "Yangyingfeng", "这到底是怎麽回事.......", 6, 0, 1},
		},
	},
	[7] = {nTime = 0, nNum = 1,
		tbPrelock = {6},
	...
	[8] = {nTime = 8, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "Yangyingfeng1", "紫轩！紫轩！你怎麽啦？", 3, 8, 1},
		},
		tbUnLockEvent = 
		{
		},
