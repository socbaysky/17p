...
tbAct.szActStartMailText = [[         国庆日“神州大地”收集寻宝活动现已开启，活动时间为[FFFE0D]2018.10.1-2018.10.7[-]。
...
tbAct.szNewsText = [[
    国庆日“神州大地”收集寻宝活动开始了！
      ...
      参与等级：[FFFE0D]30级[-]
      活动期间内通过探寻线索收集25张地图分卷，集齐可合成[ff8f06] [url=openwnd:神州大地宝卷, ItemTips, "Item", nil, 6386] [-]，使用後有机会获得[ff8f06] [url=openwnd:SS级同伴挑选礼盒, ItemTips, "Item", nil, 3179] [-]、[ff8f06] [url=openwnd:SS级本命武器挑选礼盒, ItemTips, "Item", nil, 3693] [-]、[aa62fc] [url=openwnd:随机4级魂石, ItemTips, "Item", nil, 2169] [-]等稀世瑰宝！
      ...
      分卷及碎片全部收入[ff8f06] [url=openwnd:神州宝卷收纳盒, ItemTips, "Item", nil, 6468] [-]，少侠可在收纳盒中将指定碎片赠送给心仪的好友/帮派成员，也可以随机抢夺仇人/陌生人的碎片。但要注意的是一旦离线，少侠也将面临着被抢夺的危险。（活动结束後相关道具可进行过期出售，收纳盒中的碎片及分卷的价值将在出售收纳盒时一并计入）
