...
[eebb01]1、参与资格[-]
      ...
      已开69等级上限但是之前未开放华山论剑的伺服器资格获取方式为到达本服战力排行榜的[eebb01]前200名[-]。
...
[eebb01]2、赛制及时间[-]
    ...
    szNewsContentTime1 = "6月5日、6月6日";
    szNewsContentTime2 = "6月11日";
    szNewsContentTime3 = "6月7日、6月8日";
    szNewsContentTime4 = "6月12日";
    szNewsContentTime5 = "6月9日、6月10日";
    szNewsContentTime6 = "6月13日";
...
[eebb01]报名阶段[-]
    具有参赛资格的侠士，在这个阶段内自行与[eebb01]本服[-]其他侠士组成战队，在武林大会的专属介面报名各比赛。
    每位侠士最多参与[eebb01]2种[-]比赛，并且每个比赛可以有[eebb01]不同[-]的战队和队友。
    阶段结束後，[eebb01]不再允许创建战队[-]报名比赛，请各位大侠不要错过时间！
[eebb01]初赛阶段[-]
...
[eebb01]决赛阶段[-]
    ...
    决赛时，玩家可以对最终冠军进行[eebb01]竞猜[-]，正确後可以获得[eebb01]300元宝[-]奖励。


    ]==];


    szMailTextYuGao = "  大侠，江湖盛事武林大会即将开启，获得参与资格後可与知己好友组成战队与最顶尖的高手正面碰撞，登上擂台向各路豪杰展示你们的英雄气概吧！\n欲知详情，请点击前往[00ff00][url=openwnd:武林大会活动介面, WLDHJoinPanel][-]了解。";
    ...
    szEnterFinalQualifyMsgKin = "恭喜帮派成员[eebb01]%s[-]所在战队成功晋级本届武林大会[eebb01]%s[-]16强"; --晋级16强的家族提示
...
tbDef.tbPrepareGame = {
    szBeforeNotifyMsg = "【武林大会】[eebb01]%s初赛[-]将於[eebb01]3分钟[-]後开始，请参赛选手提前准备！";
    szPreOpenWorldMsg = "【武林大会】[eebb01]%s初赛[-]开始了，首场比赛将於3分钟後开始，请参赛选手尽快入场！";

    szWinNotifyInKin = "【武林大会】恭喜帮派成员[eebb01]%s[-]所在战队取得了一场[eebb01]%s初赛[-]胜利。";
...
tbDef.tbFinalsGame =
{
    szBeforeNotifyMsg = "【武林大会】[eebb01]%s冠军争夺战[-]将於[eebb01]3分钟[-]後开始，玩家可以进场支援心仪的参赛选手！";
    ...
    tbPlayGameState =
    {
        [1]  = 
        {
            ...
            szCall = "Freedom", 
            szRMsg = "比赛即将开始", 
            szWorld = "【武林大会】[eebb01]%s[-]冠军争夺战将在[eebb01]3分钟[-]後开始，玩家可以进场支援心仪的参赛选手！";
        };
         [2]  = 
        {   
            nNextTime = 150, 
            ...
            tbTeamMsg = 
            {
                tbWin = 
                {
                    ...
                    szKinMsg = "【武林大会】恭喜帮派成员[eebb01]%s[-]所在战队成功晋级[eebb01]%s[-]八强赛!";
        ...
        {   
            ...
            tbTeamMsg = 
            {
                tbWin = 
                {
                    ...
                    szKinMsg = "【武林大会】恭喜帮派成员[eebb01]%s[-]所在战队成功晋级[eebb01]%s[-]半决赛！";
        ...
        [6]  = 
        {
            ...
            tbTeamMsg = 
            {
                tbWin = 
                {
                    ...
                    szKinMsg = "【武林大会】恭喜帮派成员[eebb01]%s[-]所在战队成功晋级[eebb01]%s[-]决赛，冠军荣耀触手可及！";
        ...
        [12] = 
        {
            ...
            nPlan = 2;
            bCanStop = true;
            szWorld = "【武林大会】[eebb01]%s[-]决赛最後一场开始了，这真是宿命的对决！";
        };
        [13] = 
        {
            nNextTime = 60, 
