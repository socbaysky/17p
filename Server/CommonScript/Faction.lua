...
function Faction:Init()
	local tbParam = {"nId", "szName", "szSmallIcon", "szIcon", "szBigIcon", "szWordIcon", "szSelectIcon", "StatueNpc", "szBackground1", "szBackground2", "szShareBgTextureM", "szShareBgTextureF"};
	local szType = "dssssssdssss";
