...
function tbItem:GetTip(it)
	return "热气腾腾刚出炉的一大锅[FFFE0D]腊八粥[-]，前线的将士终於能感受到冬日的温暖了";
end
...
function tbItem:GetIntrol(nTemplateId, nItemId)
	...
	if not it then
		szTips = "用[FFFE0D]薏米仁[-]、[FFFE0D]桂圆[-]、[FFFE0D]莲子[-]、[FFFE0D]葡萄乾[-]、[FFFE0D]栗子[-]、[FFFE0D]红枣[-]、[FFFE0D]粳米[-]、[FFFE0D]核桃仁[-]做成，香气扑鼻，沁人心脾";
	else
