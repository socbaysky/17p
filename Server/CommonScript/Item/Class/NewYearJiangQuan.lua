...
tbItem.szNewYearOverdue = "2018-2-22-22-00-00"               -- 新年奖券过期时间
...
function tbItem:GetIntrol()
	...
	return string.format("使用後参与[FFFE0D]%s[-]抽奖，同时还将获得[FFFE0D]3月2日元宵抽大奖[-]的机会，点击[FFFE0D]预览[-]可以前去查看奖励内容。", szExeDate)
end
