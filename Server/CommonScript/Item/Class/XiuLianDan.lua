...
tbItem.nMaxAddOpenCount = 6;

tbItem.tbVipExtCount = --VIP每天多少次
{
    {nMin = 0; nMax = 13, nCount = 6};
    {nMin = 14; nMax = 30, nCount = 8};
};
...
{
    {
        nMin = 0,
        nMax = 10,
        szMsg = "使用後修炼珠增加[FFFE0D]30分钟[-]野外修炼时间，修炼丹[FFFE0D]每天4点[-]恢复[FFFE0D]1次[-]使用次数，最多可以累积[FFFE0D]6次[-]";
    };

    {
        nMin = 11,
        nMax = 13,
        szMsg = "使用後修炼珠增加[FFFE0D]30分钟[-]野外修炼时间，修炼丹[FFFE0D]每天4点[-]恢复[FFFE0D]1次[-]使用次数，最多可以累积[FFFE0D]3次[-]。\n升级尊14每天可使用次数增加[FFFE0D]6次[-]";
    };

    {
        nMin = 14,
        nMax = 30,
        szMsg = "使用後修炼珠增加[FFFE0D]30分钟[-]野外修炼时间，修炼丹[FFFE0D]每天4点[-]恢复[FFFE0D]2次[-]使用次数，最多可以累积[FFFE0D]8次[-]";
    };
};
