...
tbItem.tbBookInfo =
{
--- 道具的ID  最大使用次数  添加的技能点  存储的ID改变通知程序-------paulf20181228
    [1430] = {nMaxCount = 10, nAddPoint = 1, nSaveID = 1};
	[1431] = {nMaxCount = 10, nAddPoint = 1, nSaveID = 2};
	[1432] = {nMaxCount = 5, nAddPoint = 1, nSaveID = 3};
	[1454] = {nMaxCount = 10, nAddPoint = 3, nSaveID = 4};
