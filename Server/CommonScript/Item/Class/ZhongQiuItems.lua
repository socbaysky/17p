...
function tbItem:OnUse(it)
	...
	local szMsg = string.format("玩家%s为帮派成员献上了香甜美味的【%s】，获得了%d贡献的奖励！同时真诚的说：“丹桂飘香又中秋，花好月圆人长久！衷心祝福我们的帮派团圆美满，更加辉煌！", me.szName, it.szName, self.nAddContrib)
