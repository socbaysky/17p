...
tbItem.tbRandEventRateRaw = {
	...
	{ 1640, "FnFindAttackNpc", 3157, 5, 5, 7};  --发现攻击npc，npcId,nNpcCount，奖励随机数量范围， NpcId 需要是没有class的
	{ 820, "FnFindAttackNpc", 3158, 1, 11, 13, "帮派成员「%s」在探寻线索时战胜了强大的碎片护卫，获得了[FFFE0D]%d张分卷碎片[-]。#49"};  --发现npc，npcId,nNpcCount，奖励随机数量范围
	--对话npc，npcId, 道具id， 获得个数，价格，延迟删除时间， 对话内容, 家族频道提示   对话npc 的className 需要是CollectAndRobClueDialog
	{ 1440, "FnFindDialogNpc", 3159, 6414, 5, 58, 180, "少侠我看你非等闲之辈，是否在寻找神州大地宝卷？我这里有[FFFE0D]5张乾坤分卷碎片[-]，便宜点卖给你，就58元宝怎麽样？遇到我可是你的幸运哦！", "帮派成员「%s」在探寻线索时遇到了游走四方的江湖行商，幸运的买到了[FFFE0D]%d张乾坤分卷碎片[-]！" };  
