...
--- 策划填写------------------------------------paulf20181228
tbDef.nAddExpPercent = 15000; --击杀野怪的经验倍率
tbDef.nAddDropPercent = 1000; --击杀野怪的掉落的增加倍率
tbDef.nPerDayAddTime = 6*60 * 60; --一天增加的修炼时间
...
tbDef.nMaxOpenTime = 6 * 60 * 60; --玩家身上最多开启时间
tbDef.nPerOpenXiuLianTime = 30 * 60; --每次开启时间
tbDef.nXiuLianLevel = 24; --获得修炼珠等级
tbDef.tbMailItem = {{"item", 1422, 1},{"item", 1927, 5}}; --发送修炼珠
tbDef.nXiuLianExpTiLi = 10000; --每30分钟经验上限（体力基准经验）
tbDef.nJingYingRateCount = 30;  --每30分钟最多3只精英享有10次掉落
tbDef.nJingYingDropCount = 100; --精英的掉落数
...
function XiuLian:OnPlayerLevelUp(pPlayer, nLevel)
    ...
    Mail:SendSystemMail({
        To = pPlayer.dwID,
        Title = "修炼珠",
        Text = [==[    能提升150倍野外打怪修炼速度的神奇珠子，江湖人称之为【修炼珠】。修炼珠每天4:00自动恢复5小时的修炼时间，最多只能累积70小时的修炼时间，且修炼状态只在“野外地图”击杀野怪时生效。]==],
        From = "纳兰真",
