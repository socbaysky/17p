...
RankActivity.LEVEL_RANK_REWARD_LEVEL    = 99 							-- 需达到的等级
RankActivity.tbRankLevelReward = { 										-- 等级排名奖励
	[1] = {1, {{"Item", 1378, 1},{"Gold", 2000000}, {"AddTimeTitle", 5060, 30*24*60*60}}}, 		-- N名以下（包括N名）的奖励
	[2] = {10,  {{"Gold", 1000000}, {"AddTimeTitle", 5061, 30*24*60*60}}},
	[3] = {100, {{"Gold", 500000},  {"AddTimeTitle", 5062, 30*24*60*60}}},
} 					
...
RankActivity.tbRankPowerReward =  										-- 战力排名各门派奖励
{
	...
	[15] = {
		{1,{{"AddTimeTitle", 5020, 30*24*60*60}}},	
	},																	--15 = 天山	
	[16] = {
		{1,{{"AddTimeTitle", 5021, 30*24*60*60}}},	
	},																	--16 = 霸刀	
	[17] = {
		{1,{{"AddTimeTitle", 5022, 30*24*60*60}}},	
	},																	--17 = 华山	
}
...
RankActivity.tbPowerRankShowReward = 						 			-- 战力排名界面显示奖励
{
	...
	[15] = {
			{{"Item", 6520, 1}, {"Item", 1126, 1}},
		  },															--天山
	[16] = {
			{{"Item", 7532, 1}, {"Item", 1126, 1}},
		  },															--霸刀
	[17] = {
			{{"Item", 8394, 1}, {"Item", 1126, 1}},
		  },															--华山												
}
