ZhenFa.GROUP = 76
ZhenFa.tbJueYao = {
    {szCheckFn = "CheckFriend",         nStrengthLv = 1,  nCurExp = 2,  nCurItemTID = 3,  nAttribIdx = 4,  nCurLevel = 5,  tbDesc = {"队内有1个好友数量时启动：", "队内有2个好友数量时启动：", "队内有3个好友数量时启动："}},
    {szCheckFn = "CheckTeacherStudent", nStrengthLv = 11, nCurExp = 12, nCurItemTID = 13, nAttribIdx = 14, nCurLevel = 15, tbDesc = {"队内有1个自身的师傅或徒弟时启动：", "队内有2个自身的师傅或徒弟时启动：", "队内有3个自身的师傅或徒弟时启动："}},
    {szCheckFn = "CheckSwornFriends",   nStrengthLv = 21, nCurExp = 22, nCurItemTID = 23, nAttribIdx = 24, nCurLevel = 25, tbDesc = {"队内有自身结拜兄弟时启动："}},
    {szCheckFn = "CheckBiWuZhaoQin",    nStrengthLv = 31, nCurExp = 32, nCurItemTID = 33, nAttribIdx = 34, nCurLevel = 35, tbDesc = {"队内有自身情缘时启动："}},
    {szCheckFn = "CheckKin",            nStrengthLv = 41, nCurExp = 42, nCurItemTID = 43, nAttribIdx = 44, nCurLevel = 45, tbDesc = {"队内有1个本帮派成员时启动：", "队内有2个本帮派成员时启动：", "队内有3个本帮派成员时启动："}},
    {szCheckFn = "CheckMarriage",       nStrengthLv = 51, nCurExp = 52, nCurItemTID = 53, nAttribIdx = 54, nCurLevel = 55, tbDesc = {"队内有自身侠侣时启动："}},
}
