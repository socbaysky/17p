...
ChouJiang.tbDayAward = 
{
    ["OpenLevel39"] = 
    {
         [1] = {
            ...
            {[1] = 1, [2] = {{"item", 7441, 1}}, [3] = false, [4] = false, [5] = true, [6] = true, [7] = {5,12}},   ----全满足条件
            {[1] = 1, [2] = {{"item", 7441, 1}}, [3] = false, [4] = false, [5] = true, [7] = {5,12}},               ----仅不满足周卡状态
    ...
    ["OpenLevel79"] = 
    {
         [1] = {
            ...
            -- [7] = vip限制{min,max}
            -- 可以配置多条数量一样条件逐步放宽，只会抽一条配置的数量（*每行条件数量要保持一致，除非有特殊需求）
            {[1] = 1, [2] = {{"item", 7442, 1}}, [3] = false, [4] = false, [5] = true, [6] = true, [7] = {5,12}},   ----全满足条件
            {[1] = 1, [2] = {{"item", 7442, 1}}, [3] = false, [4] = false, [5] = true, [7] = {5,12}},               ----仅不满足周卡状态
    ...
    ["OpenLevel89"] = 
    {
         [1] = {
            ...
            -- [7] = vip限制{min,max}
            -- 可以配置多条数量一样条件逐步放宽，只会抽一条配置的数量（*每行条件数量要保持一致，除非有特殊需求）
            {[1] = 1, [2] = {{"item", 2795, 1}}, [3] = false, [4] = false, [5] = true, [6] = true, [7] = {5,12}},   ----全满足条件
            {[1] = 1, [2] = {{"item", 2795, 1}}, [3] = false, [4] = false, [5] = true, [7] = {5,12}},               ----仅不满足周卡状态
    ...
    ["OpenLevel109"] = 
    {
         [1] = {
            ...
            -- [7] = vip限制{min,max}
            -- 可以配置多条数量一样条件逐步放宽，只会抽一条配置的数量（*每行条件数量要保持一致，除非有特殊需求）
            {[1] = 1, [2] = {{"item", 2794, 1}}, [3] = false, [4] = false, [5] = true, [6] = true, [7] = {5,12}},   ----全满足条件
            {[1] = 1, [2] = {{"item", 2794, 1}}, [3] = false, [4] = false, [5] = true, [7] = {5,12}},               ----仅不满足周卡状态
    ...
    ["OpenLevel119"] = 
    {
         [1] = {
            ...
            -- [7] = vip限制{min,max}
            -- 可以配置多条数量一样条件逐步放宽，只会抽一条配置的数量（*每行条件数量要保持一致，除非有特殊需求）
            {[1] = 1, [2] = {{"item", 6148, 1}}, [3] = false, [4] = false, [5] = true, [6] = true, [7] = {5,12}},   ----全满足条件
            {[1] = 1, [2] = {{"item", 6148, 1}}, [3] = false, [4] = false, [5] = true, [7] = {5,12}},               ----仅不满足周卡状态
...
ChouJiang.tbBigAward = 
{
    ...
    {
        [1] = {
            [1] = {[1] = 1, [2] = {{"item", 7446, 1}}, [3] = true, [4] = false, [5] = true, [6] = false},      
        };
        [2] = {
            [1] = {[1] = 2, [2] = {{"item", 7449, 1}}, [3] = true, [4] = false, [5] = true, [6] = false},
        };
        [3] = {
            [1] = {[1] = 3, [2] = {{"item", 7452, 1}}, [3] = true, [4] = false, [5] = true, [6] = false},
        };
        [4] = {
            [1] = {[1] = 10, [2] = {{"item", 3180, 1}}, [3] = true, [4] = false, [5] = false, [6] = false},
        };
...
ChouJiang.tbBigShowAward = 
{
    ...
    {"OpenLevel139", {
        [1] = {szRankSprite = "Reword_04",szEggSprite = "icon_egg04",szCount= "共1名",tbAward = {"item", 7446, 1}};
        [2] = {szRankSprite = "Reword_01",szEggSprite = "icon_egg03",szCount= "共2名",tbAward = {"item", 7449, 1}};
        [3] = {szRankSprite = "Reword_02",szEggSprite = "icon_egg02",szCount= "共3名",tbAward = {"item", 7452, 1}};
        [4] = {szRankSprite = "Reword_03",szEggSprite = "icon_egg01",szCount= "共10名",tbAward = {"item", 3180, 1}};
        [5] = {szCount= "共50名",tbAward = {"item", 2165, 1}};
        [6] = {szCount= "共100名",tbAward = {"Contrib", 10000}};
        [7] = {tbAward = {"item", 3738, 1}};
