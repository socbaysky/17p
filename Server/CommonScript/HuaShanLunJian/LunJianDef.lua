...
tbDef.tbPrepareGame =
{
    szStartWorldNotify = "今日华山论剑将於3分钟後开启报名，请大家提前准备！";
...
tbDef.tbFinalsGame =
{
    szInformFinals = "恭喜少侠所在战队进入八强，成功晋级。决赛将於[FFFE0D]本月28日21：30[-]举行，请准时参加！"; --八强邮件内容
    nMonthDay = 28; --决赛日期
    ...
    tbPlayGameState =
    {
        [1]  = 
        {
            ...
            szCall = "Freedom", 
            szRMsg = "比赛即将开始", 
            szWorld = "本届华山论剑冠军争夺战将在[FFFE0D]5分钟[-]後开始，玩家可以进场支援心仪的参赛选手！";
        };
        [2]  = 
        {   
            nNextTime = 150, 
            ...
            tbTeamMsg = 
            {
                tbWin = 
                {
                    ...
                    szKinMsg = "恭喜帮派成员「%s」所在战队成功晋级华山论剑半决赛！";
        ...
        [4]  = 
        {
            ...
            tbTeamMsg = 
            {
                tbWin = 
                {
                    ...
                    szKinMsg = "恭喜帮派成员「%s」所在战队成功晋级华山论剑决赛，冠军荣耀触手可及！";
        ...
        [10] = 
        {
            ...
            nPlan = 2;
            bCanStop = true;
            szWorld = "本届华山论剑[FFFE0D]决赛最後一场[-]开始了，这真是宿命的对决！";
...
[[  本届华山论剑[FFFE0D]八强[-]已经产生，将於[FFFE0D]本月28日21：30[-]举行最终决赛，届时大家可以进入决赛地图观战。当前已经开启[FFFE0D]冠军竞猜[-]活动，请查看最新消息相应介面！
]]
