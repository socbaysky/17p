...
SendBless.tbActSetting = {
    [1] = { --普天同庆祝福函
        ...
        szItemUseName = "双十祝福";
        szMailTitle = "普天同庆"; 
        szMailText = "少侠，江湖路远，您也结交了很多武林同道吧？值此双十佳节，或许应该给他们送去诚挚的祝福，邀请他们一起欢度这个节日吧。这张“[FFFE0D]普天同庆祝福函[-]”可以帮你收集和送出祝福，请查收。详细内容请查阅[url=openwnd:最新消息, NewInformationPanel, 'SendBlessAct']相关页面。";
        szGetBlessMsgNormal = "恭喜您获得了来自好友「%s」的双十祝福！";
        szGetBlessMsgGold = "大惊喜！获得来自好友「%s」的特别双十祝福";
        szSendBlessMsg = "您向好友「%s」送出了双十的祝福！";
        ...
        [FFFE0D]1、祝福函[-]
            ...
            在祝福介面可对好友送出祝福，对方能获得[FFFE0D]祝福值[-]。根据条件不同（如祝福方头衔、双方亲密等级、帮派及师徒关系等）能获得[FFFE0D]额外祝福值[-]，进行[FFFE0D]元宝祝福[-]也能额外获得祝福值。
        ...
        [FFFE0D]3、活动奖励[-]
            ...
            ·达到5：  [FFFE0D]可领取5000黎饰[-]
            ·达到10： [FFFE0D]可领取5000黎饰[-]
            ·达到20： [FFFE0D]可领取5000黎饰[-]
            ·达到30： [FFFE0D]可领取5000黎饰[-]
            ·达到40： [FFFE0D]可领取5000黎饰[-]
            ·达到50： [FFFE0D]可领取6000黎饰[-]
            ·达到60： [FFFE0D]可领取6000黎饰[-]
            ·达到70： [FFFE0D]可领取6000黎饰[-]
            ·达到80： [FFFE0D]可领取6000黎饰[-]
            ·达到90： [FFFE0D]可领取6000黎饰[-]
            ·达到100：[FFFE0D]可领取6000黎饰[-]
    ...
    [2] = { ----新年送祝福函
        ...
        [FFFE0D]参与等级：[-]20级
            ...
            使用祝福函后，在祝福介面可对好友送出祝福，同时对方能获得[FFFE0D]祝福宝箱[-]。每轮活动，每个玩家最多获得[FFFE0D]10个[-]祝福宝箱。
...
SendBless.tbTakeAwardSet = {  --手动领取奖励
    {nScore = 5,  tbAward = {"SilverBoard", 5000 } },
    {nScore = 10, tbAward = {"SilverBoard", 5000 } },
    {nScore = 20, tbAward = {"SilverBoard", 5000 } },
    {nScore = 30, tbAward = {"SilverBoard", 5000 } },
    {nScore = 40, tbAward = {"SilverBoard", 5000 } },
    {nScore = 50, tbAward = {"SilverBoard", 6000 } },
    {nScore = 60, tbAward = {"SilverBoard", 6000 } },
    {nScore = 70, tbAward = {"SilverBoard", 6000 } },
    {nScore = 80, tbAward = {"SilverBoard", 6000 } },
    {nScore = 90, tbAward = {"SilverBoard", 6000 } },
    {nScore = 100, tbAward = {"SilverBoard", 6000 } },
};
