...
InDifferBattle.tbBattleTypeSetting = {
        ...
        Month  = { 
            ...
            szNotOpenMailContent = "亲爱的少侠：\n由於本次心魔幻境参与人数不足，而无法正常开启，我们将给予全部受影响的少侠发放对应补偿奖励。如给您造成不便，还请谅解。"
        };
        Season = { 
            szName = "季度";
            -- NextType = "Year";
...
来提升能力
    ...
    ActJueDi = {
      ...
      tbUiShowItemList = { --报名界面上展示的奖励
        {"Contrib", 0}, {"Energy",0}, {"Coin",0}
      };
      szNewInfomation = [[
      绝地试炼开始了！
      活动时间：[c8ff00]%s-%s[-]
      活动期间每天下午大侠都可以在规定时间内无限制次数进入[FFFE0D]心魔绝地[-]的战场，与其他侠士同台竞技！
      每天[FFFE0D]13:26[-]开启第一场报名，[FFFE0D]13:30[-]开始第一场比赛，此后每经过[FFFE0D]10分钟[-]的准备时间都会开启一场比赛，[FFFE0D]15:50[-]开启最后一场报名。
      大侠每天前[FFFE0D]3[-]次参与活动会获得奖励；整个活动期间会取大侠所有参与比赛积分中获得的[FFFE0D]3[-]次最高的且不为[FFFE0D]0[-]的积分作为依据发放最终结算奖励，奖励规则如下：
      1~5分          2000元气   10000银两
      6~15分        4000元气   20000银两  1000贡献
      16~31分      5000元气   40000银两  2000贡献
      32~47分      6000元气   50000银两  3000贡献
      48~95分      8000元气   60000银两  4000贡献
      96分及以上   10000元气  80000银两  5000贡献
      活动截止时大侠的[FFFE0D]3[-]次最好成绩可按照以上规则获得[FFFE0D]3[-]份奖励。
      [FFFE0D]注：绝地试炼参与次数不与正常心魔冲突，不会启动武林荣誉，不会触发红包。[-]
      ]];
      szFianalMailContent = "大侠在此次绝地试炼活动中取得的三次最好成绩积分为%s，这是您的奖励，请查收。"; --最终排名的奖励邮件
      nRankAwardNum = 1000; --能有最终积分奖励的排名数
      tbFinnalAwardSetting = {
        --从高到低
        { nScoreMin = 96,   tbAward = {{"Contrib", 5000}, {"Energy",10000}, {"Coin",80000} } }; 
        { nScoreMin = 48,   tbAward = {{"Contrib", 4000}, {"Energy",8000}, {"Coin",60000} } }; 
        { nScoreMin = 32,   tbAward = {{"Contrib", 3000}, {"Energy",6000}, {"Coin",50000} } };
        { nScoreMin = 16,   tbAward = {{"Contrib", 2000}, {"Energy",5000}, {"Coin",40000} } }; 
        { nScoreMin = 6,   tbAward = {{"Contrib", 1000}, {"Energy",4000}, {"Coin",20000} } }; 
        { nScoreMin = 1,   tbAward = {{"Energy",2000}, {"Coin",10000} } };  
      };
    };
};
--------------以上为绝地版流程-------------------
...
·幻境中所有侠士固定[FFFE0D]80级、不携带同伴、初始拥有相同的战力水准[-]，门派将在幻境开始后从[FFFE0D]随机6个[-]中选择。
...
·幻境中共有25个区域，分4个阶段进行，阶段结束后会进行休整并关闭若干区域。第4阶段将在最后一个区域进行决战，最终将以[FFFE0D]队伍存活人数、队伍总积分、存活队员总战力[-]判定优胜队伍。
	...
	szChooseFactionTip = [[
*若未选定门派，幻境开始后将自动随机选择
*所有侠士固定[FFFE0D]80级、不携带同伴、初始拥有相同的战力水准[-]
...
*幻境中仅有[FFFE0D]1条命[-]，队伍成员存活最多的队伍将获得优胜
    ...
    tbGetHonorSetting = {  --积分获得对应荣誉设定
        { nScoreMin = 0,   
                            tbAwardNormal = { {"IndifferHonor", 1200}, { "BasicExp", 50 }, { "SilverBoard", 50000 } }; 
                            tbAwardJueDi = { {"IndifferHonor", 1200}, { "BasicExp", 50 }, { "SilverBoard", 50000 } }; 
                            tbAwardMonth = { {"IndifferHonor", 4000}, { "BasicExp", 50 }, { "SilverBoard", 50000 } }; 
                            tbAwardSeason = { {"IndifferHonor", 8000}, { "BasicExp", 50 }, { "SilverBoard", 50000 } }; 
                            tbAwardYear = { {"IndifferHonor", 4000}, { "BasicExp", 50 }, { "SilverBoard", 50000 } };    
                            tbAwardActJueDi = { { "BasicExp", 20 }, { "SilverBoard", 50000 } };    
                            };
        { nScoreMin = 6,   
                            tbAwardNormal = { {"IndifferHonor", 1500}, { "BasicExp", 60 }, { "SilverBoard", 100000 } }; 
                            tbAwardJueDi = { {"IndifferHonor", 1500}, { "BasicExp", 60 }, { "SilverBoard", 100000 } }; 
                           tbAwardMonth = { {"IndifferHonor", 6000}, { "BasicExp", 60 }, { "SilverBoard", 100000 } }; 
                           tbAwardSeason = { {"IndifferHonor", 12000}, { "BasicExp", 60 }, { "SilverBoard", 100000 } }; 
                           tbAwardYear = { {"IndifferHonor", 6000}, { "BasicExp", 60 }, { "SilverBoard", 100000 } };  
                           tbAwardActJueDi = { { "BasicExp", 40 }, { "SilverBoard", 100000 } };    
                           };
        { nScoreMin = 16,  
                            tbAwardNormal = { {"IndifferHonor", 2000}, { "BasicExp", 70 }, { "SilverBoard", 120000 } }; 
                            tbAwardJueDi = { {"IndifferHonor", 2000}, { "BasicExp", 70 }, { "SilverBoard", 120000 } }; 
                           tbAwardMonth = { {"IndifferHonor", 8000}, { "BasicExp", 70 }, { "SilverBoard", 120000 } }; 
                           tbAwardSeason = { {"IndifferHonor", 16000}, { "BasicExp", 70 }, { "SilverBoard", 120000 } };
                           tbAwardYear = { {"IndifferHonor", 8000}, { "BasicExp", 70 }, { "SilverBoard", 120000 } };    
                           tbAwardActJueDi = { { "BasicExp", 50 }, { "SilverBoard", 120000 } };    
                           };
        { nScoreMin = 32,  
                            tbAwardNormal = { {"IndifferHonor", 2500}, { "BasicExp", 80 }, { "SilverBoard", 150000 } }; 
                            tbAwardJueDi = { {"IndifferHonor", 2500}, { "BasicExp", 80 }, { "SilverBoard", 150000 } }; 
                           tbAwardMonth = { {"IndifferHonor", 10000}, { "BasicExp", 80 }, { "SilverBoard", 150000 } };
                           tbAwardSeason = { {"IndifferHonor", 20000}, { "BasicExp", 80 }, { "SilverBoard", 150000 } }; 
                           tbAwardYear = { {"IndifferHonor", 10000}, { "BasicExp", 80 }, { "SilverBoard", 150000 } };    
                           tbAwardActJueDi = { { "BasicExp", 60 }, { "SilverBoard", 150000 } };    
                           };
        { nScoreMin = 48,  
                            tbAwardNormal = { {"IndifferHonor", 3000}, { "BasicExp", 100 }, { "SilverBoard", 180000 } };
                            tbAwardJueDi = { {"IndifferHonor", 3000}, { "BasicExp", 100 }, { "SilverBoard", 180000 } };
                           tbAwardMonth = { {"IndifferHonor", 12000}, { "BasicExp", 100 }, { "SilverBoard", 180000 } };
                           tbAwardSeason = { {"IndifferHonor", 24000}, { "BasicExp", 100 }, { "SilverBoard", 180000 } };
                           tbAwardYear = { {"IndifferHonor", 12000}, { "BasicExp", 100 }, { "SilverBoard", 180000 } };   
                           tbAwardActJueDi = { { "BasicExp", 80 }, { "SilverBoard", 180000 } };    
                           };
        { nScoreMin = 96,  
                            tbAwardNormal = { {"IndifferHonor", 4000}, { "BasicExp", 100 }, { "SilverBoard", 200000 } };
                            tbAwardJueDi = { {"IndifferHonor", 4000}, { "BasicExp", 100 }, { "SilverBoard", 200000 } };
                           tbAwardMonth = { {"IndifferHonor", 16000}, { "BasicExp", 100 }, { "SilverBoard", 200000 } };
                           tbAwardSeason = { {"IndifferHonor", 32000}, { "BasicExp", 100 }, { "SilverBoard", 200000 } };
                           tbAwardYear = { {"IndifferHonor", 16000}, { "BasicExp", 100 }, { "SilverBoard", 200000 } };    
                           tbAwardActJueDi = { { "BasicExp", 100 }, { "SilverBoard", 200000 } };   
                           };
    };
    ...
    tbEvaluationSetting = { --积分对应评价
        ...
        { nScoreMin = 32, szName = "优秀", szColor = "aa62fc"   };
