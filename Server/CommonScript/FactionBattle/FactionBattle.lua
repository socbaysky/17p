...
{
	[1] = {szTitle = "掌门的贺信",szText = "    做得很好！你已经历生死较量，又得军心所向！此後你就是我天王的大师兄，勤加练习，将来必能成为名动一方的豪侠，只是切勿沾沾自喜，与同门相处也莫要盛气凌人，将无兵卒，又有何用？谨记。"},
	...
	[4] = {szTitle = "掌门的贺信",szText = "    做得不错，此番较技，称得上是潇洒自如，而与诸位同门之间的情谊，也助你成就今日之名。既身为大师兄，自然是样样都要强於同门，此事虽不易，然既入我门下，理应如此，否则如何能逍遥自在？"},
	[5] = {szTitle = "掌门的贺信",szText = "    如今战火不断，天下纷乱，值此多事之秋，吾派能够有你如此杰出的弟子，实在令老道欣慰，将来这掌门之位，不免从你们这些年轻弟子中选中，还望你除了修行武功，更需修心养性，切不可过於自负。"},
	...
	[8] = {szTitle = "掌门的贺信",szText = "    卿之技艺，已日渐成熟，同门翘楚甚多，却独你一人青出於蓝而胜於蓝，行走江湖，四处历练之际，需多加小心，莫要轻易相信他人，男女皆然。还有，照顾好那只小家伙，它才是你最忠诚的同伴。"},
	[9] = {szTitle = "掌门的贺信",szText = "    哼，你既身为唐门子弟，理应为唐家堡名扬武林尽一份力，总算是你天资颇佳，不负我等期望，去吧，要记住，韬光养晦如此之久，而你，要成为青年名侠中的翘楚，方乃我唐门踏出武林的第一步。"},
	[10] = {szTitle = "掌门的贺信",szText = "   不错不错，我昆仑韬光养晦如此之久，近些年来总算是出了这般优秀的子弟，你长年累月在这极寒之地修炼，着实不易，而今能在众多同门中脱颖而出，绝非侥幸，还得多在江湖走动，日後必成大器。"},
	[11] = {szTitle = "掌门的贺信",szText = "   丐帮自创立以来，数百年来被称为天下第一大帮，靠的并非冠绝武林的功夫，除了武林同道给面子，最重要的便是帮众弟子相互扶持，你既是其中翘楚，更应谨守此道，戒骄戒躁，方能一方有难，八方支援。"},
	[12] = {szTitle = "掌门的贺信",szText = "   哼，我等偏居一隅，却叫中原武林小瞧，道什麽五毒教，如此也好，如今你学艺有成，是教中年轻一辈掌控五圣蛊最嫺熟者，也是时候还以颜色，让那些中原蛮子知道我教中五圣的厉害！去吧，记住，一切小心！"},
	[13] = {szTitle = "掌门的贺信",szText = "   我藏剑山庄始于唐而兴于唐，如今经历卓非凡之祸，武林对於藏剑颇有微辞，然此并非武学衰败，亦非我藏剑无人，如今你身负重振藏剑之名的重任，还望你此後仗剑江湖，能够处处留心，让江湖众人都知道，我藏剑山庄，剑心依旧。"},
	[14] = {szTitle = "掌门的贺信",szText = "   长歌始于唐，原本乃风雅之地，承蒙各路文人异客集思广益，悟得独到武学，以此创立长歌，如今你已是门中第一人，还望你莫忘初心，习武之余，切不可放下一门技艺，此乃长歌区别於他派之根本。"},
	[15] = {szTitle = "掌门的贺信",szText = "   本派的武功融会各家之长，精深博大，只因僻处西陲，名头才不如他派响亮，如今你是同门中武功最高之人，还望你多加修炼，为扬名本派做好坚实的基础。"},
	[16] = {szTitle = "掌门的贺信",szText = "   哈哈哈，我霸刀山庄能有你如此出色的弟子，实在是我庄的福气，我们埋名养晦那麽多年，重振庄名就要依靠你们这些年轻弟子了。"},
	[17] = {szTitle = "掌门的贺信",szText = "   如今战火不断，天下纷乱，值此多事之秋，吾派能够有你如此杰出的弟子，实在令老道欣慰，将来这掌门之位，不免从你们这些年轻弟子中选中，还望你除了修行武功，更需修心养性，切不可过於自负。"},
}
