...
Strengthen.DAY_MAX_ENHANCE_COUNT = 100; --每件装备每天只能强化20次
...
Strengthen.tbUseScucessItemAddProb = {
	...
	{ nMinEnhanceLevel = 100; nMaxEnhanceLevel = 119, 	nAddProb = 0.1 }; 
}
...
function Strengthen:CanStrengthen(pPlayer, nEquipPos, nEquipLevel, bNotChechMoney)
...
function Strengthen:GetCurMaxUseAddProbItem( pPlayer, nEquipPos )
	...
	return math.min(math.ceil(n1) , nHasCount) 
end
