...
AddictionTip.szUrl = "http://jxqy.maasapi.idip.tencent-cloud.net:12280/aas.fcg";

AddictionTip.nRetryTimes = 1;
AddictionTip.nMaxBatchCount = 128;

AddictionTip.szOnceGameTips = "您当前已连续线上%s，请注意休息！";
AddictionTip.szAccumuTips = "您今日已累积线上%s，请注意休息！";

AddictionTip.szOnceGameForceLogoutTips = "已经连续游戏很久了，需要休息至 %s";
AddictionTip.szAccumuForceLogoutTips = "当日累积游戏时间过长，需要休息至 %s";
AddictionTip.szCurfewTips = "当前处於宵禁时段，持续至 %s";
AddictionTip.szBanTips = "当前处於禁玩时段，持续至 %s";
