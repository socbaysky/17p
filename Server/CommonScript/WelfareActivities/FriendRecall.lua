...
{
	szTitle = [[许久不见，如今安好？
   往日征战江湖的夥伴，是否渐行渐远，如今功成名就，是否想与他们同享喜悦？若有此心，不若行动，通过Facebook和LINE找到他们，一同再战江湖！]],

   	szDesc = [[
规则&奖励说明
  1、与被召回侠士组队完成[FFFE0D]组队秘境、淩绝峰、山贼秘窟、惩恶任务、心魔幻境、通天塔[-]时将额外获得名望
...
规则&奖励说明
     ...
     2、55级以上的侠士可以通过主介面的回归福利按钮领取老玩家回归的奖励
