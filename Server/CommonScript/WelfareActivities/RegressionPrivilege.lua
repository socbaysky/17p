...
RegressionPrivilege.DOUBLE_ACT            = {
    ...
    KinGather                             = {nSaveKey = 27, nMaxSaveKey = 40, nDayPer = 1.25, szMsg = "帮派答题回归特权额外奖励",
                                             tbUiInfo = {szTitle = "烤火答题奖励翻倍", szContent = "帮派烤火答题时获得双倍贡献", szBtnContent = "查看活动", bCloseMyself = true, szBtnUrl = "[url=openwnd:test, CalendarPanel, 1, 18]"}},
...
RegressionPrivilege.RECHARGE_AWARD        = { --充值额外奖励（nSaveKey不能修改）
                               { nSaveKey = 30, nShowPro = 2, nDayPer = 3,  nRechargeIdx = 1, szContent = "0.99$回归元宝礼包"},
                               { nSaveKey = 31, nShowPro = 1, nDayPer = 30, nRechargeIdx = 2, szContent = "3.99$回归元宝礼包"},
                               { nSaveKey = 32, nShowPro = 5, nDayPer = 6,  nRechargeIdx = 3, szContent = "0.99$超值回归礼包"},
                               { nSaveKey = 33, nShowPro = 4, nDayPer = 2,  nRechargeIdx = 4, szContent = "0.99$超值福利礼包"},
                               { nSaveKey = 34, nShowPro = 3, nDayPer = 4,  nRechargeIdx = 5, szContent = "3.99$超值豪华礼包"},
}
