...
Gift.tbBoxNotice = 
{
	...
	[Gift.Sex.Boy] = 
	{
		...
		[Gift.Sex.Girl] = "「%s」拿出藏在背後已久的【%s】送给「%s」，说道：此花只应天上有，不及佳人一回眸。最珍贵的花亦远不如你，故此花非你莫属。",
	},
	-- 赠送放是女的
	[Gift.Sex.Girl] = 
	{
...
function Gift:LoadSetting()
	...
	local szParamType = "sssdddddddssdddd";
	local szKey = "szKey";
	local tbParams = {"szKey","szId","szGirlId","nTimesType","nReset","nTimes","nItemSend","nItemAccept","nSure","nImityLevel","szSureTip","szUseTip","nVip","nAddImitity","nNotSendMail","nNotConsume"};
...
function Gift:GetItemShowName(nItemId, nMyFaction, nMySex, nFaction, nSex)
	local szMyItemName = KItem.GetItemShowInfo(nItemId, nMyFaction, nMySex) or ""
	local szItemName = KItem.GetItemShowInfo(nItemId, nFaction, nSex) or ""
