...
DegreeCtrl.tbSetting = {
	...
	DonationCount       = { {32,  1}, {32, 	2}, "Day", 		"4:00", 	0, 				"帮派捐献次数"},
	KinNestDay      	= { {35,  1}, {35,  2},	"Day", 		"0:00",		4,				"帮派巢穴奖励"},
	ActivityQuestion    = { {28,  15}, {28, 16},"Day", 		"4:00", 	1, 				"每日答题次数"},
	CommerceTask    	= { {33,  1}, {33, 2}, 	"Day", 		"4:00", 	1, 				"商会任务次数"},
	KinRobReward        = { {36,  1}, {36, 	2}, "Day", 		"00:00", 	4, 				"帮派盗贼奖励"},
	KinTask     		= { {40,  1}, {40, 	2}, "Day", 		"4:00", 	10, 			"帮派任务"},
	--XiuLianDan     		= { {92,  1}, {92, 	2}, "Day", 		"4:00", 	1, 				"修炼丹的次数"},
	XinDeBook     		= { {114,  1}, {114, 2}, "Day", 	"00:00", 	10, 			"心得书的次数"},
	WhiteTigerFuben    	= { {46,  1}, {46, 	2}, "Day", 		"4:00", 	1, 				"白虎堂次数"},
	...
	Muse     			= { {131, 1}, {131,  2},"Day", 		"4:00",		10,				"冥想次数"}, -------paulf20181228
	PlantCure     		= { {133, 1}, {133,  2},"Day", 		"4:00",		1,				"植物养护次数"}, 
