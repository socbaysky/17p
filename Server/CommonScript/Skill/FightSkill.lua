...
--技能组ID  最大使用数量   增加上限  保存位置      等级需求         消耗的道具ID           消耗的道具数量        时间轴限制
    [2]  = {nMaxCount = 5, nAdd = 1, nSaveID =  1, nRequireLv = 110, nConsumeItemID = 2424, nConsumeItemNum = 30, szTimeFrame = "OpenLevel119"};
    [3]  = {nMaxCount = 5, nAdd = 1, nSaveID =  2, nRequireLv = 110, nConsumeItemID = 2424, nConsumeItemNum = 30, szTimeFrame = "OpenLevel119"};
    [4]  = {nMaxCount = 5, nAdd = 1, nSaveID =  3, nRequireLv = 110, nConsumeItemID = 2424, nConsumeItemNum = 30, szTimeFrame = "OpenLevel119"};
    [6]  = {nMaxCount = 5, nAdd = 1, nSaveID =  4, nRequireLv = 110, nConsumeItemID = 2424, nConsumeItemNum = 30, szTimeFrame = "OpenLevel119"};

    [5]  = {nMaxCount = 5, nAdd = 1, nSaveID =  5, nRequireLv = 120, nConsumeItemID = 2424, nConsumeItemNum = 30, szTimeFrame = "OpenLevel129"};
    [7]  = {nMaxCount = 5, nAdd = 1, nSaveID =  6, nRequireLv = 120, nConsumeItemID = 2424, nConsumeItemNum = 30, szTimeFrame = "OpenLevel129"};
    [8]  = {nMaxCount = 5, nAdd = 1, nSaveID =  7, nRequireLv = 120, nConsumeItemID = 2424, nConsumeItemNum = 30, szTimeFrame = "OpenLevel129"};

    [9]  = {nMaxCount = 5, nAdd = 1, nSaveID =  8, nRequireLv = 130, nConsumeItemID = 2424, nConsumeItemNum = 30, szTimeFrame = "OpenLevel139"};
    [11] = {nMaxCount = 5, nAdd = 1, nSaveID =  9, nRequireLv = 130, nConsumeItemID = 2424, nConsumeItemNum = 30, szTimeFrame = "OpenLevel139"};
    [12] = {nMaxCount = 5, nAdd = 1, nSaveID = 10, nRequireLv = 130, nConsumeItemID = 2424, nConsumeItemNum = 30, szTimeFrame = "OpenLevel139"};
}
...
function FightSkill:CheckUseItemBreak(pPlayer, nLevelUpGroup)
    ...
    if pPlayer.nLevel < tbInfo.nRequireLv then
        return false, string.format("%d级之後可使用道具提升该技能最大等级", tbInfo.nRequireLv)
    end
...
function FightSkill:CheckShowSKillUpper(pPlayer, nSkillId)
    local tbSkillInfo = FightSkill:GetSkillFactionInfo(nSkillId)
    if not tbSkillInfo or not tbSkillInfo.LevelUpGroup then
        return
    end

    local tbInfo = self.tbDirectBreakMaxLv[tbSkillInfo.LevelUpGroup]
    if not tbInfo then
        return
    end

    if (pPlayer.nLevel < tbInfo.nRequireLv) or
        (not Lib:IsEmptyStr(tbInfo.szTimeFrame) and
        GetTimeFrameState(tbInfo.szTimeFrame) ~= 1) then
        return
    end

    local nCount = pPlayer.GetUserValue(self.nSaveLevelGroup, tbInfo.nSaveID)
    return nCount < tbInfo.nMaxCount
end