...
local tb    = {
    ...
    tw_xzbf_child1 = {--血战八方_子1--15级
		attack_usebasedamage_p={{{1,186},{15,242},{20,262}}},
		attack_metaldamage_v={
			[1]={{1,186*2*0.9},{15,242*2*0.9},{20,262*2*0.9}},
			[3]={{1,186*2*1.1},{15,242*2*1.1},{20,262*2*1.1}}
		},
	...
	tw_book2 = { --血战八方秘籍
		add_usebasedmg_p1={211,{{1,3},{10,30},{15,40},{20,40}}},		--增加攻击力,初始伤害调低了,受伤一开始也算进去了,这里给的是10级数值+初始额外降低的值
    ...
    tw_90_qgbh = {--气盖八荒-90级被动7（光环）--10级
		lifemax_p={{{1,8},{10,80},{11,88}}},
		--lifemax_v={{{1,1200},{10,4800},{11,5000}}},
		userdesc_101={{{1,4},{10,40},{11,44}}},				--增加队友光环的描述
		skill_statetime={3*15},
    },
    tw_90_qgbh_team = {--气盖八荒_队友--10级
		lifemax_p={{{1,4},{10,40},{11,44}}},
