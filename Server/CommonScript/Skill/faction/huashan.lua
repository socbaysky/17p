...
local tb    = {
	...
	hs_xscl = {--萧史乘龙
		...
		check_buff_superpose={4988,3},			--3点剑意才能使用

		userdesc_000={4978},				--萧史乘龙伤害,剑意获得间隔
		userdesc_101={2*15},				--萧史乘龙伤害,剑意获得间隔
	},
	hs_xscl_child1 = {--萧史乘龙_伤害
		attack_usebasedamage_p={{{1,268},{15,359},{20,392}}},
		attack_wooddamage_v={
			[1]={{1,268*2*0.9},{15,359*2*0.9},{20,392*2*0.9}},
			[3]={{1,268*2*1.1},{15,359*2*1.1},{20,392*2*1.1}}
		},
	...
	hs_xscl_cost = {--萧史乘龙_扣除剑意
		mult_skill_state={4988,1,-3}, 		--扣除3点剑意
		skill_statetime={1},
	},
	...
	hs_book1 = {--萧史乘龙秘籍_20级
		--增加会心
		add_deadlystrike_p1={4978,{{1,2},{10,25},{20,25}}},

		--冲刺后获得免控buff
		addstartskill={
			{{1,0},{10,0},{11,4978},{20,4978}},
			{{1,0},{10,0},{11,4891},{20,4891}},
			{{1,0},{10,0},{11,11},{20,20}}
		},

		--增加攻击力
		add_usebasedmg_p1={4978,{{1,0},{15,0},{16,6},{20,33}}},
	...
	hs_book2 = {--天绅倒悬秘籍_20级
		--结束时造成致缠和延长目标技能cd
		add_buffendskill1={{{1,4981},{20,4981}},{{1,4892},{20,4892}},{{1,1},{20,20}}},

		--增加天绅倒悬的吸血
		add_steallife_p={4980,{{1,0},{10,0},{11,1000},{15,5000},{20,5000}}},
	...
	hs_cyyqj = {--朝阳一气剑_15级
		attack_usebasedamage_p={{{1,184},{15,382},{20,453}}},
		attack_wooddamage_v={
			[1]={{1,184*2*0.9},{15,382*2*0.9},{20,453*2*0.9}},
			[3]={{1,184*2*1.1},{15,382*2*1.1},{20,453*2*1.1}}
		},
	...
	hs_cyyqj_charge = {--朝阳一气剑_15级_获得剑意
		mult_skill_state={4988,1,3}, 		--获得3点剑意
		skill_statetime={1},
	},

	hs_charge1 = {--通用_获得1剑意
		mult_skill_state={4988,1,1}, 		--获得3点剑意
		skill_statetime={1},
	},
	hs_book3 = {--朝阳一气剑_20级
		--提高伤害,造成减速
		add_usebasedmg_p1={4982,{{1,5},{10,50},{20,50}}},
		add_hitskill_pos1={4982,4893,{{1,1},{20,20}}},

		--自身获得buff
		addstartskill={
			{{1,0},{10,0},{11,4984},{20,4984}},
			{{1,0},{10,0},{11,4894},{20,4894}},
			{{1,0},{10,0},{11,11},{20,20}}
		},
	...
	hs_book3_child2 = {--会伤加成
		deadlystrike_damage_p={{{1,0},{10,0},{11,12},{15,60},{20,60}}},
		skill_statetime={6*15},
	},
	hs_book3_child3 = {--清cd
		reduce_cd_time_point1={4982,15*15,1},		--刷新天绅倒悬cd
	},
	...
	hs_fszx = {--风送紫霞
		...
		check_buff_superpose={4988,5},			--5点剑意才能使用

		userdesc_000={4986},				--萧史乘龙伤害,剑意获得间隔
	},
	hs_fszx_cost = {--扣除剑意
		mult_skill_state={4988,1,-5}, 		--扣除5点剑意
		
		skill_statetime={1},
	},
	hs_fszx_detonate = {--引爆紫霞剑气
		hitfilter_buff={4876},								--有剑气才能击中,然后hitskill是范围伤害,从而每层爆一次伤害
		mult_skill_state={4876,1,-1}, 		--扣除1层剑气
	...
	hs_fszx_dmg = {--风送紫霞_伤害
		...
		attack_usebasedamage_p={{{1,64},{15,113},{20,131}}},
		attack_wooddamage_v={
			[1]={{1,64*2*0.9},{15,113*2*0.9},{20,131*2*0.9}},
			[3]={{1,64*2*1.1},{15,113*2*1.1},{20,131*2*1.1}}
		},
	...
	hs_book4 = {--风送紫霞秘籍
		...
		--伤害加成
		add_usebasedmg_p1={4986,{{1,0},{10,0},{11,3},{15,18},{20,18}}},
	...
	hs_sp = {--识破_10级
		add_deadlystrike_p1={4980,{{1,1},{10,10},{15,25}}},
		addstartskill={4980,4991,{{1,1},{15,15}}},
		skill_statetime={-1},

		userdesc_000={4991,4992},
	},
	hs_sp_child1 = {--识破_10级
	...
	hs_sp_child2 = {--识破_10级
		reduce_cd_time_point1={4980,{{1,1*15},{10,4*15},{11,4*15}},1},		--减少天绅倒悬cd
		mult_skill_state={4988,1,3}, --回复剑意
	...
	hs_gjjf = { --高级剑法
		add_skill_level={4972,{{1,1},{10,10},{11,11}},0},
		add_skill_level2={4973,{{1,1},{10,10},{11,11}},0},
		add_skill_level3={4974,{{1,1},{10,10},{11,11}},0},
		add_skill_level4={4975,{{1,1},{10,10},{11,11}},0},
	...
	hs_ythg= {--云天弧光
		...
		add_steallife_p={4996,10000},	--好像不能直接伤害吸血,需要用这个来加成

		userdesc_000={4996},
		userdesc_101={{{1,12},{10,50},{15,50}}},
	},
	hs_ythg_dmg = {--云天弧光_伤害
		attack_usebasedamage_p={{{1,30},{10,72},{15,108}}},
		attack_wooddamage_v={
			[1]={{1,30*2*0.9},{10,72*2*0.9},{15,108*2*0.9}},
			[3]={{1,30*2*1.1},{10,72*2*1.1},{15,108*2*1.1}}
		},
	...
	hs_tgyy= {--天光云影_90被动_10级
		...
		add_deadlystrike_p1={4996,{{1,2},{10,20}}},
