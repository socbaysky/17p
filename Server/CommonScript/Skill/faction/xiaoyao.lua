...
local tb    = {
    ...
    xy_bhgr_child1 = {--白虹贯日_子1--10级
		attack_usebasedamage_p={{{1,379},{15,704},{20,820}}},
		attack_wooddamage_v={
    ...
    xy_book2_child1 = {--七探蛇盘秘籍_子
		attack_usebasedamage_p={{{1,30},{10,85},{20,85}}},
		attack_wooddamage_v={
			[1]={{1,30*2*0.9},{10,85*2*0.9},{20,85*2*0.9}},
			[3]={{1,30*2*1.1},{10,85*2*1.1},{20,85*2*1.1}}
		},
	...
	xy_dzxy = {--斗转星移-10级主动3--15级
		attack_usebasedamage_p={{{1,245},{15,322},{20,350}}},
		attack_wooddamage_v={
			[1]={{1,245*2*0.9},{15,322*2*0.9},{20,350*2*0.9}},
			[3]={{1,245*2*1.1},{15,322*2*1.1},{20,350*2*1.1}}
		},
    ...
    xy_book3 = {--高级斗转星移
		add_steallife_p={506,{{1,500},{10,5000},{20,5000}}},				--技能ID，吸血万分比

		add_usebasedmg_p1={506,{{1,0},{10,0},{11,6},{15,27},{20,55}}},			--增加斗转星移攻击力
    ...
    xy_sygy_child1 = {--三元归一_子1--10级_523
		...
		physics_potentialdamage_p={{{1,10},{10,20},{11,22}}},
    ...
    xy_90_bsqf_child = {--悲酥清风_子--10级
		...
		all_series_resist_p={{{1,30},{10,60},{11,70},{12,60*1.2},{14,60*1.4}}},
		physics_potentialdamage_p={{{1,10},{10,25},{11,27},{12,25*1.2},{14,25*1.4}}},
