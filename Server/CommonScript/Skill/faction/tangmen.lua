...
local tb = {
    ...
    tm_bylh = {--暴雨梨花4级主动2--15级
		...
		attack_usebasedamage_p={{{1,249},{15,390},{20,440}}},
		attack_wooddamage_v={
			[1]={{1,249*2*0.9},{15,390*2*0.9},{20,440*2*0.9}},
			[3]={{1,249*2*1.1},{15,390*2*1.1},{20,440*2*1.1}}
		},
    ...
    tm_book2 = {--暴雨梨花--高级
		add_usebasedmg_p1={4008,{{1,5},{10,50},{15,100},{20,100}}},		--增加暴雨梨花主飞镖攻击力,后面的攻速已经算进去,这里把2倍数值摊到15级内
		...
		add_deadlydmg_p1={4008,{{1,0},{15,0},{16,12},{20,60}}},  			--增加会心伤害
    ...
    tm_myz_dmg = {--迷影纵_散镖,含沙射影
		attack_usebasedamage_p={{{1,20},{15,60},{20,80}}},
		attack_wooddamage_v={
			[1]={{1,20*2*0.9},{15,60*2*0.9},{20,80*2*0.9}},
			[3]={{1,20*2*1.1},{15,60*2*1.1},{20,80*2*1.1}}
		},
		state_npchurt_attack={100,6},
		missile_hitcount={0,0,1},
    },
    ...
    tm_book3 = {--迷影纵秘籍
		defense_p={{{1,5},{10,50},{20,50}}},
		userdesc_101={{{1,5},{10,50},{20,50}}},										--效果和后面的重复,另写描述
    ...
    tm_book3_child2 = {--迷影纵_清属性
		defense_p={{{1,0},{10,0},{11,24},{15,120},{20,120}}},
    ...
    tm_jgfx_child = {--九宫飞星_子
		...
		attack_usebasedamage_p={{{1,52},{15,113},{20,134}}},
		attack_wooddamage_v={
			[1]={{1,52*2*0.9},{15,113*2*0.9},{20,134*2*0.9}},
			[3]={{1,52*2*1.1},{15,113*2*1.1},{20,134*2*1.1}}
		},
    ...
    tm_xy_child = {--心眼_子
		deadlystrike_p={{{1,4},{10,13},{20,26}}},
		ignore_defense_vp={{{1,3},{10,10},{11,11}}},
