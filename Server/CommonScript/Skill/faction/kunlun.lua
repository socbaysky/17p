...
local tb    = {
    ...
    kl_xrzl_child = {--仙人指路_子
		attack_usebasedamage_p={{{1,327},{15,372},{20,388}}},
		attack_earthdamage_v={
			[1]={{1,327*2*0.9},{15,372*2*0.9},{20,388*2*0.9}},
			[3]={{1,327*2*1.1},{15,372*2*1.1},{20,388*2*1.1}}
		},
	...
	kl_xfsl_child = {--啸风三连-10级主动3--15级
		attack_usebasedamage_p={{{1,107},{15,169},{20,192}}},
		attack_earthdamage_v={
			[1]={{1,107*2*0.9},{15,169*2*0.9},{20,192*2*0.9}},
			[3]={{1,107*2*1.1},{15,169*2*1.1},{20,192*2*1.1}}
		},
	...
	kl_zxcg = {--醉仙错骨-20级被动1--10级
		physics_potentialdamage_p={{{1,5},{10,45},{12,54}}},
	...
	kl_ldjt = {--雷动九天-30级主动4--15级
		...
		attack_usebasedamage_p={{{1,88},{15,257},{20,318}}},
		attack_earthdamage_v={
			[1]={{1,88*2*0.9},{15,257*2*0.9},{20,318*2*0.9}},
			[3]={{1,88*2*1.1},{15,257*2*1.1},{20,318*2*1.1}}
		},
	...
	kl_book4={--雷动九天秘籍
		add_usebasedmg_p1={4112,{{1,6},{10,60},{15,121},{20,121}}},					--增加雷动九天1攻击力
