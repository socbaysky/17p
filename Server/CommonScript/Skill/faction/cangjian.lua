...
local tb	= {
	...
	cj_book2_child2 = {--心剑_中级秘籍,回血
		dir_recover_life_pp={{{1,22},{10,227},{11,227}},1},		--生命上限万分比,自身数值
		skill_statetime={2},
	},
	...
	cj_yqyy_child = {--玉泉鱼跃_子--15级
		attack_usebasedamage_p={{{1,320},{15,491},{20,553}}},
		attack_metaldamage_v={
	...
	cj_fcyj_child3 = {--峰插云景飞剑
		attack_usebasedamage_p={{{1,44},{15,101},{20,121}}},
		attack_metaldamage_v={
	...
	cj_hggs_enemy = {--鹤归孤山_敌人--10级
		physics_potentialdamage_p={{{1,-10},{10,-60},{11,-66}}},	--减少基础攻击力
	...
	cj_ybsl_child = {--映波锁澜_子1
		all_series_resist_p={{{1,150},{10,1500},{11,1650}}},
		ignore_abnor_state={},		--免疫负面效果
		state_zhican_ignore={1},		--免疫致残
