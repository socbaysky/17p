...
local tb    = {
    ...
    ts_fylb = {--飞燕凌波-1级主动1--15级
		...
		attack_usebasedamage_p={{{1,153},{15,243},{20,276}}},
		attack_waterdamage_v={
			[1]={{1,153*2*0.9},{15,243*2*0.9},{20,276*2*0.9}},
			[3]={{1,153*2*1.1},{15,243*2*1.1},{20,276*2*1.1}}
		},
	...
	ts_book1 = {	--飞燕凌波秘籍
		...
		add_usebasedmg_p1={4606,{{1,0},{10,0},{11,7},{15,32},{20,65}}},
    ...
    ts_ypys = {--银瓶玉碎-4级主动2--15级
		attack_usebasedamage_p={{{1,234},{15,512},{20,615}}},
		attack_waterdamage_v={
			[1]={{1,234*2*0.9},{15,512*2*0.9},{20,615*2*0.9}},
			[3]={{1,234*2*1.1},{15,512*2*1.1},{20,615*2*1.1}}
		},
	...
	ts_book2 = {--银瓶玉碎_秘籍
		...
		add_usebasedmg_p1={4608,{{1,0},{10,0},{11,20},{15,98},{20,98}}},	--增加银瓶玉碎主技能伤害
	...
	ts_book2_child2 = {--银瓶玉碎冰冻
		state_freeze_attack={{{1,0},{10,0},{11,8},{15,40},{20,40}},15*2},
	},
	...
	ts_book3 = {--空山凝云秘籍
		...
		add_usebasedmg_p1={4615,{{1,0},{10,0},{11,28},{15,140},{20,280}}},		--增加空子弹的伤害
    ...
    ts_sly_child = {--水龙吟_子--15级
		attack_usebasedamage_p={{{1,174},{15,367},{20,436}}},
		attack_waterdamage_v={
			[1]={{1,174*2*0.9},{15,367*2*0.9},{20,436*2*0.9}},
			[3]={{1,174*2*1.1},{15,367*2*1.1},{20,436*2*1.1}}
		},
    ...
    ts_fqwt_self1 = {--凤栖梧桐_回血
		dir_recover_life_pp={{{1,6},{10,60},{11,66}},1},--生命上限,自身数值
		skill_statetime={1},
    },
    ...
    ts_smth_team = {--水幕天华_队友--10级
		weaken_deadlystrike_damage_p={{{1,1.5},{2,3},{10,15},{12,18}}},
		skill_statetime={3*15},
    },
    ...
    ts_jdqx = {--剑胆琴心-80级被动6--20级
		physics_potentialdamage_p={{{1,3},{20,30},{24,30*1.2}}},
    ...
    ts_qshm_child = {--琴瑟和鸣_子,无成长,触发几率成长
		attack_usebasedamage_p={0},
		state_slowall_attack={{{1,50},{10,50},{11,55}},15*1},
