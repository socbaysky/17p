	...
	[LoverTask.TASK_TYPE_DREAM] = 
	{
		...
		tbStep = 
		{
			...
			};
			{
				...
				tbParam = {91007}, 
				tbTaskInfo = {
					[LoverTask.TASK_STATE_ACCEPT] = {szTitle = "[11adf6][缘]若雪梦境[-]", szDetail = "了解[FFFE0D]若雪[-]梦境", szDesc = "燕若雪大致说了一下梦境的注意事项，二位元需要学会牵手动作，才能通过梦境", tbShowAward = {}};
				};
			};
			{
				szDes = "[缘]前往梦境", 
