...
function Partner:CheckCanUseProtentialItem(pPlayer, nPartnerId, nProtentialType)
	...
	if nPValue >= nLimitProtential then
		if bMax then
			...
			return false, string.format("%s已达目前上限，突破後才可提升", self.tbProtentialName[nProtentialType]);
		end
	end
...
Partner.tbAllAttribDef =
{
	...
	{"会心机率",	Partner.GetDeadlyStrike},
	{"会心伤害",	Partner.GetDeadlyStrikeDamage},
	{"抗会心机率",	"weaken_deadlystrike_v"},
	{"会心免伤",	Partner.GetBaseValueWhithP,	"weaken_deadlystrike_damage_p"},
	{"受伤机率",	Partner.GetValueWithAllValue, "state_hurt_attackrate", "add_seriesstate_rate_v"},
	{"眩晕机率",	Partner.GetValueWithAllValue, "state_stun_attackrate", "add_seriesstate_rate_v"},
	{"迟缓机率",	Partner.GetValueWithAllValue, "state_slowall_attackrate", "add_seriesstate_rate_v"},
	{"致缠几率",	Partner.GetValueWithAllValue, "state_zhican_attackrate", "add_seriesstate_rate_v"},
	{"麻痹机率",	Partner.GetValueWithAllValue, "state_palsy_attackrate", "add_seriesstate_rate_v"},
	{"抗受伤机率",	Partner.GetValueWithAllValue, "state_hurt_resistrate", "resist_allseriesstate_rate_v"},
	{"抗眩晕机率",	Partner.GetValueWithAllValue, "state_stun_resistrate", "resist_allseriesstate_rate_v"},
	{"抗迟缓机率",	Partner.GetValueWithAllValue, "state_slowall_resistrate", "resist_allseriesstate_rate_v"},
	{"抗致缠几率",	Partner.GetValueWithAllValue, "state_zhican_resistrate", "resist_allseriesstate_rate_v"},
	{"抗麻痹机率",	Partner.GetValueWithAllValue, "state_palsy_resistrate", "resist_allseriesstate_rate_v"},
