...
Sdk.Def.tbPCVersionNoticeMail = {
	Title = "电脑版使用说明";
	Text = [[      亲爱的少侠，欢迎使用《剑侠情缘手游》电脑版。在电脑版中可以使用键盘进行基本操作。您可以通过 [FFFE0D]角色资讯介面--操作--PC操作设置[-] 介面进行快速键设置。
      电脑版目前暂不支持储值，您仍需[FFFE0D]回到手机端来完成储值支付[-]。对此带来的不便，敬请见谅。]];
	From = "系统";
}
...
-------------------新增------------------------------
	...
	["FirstSSPartner"] =
		{"hongbaocard_4110_3222164606", "恭喜您获得首个[FFFE0D]SS级同伴[-]！"};
	["Power100w"] =
