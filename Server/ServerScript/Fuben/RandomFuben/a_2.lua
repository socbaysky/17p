...
tbFubenSetting.LOCK = 
{
	...
	[6] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 80, "击退金钱豹"},	
			{"BlackMsg", "没想到这条路上竟有如此多的野兽！"},
