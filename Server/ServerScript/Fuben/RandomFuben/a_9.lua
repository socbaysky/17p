...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 40, "保护紫轩"},
			{"BlackMsg", "前方似乎有位姑娘遇到了麻烦！"},

			--山贼
			{"AddNpc", 1, 5, 4, "guaiwu", "RandomFuben1_9_1", false, 0, 0, 0, 0},
			{"NpcBubbleTalk", "Zixuan", "你们这群山贼真是可恶，可有人来帮助小女子！", 4, 1, 1},
			{"NpcBubbleTalk", "guaiwu", "哈哈哈，小娘子乖乖跟兄弟们回去吧！", 4, 2, 1},
		},
	},
	[4] = {nTime = 0, nNum = 5,
		tbPrelock = {3},
		...
		tbUnLockEvent = 
		{
			...
			{"SetFubenProgress", 60, "击退山贼头目"},
			{"NpcBubbleTalk", "BOSS", "哪里来的家伙，竟敢坏兄弟们的好事！真是自寻死路！！", 4, 3, 1},
