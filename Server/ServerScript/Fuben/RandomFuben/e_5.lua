...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第五层 天机工坊"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
...
-------------胜利判定------------------------
	[4] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"SetFubenProgress", 50, "击败南宫灭"},				
			{"NpcBubbleTalk", "BOSS", "没想到你们竟会闯入这里，今日你们将在劫难逃！", 4, 1, 1},
		},
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 100, "击败南宫灭"},
...
------------------------列阵枪毙（第一次）------------------------------
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"BlackMsg", "机关人出现，不要与其接触尝试破坏其阵型！"},	
			{"NpcBubbleTalk", "BOSS", "哼，就让你尝尝我机关阵的威力！！", 4, 1, 1},
...
----------------------列阵枪毙（第二次）------------------------------
	[38] = {nTime = 0, nNum = 1,
		...
		{
			{"BlackMsg", "机关人出现，不要与其接触尝试破坏其阵型！"},	
			{"NpcBubbleTalk", "BOSS", "哼，就让你尝尝我机关阵的威力！！", 4, 2, 1},	
			{"NpcAddBuff", "BOSS", 2452, 1, 180},		
