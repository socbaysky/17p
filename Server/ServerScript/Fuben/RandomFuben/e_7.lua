...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 50, "击败柴嵩"},
			{"SetNpcProtected", "BOSS", 0},
			{"SetAiActive", "BOSS", 1},
			{"SetHeadVisiable", "BOSS", true, 0},
			{"NpcBubbleTalk", "BOSS", "没想到会在此处与你们巧遇，闲来无事不如来切磋一番吧！", 4, 0, 1},
...
----------------------阶段1---------------------------	
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "BOSS", "没想到你们倒还有些棘手，那我也不能大意了！！", 4, 0, 1},
			{"NpcHpUnlock", "BOSS", 40, 40},

			{"BlackMsg", "触碰地面[FFFE0D]所有光圈[-]，获取[FFFE0D]强力技能[-]来对抗柴嵩！"},
	...
	[37] = {nTime = 6, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "[FFFE0D]光圈已消失[-]，各位侠士请小心应对柴嵩！！"},	
		},
	},
----------------------阶段2---------------------------	
	[40] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{			
			{"NpcBubbleTalk", "BOSS", "没想到你们竟会如此棘手，不过单凭如此还是无法战胜我的！！你们当心了！！", 4, 0, 1},
