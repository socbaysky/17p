...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第四层 千壑雪岭"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 50, "击败天星道长"},
			{"SetNpcProtected", "BOSS", 0},
			{"SetAiActive", "BOSS", 1},	
			{"NpcBubbleTalk", "BOSS", "少年人，来向贫道展示一下你们的武功吧！", 4, 1, 1},
...
--------------阶段1--------------------
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{	
			{"NpcBubbleTalk", "BOSS", "当真不错，没想到你们竟有如此实力！老夫也不能藏拙了，接招吧！", 3, 0, 1},	
	...
	[31] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{	
			{"BlackMsg", "[FFFE0D]引雷剑[-]准备召唤雷电，尽速将其破坏掉！！"},
		},
	},
	[32] = {nTime = 6, nNum = 0,
		tbPrelock = {31},
...
-------------阶段2------------------------
	[40] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{	
			{"NpcBubbleTalk", "BOSS", "当真不错，没想到你们竟有如此实力！", 3, 1, 1},	
...
-------------阶段3------------------------
	[50] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{	
			{"NpcBubbleTalk", "BOSS", "长江後浪推前浪，看来老道也不能藏拙了！", 4, 1, 1},	
