...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第七层 诡异废庄"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[4] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"BlackMsg", "此处似乎有武林中人出没"},
			{"SetFubenProgress", 20, "击败大头领"},
			{"ClearTargetPos"},
			{"AddNpc", 2, 1, 40, "sl", "shouling1", false, 0, 0, 9010, 0},
			{"NpcBubbleTalk", "sl", "来者何人？胆敢闯到此处，活得不耐烦啦！", 4, 3, 1},
			{"NpcHpUnlock", "sl", 5, 80},
		},
	},
	[5] = {nTime = 0, nNum = 1,
		...
		{	
			...
			{"BlackMsg", "小心！中原一点红在[FFFE0D]回血阵[-]内会持续回复血量！"},
	...
	[7] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "sl", "你们居然杀了我大哥？我要报仇！", 4, 1, 1},
			{"NpcHpUnlock", "sl", 8, 80},
		},
	},
	[8] = {nTime = 0, nNum = 1,
	...
	[9] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"BlackMsg", "糟了！雷电停了！快去重新开启[FFFE0D]机关[-]！"},
			{"DelNpc", "jg1"},
			{"CloseCycle", "cycle3"},
			{"DelNpc", "skill"},
	...
	[10] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "sl", "你们居然杀了我大哥二哥？我要报仇！", 4, 1, 1},
	...
	[11] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "sl", "来尝尝这个的滋味！", 4, 1, 1},
	...
	[12] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "sl", "你们居然杀了我大哥二哥三哥四哥？哦不对，我是老四。我要报仇！！", 4, 1, 1},
	...
	[13] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "sl", "他们都说我傻，其实我一点都不傻，看我的！回来吧哥哥们！！", 4, 1, 1},
...
----------------稀有锁-------------------------------
	[30] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"BlackMsg", "一位老者忽然出现，气宇轩昂！"},
			{"AddNpc", 10, 1, 0, "xy", "chongsheng1", false, 8, 0, 0, 0},
			{"UnLock", 14},
			{"NpcBubbleTalk", "xy", "我来帮你们压住这个法阵！", 4, 0, 1},
			{"NpcBubbleTalk", "sl", "又是你这个牛鼻子来坏我的好事！", 4, 3, 1},
			{"NpcBubbleTalk", "xy", "惩奸除恶，我辈本分！", 4, 6, 1},
			{"UnLock", 30},
