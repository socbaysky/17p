...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		{	
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第四层 石窟密洞"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"BlackMsg", "此地毒水纵横，切记不可碰到毒水！"},
			{"SetFubenProgress", 20, "寻找出路"},
	...
	[4] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 30, "击败敌人"},
			{"BlackMsg", "发现机关！将机关守卫击退并破坏机关！"},

			--机关守卫
			{"AddNpc", 3, 7, 5, "guaiwu", "RandomFuben4_3_1",false, 0, 0, 0, 0},
			{"NpcBubbleTalk", "guaiwu", "你们是什麽人？胆敢在大爷的地盘撒野！", 4, 1, 1},
		},
	},
	[5] = {nTime = 0, nNum = 8,
		tbPrelock = {4},
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 60, "击败敌人"},
			{"BlackMsg", "发现机关！将机关守卫击退并破坏机关！"},

			--机关守卫
			{"AddNpc", 4, 8, 7, "guaiwu", "RandomFuben4_3_2",false, 0, 0, 0, 0},
			{"NpcBubbleTalk", "guaiwu", "不知死活的家伙，就让我们送你上路！", 4, 1, 1},
		},
	},
	[7] = {nTime = 0, nNum = 9,
		tbPrelock = {6},
