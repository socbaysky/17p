...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"NpcBubbleTalk", "Lisan", "哈哈，总算是来人了，这条路危险重重还请各位侠士能护送我一程！", 4, 1, 1},	
	...
	[4] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"BlackMsg", "糟糕！似乎是遇到恶狼群了！"},
			{"SetFubenProgress", 20, "击退灰狼"},
			{"NpcBubbleTalk", "Lisan", "糟糕，看来是遇到狼群了，赶紧将牠们击退！", 4, 1, 1},
	...
	[5] = {nTime = 0, nNum = 7,
		...
		{	
			...
			{"BlackMsg", "狼群数量越来越多，得尽快离开此地才是！"},	
			{"NpcBubbleTalk", "Lisan", "总算是将狼群击退了，我们继续前进！", 4, 1, 1},	
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"ClearTargetPos"},
			{"BlackMsg", "糟糕，又遇到恶狼群了！"},
			{"NpcBubbleTalk", "Lisan", "糟糕，又遇到狼群了，赶紧将牠们击退！", 4, 1, 1},
			{"SetFubenProgress", 60, "击退灰狼"},
	...
	[7] = {nTime = 0, nNum = 7,
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 80, "离开竹林小道"},
			{"BlackMsg", "出口就在前方，尽速逃离这里！"},
