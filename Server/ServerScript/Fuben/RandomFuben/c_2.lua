...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第三层 峰顶峭崖"},			
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 50, "击败林海"},	
			{"BlackMsg", "糟糕，竟在此处遇到了林海！！"},
			{"SetNpcProtected", "BOSS", 0},	
			{"NpcBubbleTalk", "BOSS", "哈哈，还真是冤家路窄啊，你们准备受死吧！！", 3, 0, 1},
			{"NpcHpUnlock", "BOSS", 30, 75},	
		},
	},
-------------胜利判定------------------------
...
-----------------------------------怪物巡逻锁（第一阶段）--------------------------------------
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "BOSS", "可恶！！！你们不要太得意了！！出来吧，守卫们！！", 4, 0, 1},
			{"NpcHpUnlock", "BOSS", 50, 40},	

			{"BlackMsg", "注意避开林海召唤出的怪物，不要被发现了！！"},
	...
	[40] = {nTime = 1, nNum = 0,
		...
		tbStartEvent = 
		{
			{"BlackMsg", "林海施展了秘术，请务必小心！！"},
			{"NpcBubbleTalk", "BOSS", "哈哈哈，乳臭未乾的家伙们，准备迎接死亡吧！！！", 4, 0, 1},
...
-----------------------------------怪物巡逻锁（第二阶段）--------------------------------------
	[50] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "BOSS", "可恶！！！你们不要太得意了，让你们尝尝我的厉害！！", 4, 0, 1},
