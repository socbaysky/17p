...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第七层 低语秘洞"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[4] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 60, "与尹含烟比试"},
			{"ClearTargetPos"},		    
			{"SetNpcProtected", "boss", 0},
			{"SetAiActive", "boss", 1},
			{"SetHeadVisiable", "boss", true, 0},
			{"NpcBubbleTalk", "boss", "你们来得正好，我正手痒呢！", 4, 1, 1},
		},
	},
	[5] = {nTime = 0, nNum = 1,
		tbPrelock = {2},
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "boss", "来见识下我最近研习的招式吧！", 4, 0, 1},
		},
	},
	[7] = {nTime = 6, nNum = 0,
		tbPrelock = {6},
		tbStartEvent = 
		{
			{"BlackMsg", "去[FFFE0D]极反法阵[-]中躲避致命攻击！"},
			--boss技能
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "boss", "嘿嘿，还没完呢！", 5, 1, 1},
			--删除法阵
			{"DelNpc", "npc"},
			--移除锁足BUFF
