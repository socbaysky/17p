...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 20, "跟随小殷方"},
			{"ChangeNpcAi", "hs", "Move", "Path1", 4, 1, 1, 0, 0},
			{"NpcBubbleTalk", "hs", "没想到会在这碰到你们，我们一同前行吧！", 4, 1, 1},
			{"BlackMsg", "跟随小殷方探索凌绝峰。"},
		},
	},
	[4] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "jy", "你们无路可退了，乖乖束手就擒吧！", 4, 2, 1},
			{"SetFubenProgress", 30, "击败藏剑弟子"},
		},
	},
	[5] = {nTime = 0, nNum = 7,
		tbPrelock = {4},
		...
		tbUnLockEvent = 
		{
			...
			{"SetFubenProgress", 40, "跟随小殷方"},
			{"SetTargetPos", 4558, 2806},
			{"NpcBubbleTalk", "hs", "看来这些刺客都是卓非凡派来的人，我们得小心前进了！", 4, 1, 1},
	...
	[8] = {nTime = 0, nNum = 8,
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 70, "击败藏剑高手"},
		    {"ChangeNpcAi", "hs", "Move", "Path3", 0, 1, 1, 0, 0},
		    {"NpcBubbleTalk", "hs", "总算是把他们击退了！你们的武艺不错，我们来切磋一下吧！", 4, 1, 1},
		},
	},
	[9] = {nTime = 2, nNum = 0,
		tbPrelock = {8},
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 80, "与小殷方比试"},
			{"BlackMsg", "与小殷方切磋武艺！"},
			{"DelNpc", "hs"},
			{"AddNpc", 2, 1, 10, "BOSS", "RandomFuben2_10_BOSS",false, 0},
			{"NpcBubbleTalk", "BOSS", "你们可千万不要小看我，否则会吃大亏的！", 4, 2, 1},
		},
	},
...
-------------胜利判定------------------------
	[10] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "hs", "你们的武艺真不错啊！", 4, 2, 1},
