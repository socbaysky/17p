...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第六层 石壁悬崖"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[4] = {nTime = 8, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 80, "击败敌人"},

			{"BlackMsg", "突然燃起的邪火貌似对我们不利！"},
...
---------------------稀有锁---------------------------------
	[30] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "Qingxiao", "这就是邪教中的祭魂大法，击毁所有邪火就可破解！", 4, 1, 1},
