...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第四层 峰顶山门"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
...
----------------------阶段1---------------------------
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{	
			{"NpcBubbleTalk", "BOSS", "没想到你们倒还有点本事，既然如此就让你们尝尝我的厉害！！", 4, 1, 1},	
	...
	[31] = {nTime = 10, nNum = 0,
		...
		tbUnLockEvent = 
		{		
			{"NpcBubbleTalk", "BOSS", "来尝尝这招「雷动九天」的威力吧！！", 4, 1, 1},	
	...
	[32] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"BlackMsg", "[FFFE0D]苗疆女子[-]似乎在施展秘术，请尽快将其击杀！"},
...
----------------------阶段2---------------------------
	[40] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{	
			{"NpcBubbleTalk", "BOSS", "可恶... 没想到竟会如此棘手！！但你们也不要太得意了！！", 4, 1, 1},	
