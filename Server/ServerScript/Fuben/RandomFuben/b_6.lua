...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第二层 竹林小道"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[3] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "Hushenyi", "没想到竟会在此处遇到这群苍鹰，真是麻烦啊！", 4, 1, 1},
		},
	},
	[4] = {nTime = 0, nNum = 11,
		tbPrelock = {3},
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 60, "护送胡神医"},
			{"NpcBubbleTalk", "Hushenyi", "小娃娃们，你们便助老头子一臂之力吧！", 4, 0, 1},
	...
	[5] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 80, "保护胡神医"},
			{"NpcBubbleTalk", "Hushenyi", "又遇到这群苍鹰了，将牠们击退！", 4, 1, 1},
