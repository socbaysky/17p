...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第七层 荒城之外"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[3] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "[FFFE0D]熄灭邪火[-]破掉护身术！"},
			{"SetFubenProgress", 5, "破掉护身术"},
		},
	},
	[20] = {nTime = 0, nNum = 1,
		tbPrelock = {3},
	...
	[11] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "sl", "你们还有些本事，居然来到了此处！", 4, 1, 1},
		},
	},
	[50] = {nTime = 0, nNum = 1,
		tbPrelock = {11},
