...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		{	
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第六层 怒梅雪园"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
...
----------------------闯关时间--------------------------
	...
	[4] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"SetFubenProgress", 50, "击败古嫣然"},
			{"ClearTargetPos"},
			{"AddNpc", 1, 1, 10, "BOSS", "boss", false, 0, 0, 9010, 0},
			{"NpcBubbleTalk", "BOSS", "你们也要来吃我的毒虫麽？", 4, 3, 1},
	...
	[7] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{	
			{"NpcBubbleTalk", "BOSS", "不知好歹的东西，姑奶奶就不留手了！", 4, 3, 1},
			{"BlackMsg", "注意观察古嫣然状态，不要被狂暴古嫣然近身！"},
