...
tbFubenSetting.LOCK =
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 50, "击败杨熙烈"},
			{"NpcBubbleTalk", "BOSS", "小孬孬们，来与我杨熙烈一战吧！", 4, 1, 1},
...
-------------闯关时间------------------------
	...
	[32] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent =
		{
			{"NpcBubbleTalk", "BOSS", "没想到竟与老夫战到这种程度，小孬孬们还不错！", 4, 1, 1},
	...
	[33] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent =
		{
			{"NpcBubbleTalk", "BOSS", "没想到你们竟能将老夫逼至如此境地，当真是後生可畏！！", 4, 1, 1},
