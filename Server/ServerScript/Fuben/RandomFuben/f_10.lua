...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第六层 桃源小径"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[3] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "哈哈，又有肥羊送上门来了，兄弟们抄家伙一起上啊！！", 4, 0, 1},	
		},
	},
	[4] = {nTime = 0, nNum = 14,
		tbPrelock = {3},
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 80, "击败无忧教高手"},

			--无忧教高手 &  无忧教弟子  
			{"NpcBubbleTalk", "Leader", "看来你们还有些本事，那就让我来收拾你们吧！", 5, 3, 1},
...
---------------------稀有锁---------------------------------
	[30] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			...
			{"NpcBubbleTalk", "Qingxiao", "这就是邪教中的招魂大法，速速击杀妖道！", 4, 1, 1},
			{"UnLock", 30},
		},
		tbUnLockEvent = 
		{
