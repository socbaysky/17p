...
tbFubenSetting.LOCK = 
{
	...
	[6] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 80, "击败路达"},
			{"NpcBubbleTalk", "BOSS", "哈哈，真是冤家路窄！你们多次挑衅本大爷，今日就是你们的死期！", 4, 1, 1},
