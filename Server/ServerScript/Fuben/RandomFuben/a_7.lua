...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"BlackMsg", "咦？这里怎麽会有这麽多奇怪的机关？"},
			{"SetFubenProgress", 20, "开启机关"},
		},
	},
	[4] = {nTime = 0, nNum = 1,
		tbPrelock = {3},
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 40, "击退山贼"},

			--山贼
			{"AddNpc", 1, 6, 5, "guaiwu", "RandomFuben1_7_1", false, 0, 0, 9005, 0.5},
			{"NpcBubbleTalk", "guaiwu", "又有肥羊送上门了，大夥一起上啊！", 4, 1, 1},	
		},
	},
	[5] = {nTime = 0, nNum = 6,
		tbPrelock = {4},
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 60, "继续前进"},	
			{"BlackMsg", "这条路有些奇怪，大夥小心为上！"},		
