...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
		    ...
		    {"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第三层 石壁平台"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[3] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "来者何人！！此处被我五色教承包了，闲杂人等还不速速退去？！", 4, 3, 1},
   		},
	},
	[4] = {nTime = 0, nNum = 7,
		tbPrelock = {3},
...
----------------阶段一----------------------
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "没想到你们倒还有两下子，既然如此让你们看看我的厉害吧！！！", 4, 0, 1},
	...
	[32] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "将[FFFE0D]机关破坏[-]并尽速逃离此区域！！！"},
