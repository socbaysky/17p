...
--------------------阶段1-----------------------------
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "可恶，你们不要太得意了！！天机工匠何在！！", 4, 0, 1},	
	...
	[31] = {nTime = 2, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"BlackMsg", "[FFFE0D]天机工匠[-]准备强化弩车，在抵达前将其击杀！"},
		},
	},
	[32] = {nTime = 0, nNum = 1,
		tbPrelock = {30},
	...
	[34] = {nTime = 2, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "Control1", "哈哈，强化这弩车对我等来说简直是易如反掌！！", 3, 0, 1},
	...
	[36] = {nTime = 2, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "Control2", "哈哈，强化这弩车对我等来说简直是易如反掌！！", 3, 0, 1},
...
---------------------阶段2----------------------------------
	...
	[44] = {nTime = 2, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "Control3", "哈哈，强化这弩车对我等来说简直是易如反掌！！", 3, 0, 1},
	...
	[46] = {nTime = 2, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "Control4", "哈哈，强化这弩车对我等来说简直是易如反掌！！", 3, 0, 1},
