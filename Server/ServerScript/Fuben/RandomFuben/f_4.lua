...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"SetFubenProgress", 50, "击败宋秋石"},
			{"NpcBubbleTalk", "BOSS", "何人敢到我昆仑门下撒野！", 4, 3, 1},	
		},
	},
	------------------------------------流程阶段------------------------------
	[21] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{	
			{"BlackMsg", "注意躲避宋秋石的[FFFE0D]三分归元气[-]！！"},
			{"NpcBubbleTalk", "BOSS", "尔等速速报上名来，昆仑派剑下不诛无名之辈！！", 4, 0, 1},
...
----------------------阶段1---------------------------	
	[11] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"BlackMsg", "注意击杀[FFFE0D]灵魂球[-]！否则宋秋石会增强！"},
