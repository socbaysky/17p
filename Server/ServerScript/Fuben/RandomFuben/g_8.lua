...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第七层 无人雪宫"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[10] = {nTime = 0, nNum = 1,
		...
		tbStartEvent = 
		{
			{"SetFubenProgress", 80, "击败耶律辟离"},
			{"BlackMsg", "击败盘踞在此处的耶律辟离"},
			{"AddNpc", 4, 1, 10, "sl", "shouling1", false, 0, 0, 9010, 0.5},
			{"AddNpc", 2, 8, 0, "gw", "guaiwu5", false, 0, 0, 9005, 0.5},
			{"NpcBubbleTalk", "sl", "真是冤家路窄啊！哼哼，来了就别想走了！", 4, 1, 1},
		},
		tbUnLockEvent = 
		{
			--判断模式篝火&踢出
