...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第七层 阴风岩窟"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[4] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 60, "击败端木睿"},
			{"ClearTargetPos"},		    
			{"SetNpcProtected", "boss", 0},
			{"SetAiActive", "boss", 1},
			{"SetHeadVisiable", "boss", true, 0},
			{"NpcBubbleTalk", "boss", "此处已经很久没人来了，或许你们能陪在下练练！", 4, 1, 1},
		},
	},
	[5] = {nTime = 0, nNum = 1,
		tbPrelock = {2},
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "boss", "来见识下我潜心研究多年的绝技！", 4, 0, 1},
		},
	},
	[7] = {nTime = 4, nNum = 0,
		tbPrelock = {6},
	...
	[11] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "boss", "再来见识下我潜心研究多年的绝技！", 4, 0, 1},
		},
	},
	[12] = {nTime = 4, nNum = 0,
		tbPrelock = {11},
	...
	[16] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "boss", "可恶，见识我的怒火吧！！", 4, 0, 1},
		},
	},
	[17] = {nTime = 4, nNum = 0,
		tbPrelock = {16},
