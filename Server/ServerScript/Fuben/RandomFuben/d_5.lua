...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 10, nNum = 0,
		...
		tbStartEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第四层 峰顶天池"},
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 50, "击败燕若雪"},
			{"SetNpcProtected", "BOSS", 0},
			{"SetAiActive", "BOSS", 1},
			{"NpcBubbleTalk", "BOSS", "你们是什麽人，出现於此地意欲何为？！", 4, 3, 1},
		},
	},
--------------------------------流程阶段-------------------------------------
-------------------阶段1-------------------------
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{	
			{"NpcBubbleTalk", "BOSS", "没想想到还有点本事，倒是小瞧你们了！来尝尝这招吧！", 4, 0, 1},
			{"NpcHpUnlock", "BOSS", 40, 55},

			{"BlackMsg", "[FFFE0D]左方[-]有巨浪袭来，尽速寻找[FFFE0D]石柱[-]进行躲避！"},
...
------------------阶段2-------------------------
	[40] = {nTime = 0, nNum = 1,
		...
		{	
			...
			{"BlackMsg", "[FFFE0D]右方[-]有巨浪袭来，尽速寻找[FFFE0D]石柱[-]进行躲避！"},
...
----------------------------阶段3--------------------------------
	[50] = {nTime = 0, nNum = 1,
		...
		{	
			...
			{"NpcBubbleTalk", "BOSS", "可恶.... 你们不要太得意了，尝尝这招的滋味吧！", 4, 0, 1},

			{"BlackMsg", "巨浪从[FFFE0D]正面[-]袭来，尽速寻找[FFFE0D]石柱[-]进行躲避！"},
