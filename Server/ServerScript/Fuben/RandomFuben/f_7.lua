...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第六层 隐窟密洞"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 50, "击败封玉书"},
			{"SetNpcProtected", "BOSS", 0},
			{"SetAiActive", "BOSS", 1},
			{"SetHeadVisiable", "BOSS", true, 0},
			{"NpcBubbleTalk", "BOSS", "你们是什麽人，在这里做什麽？！", 4, 0, 1},	
		},
	},
------------------------------------流程阶段------------------------------
----------------------阶段1---------------------------	
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "BOSS", "哼，你们不要太得意了，就让你们尝尝我布下机关阵法的威力吧！！！", 4, 0, 1},	
	...
	[31] = {nTime = 2, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"BlackMsg", "封玉书开启[FFFE0D]滚石机关[-]，各位侠士请小心应对！"},
		},
	},
----------------------阶段2---------------------------	
	[40] = {nTime = 0, nNum = 1,
	...
	[42] = {nTime = 2, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"BlackMsg", "封玉书开启[FFFE0D]旋转机关[-]，各位侠士请小心应对！"},
		},
	},
----------------------阶段3---------------------------	
	[50] = {nTime = 0, nNum = 1,
...
----------------------阶段4---------------------------	
	[60] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "可恶的家伙们，你们成功将我激怒了，准备好迎接我的怒火吧！！！", 4, 1, 1},
		},
	},
	[61] = {nTime = 2, nNum = 0,
		tbPrelock = {60},
