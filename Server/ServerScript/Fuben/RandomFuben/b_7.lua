...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "guaiwu", "哈哈哈，又有肥羊上门了！兄弟们一起上啊！", 4, 1, 1},
		},
	},
	[4] = {nTime = 0, nNum = 10,
		tbPrelock = {2},
...
-------------闯关时间------------------------	
	...
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "Yinfang", "没想到会在这里碰到你们，我们一起前进吧！", 4, 0, 1},
		},
	},
	[31] = {nTime = 1, nNum = 0,
		tbPrelock = {30, 4},
