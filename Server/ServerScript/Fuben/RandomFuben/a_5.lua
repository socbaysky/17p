...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 20, "击退狼群"},
			{"NpcBubbleTalk", "Luqing", "哈哈，总算来人了！！还请各位侠士能助在下将狼群击退！", 4, 0, 1},
	...
	[4] = {nTime = 0, nNum = 14,
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 50, "护送卢青"},
			{"SetTargetPos", 2320, 3489},
			{"ChangeNpcAi", "Luqing", "Move", "Path1", 1, 1, 0, 0, 0},
			{"NpcBubbleTalk", "Luqing", "总算是将狼群击退了，我们继续前进！", 4, 0, 1},
