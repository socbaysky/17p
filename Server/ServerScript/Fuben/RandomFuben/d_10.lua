...
-------------闯关时间------------------------
	...
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "Hemuxue", "没想到会在这里碰到你们，我们一起前进吧！", 4, 1, 1},
		},
	},
	[31] = {nTime = 1, nNum = 0,
		tbPrelock = {30, 4},
