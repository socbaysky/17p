...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		{	
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第一层 後山小道"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"BlackMsg", "天呐！好大的熊！牠朝着我们冲过来了！"},
			{"SetFubenProgress", 20, "击败黑熊"},
	...
	[4] = {nTime = 0, nNum = 4,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "这後山内竟出现如此之多的黑熊，真是奇怪！"},
			{"SetFubenProgress", 40, "击败黑熊"},
		},
	},	
	[5] = {nTime = 0, nNum = 5,
		tbPrelock = {4},
