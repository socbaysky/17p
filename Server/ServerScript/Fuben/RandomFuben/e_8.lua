...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 20, "探索凌绝峰"},
			{"NpcBubbleTalk", "Nalanzhen", "没想到在这峰顶内竟会遇到你们，既然如此那便一同前行吧！", 4, 0, 1},
	...
	[4] = {nTime = 3, nNum = 0,
		...
		{	
			{"ClearTargetPos"},
			{"SetFubenProgress", 40, "击败蒙面刺客"},
			{"NpcBubbleTalk", "Nalanzhen", "没想到这里竟然也会有敌人！", 4, 0, 1},
	...
	[5] = {nTime = 0, nNum = 7,
		...
		{	
			...
			{"NpcBubbleTalk", "Nalanzhen", "我们继续前进吧！！", 4, 0, 1},
