...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第七层 哀号危崖"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "boss", "你们很不错！那再来见识下我崑仑派的秘术！", 4, 0, 1},
		},
	},
	[7] = {nTime = 22, nNum = 0,
		tbPrelock = {6},
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "boss", "崑仑秘术，神鬼难测！", 4, 0, 1},
			{"CloseCycle", "cycle_1"},
		},
	},
	-------------------阶段2----------------------
	[8] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "boss", "小心，接下来就是无尽的火海了！", 4, 0, 1},
		},
	},
	[9] = {nTime = 3, nNum = 0,
		tbPrelock = {8},
