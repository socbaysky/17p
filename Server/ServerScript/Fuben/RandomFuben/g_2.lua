...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第七层 冰寒地窟"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[4] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 50, "与道一真人比试"},
			{"ClearTargetPos"},		    
			{"SetNpcProtected", "boss", 0},
			{"SetAiActive", "boss", 1},
			{"SetHeadVisiable", "boss", true, 0},
			{"NpcBubbleTalk", "boss", "小友们不错，让老朽试试你们的功夫！", 4, 1, 1},
		},
	},
	[5] = {nTime = 0, nNum = 1,
		tbPrelock = {2},
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "boss", "果然有点真本事，那就试试这里的妙处！", 4, 0, 1},
		},
	},
	[7] = {nTime = 0, nNum = 2,
		tbPrelock = {6},
		tbStartEvent = 
		{
			...
			{"BlackMsg", "去[FFFE0D]高台周边[-]找到并摧毁[FFFE0D]阵眼[-]，阻止其施法！"},
		...
		{
			{"BlackMsg", "继续战斗！"},
			{"NpcBubbleTalk", "boss", "居然找到此处机关，还算聪明！", 10, 4, 1},
			--终止boss循环技能
			{"CloseCycle", "cycle_1"},
			{"SetAiActive", "boss", 1},
			--删除巡逻陷阱
