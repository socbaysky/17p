...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		{			
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第五层 寒梅山庄"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 50, "击败方勉"},
			{"NpcBubbleTalk", "BOSS", "何人敢在此造次，还不速速领死！", 4, 1, 1},
	...
	[4] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "BOSS", "让老夫看看你们究竟有何本领！", 4, 0, 1},	
	...
	[5] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			--关闭循环
			{"CloseCycle", "cycle_1"},
			{"NpcBubbleTalk", "BOSS", "没想到你们倒还有点本事，倒是小瞧你们了！", 4, 0, 1},	
	...
	[6] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "BOSS", "你们成功将我激怒了，受死吧！！", 4, 0, 1},	
			{"AddNpc", 5, 1, 0, "Fire", "[NpcGroup=BOSS]", false, 0, 0, 0, 0},
			{"StartTimeCycle", "cycle_1", 5, 100, {"AddNpc", 5, 1, 0, "Fire", "[NpcGroup=BOSS]", false, 0, 0, 0, 0}},
		},
	},
