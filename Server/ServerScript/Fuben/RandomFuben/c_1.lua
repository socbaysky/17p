...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第三层 熔岩密洞"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
...
------------------------------------滚石阶段--------------------------------------------
	...
	[31] = {nTime = 2, nNum = 0,
		...
		tbUnLockEvent = 
		{
			{"BlackMsg", "[FFFE0D]滚石控制者[-]出现，击败控制者可以关闭滚石！"},
		},
	},
	[32] = {nTime = 0, nNum = 1,
		tbPrelock = {30},
