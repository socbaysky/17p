...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
		    ...
		    {"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第三层 石壁悬崖"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[6] = {nTime = 0, nNum = 6,
		...
		tbUnLockEvent = 
		{
			{"SetFubenProgress", 80, "击败天忍高手"},	
			{"AddNpc", 4, 1, 7, "BOSS", "RandomFuben3_5_BOSS", false, 0, 1, 9011, 1},
			{"NpcBubbleTalk", "BOSS", "看来你们还有些本事，那就让我来收拾你们吧！", 5, 3, 1},
		},
	},
-------------胜利判定------------------------
	[7] = {nTime = 0, nNum = 1,
...
-------------闯关时间和积分------------------------
	...
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "Tangxiao", "没想到会在这里碰到你们，我们一起前进吧！", 4, 1, 1},
		},
	},
	[31] = {nTime = 0, nNum = 1,
		tbPrelock = {30},
