...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		{	
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第四层 松壑雪岭"},
		},
	},
	[2] = {nTime = 10, nNum = 1,
		tbPrelock = {1},
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 20, "击败金兵"},
			{"BlackMsg", "这群金兵似乎在守卫着什麽东西？"},
			{"NpcBubbleTalk", "guaiwu1", "来者何人，闲杂人等赶紧滚出去！", 4, 1, 1},	
		},
	},
	[4] = {nTime = 0, nNum = 9,
		tbPrelock = {3},
	...
	[5] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 60, "击败金兵"},
			{"NpcBubbleTalk", "guaiwu4", "来者何人，闲杂人等赶紧滚出去！", 4, 1, 1},	
	...
	[7] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 80, "击败邵骑风"},
			{"BlackMsg", "没想到这里竟会有埋伏！！"},
			-- {"BlackMsg", "没想到这里竟会出现火炮，优先将火炮摧毁！！"},
			{"NpcBubbleTalk", "BOSS", "哪里来的家伙，竟敢坏我大事！", 4, 1, 1},
