...
tbFubenSetting.NPC = 
{
	...
	[15] = {nTemplate = 2657, nLevel = -1, nSeries = 2}, -- 天山主角
	[16] = {nTemplate = 2658, nLevel = -1, nSeries = 2}, -- 霸刀主角
...
tbFubenSetting.tbCopyPlayer = 
{
	...
	[15] = {nNpcIndex = 15, szName = "%s的心魔"},
	[16] = {nNpcIndex = 16, szName = "%s的心魔"},
}
...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		{	
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第五层 天玄之巅"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
...
-------------闯关时间------------------------	
	[7] = {nTime = "e_9_time", nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "没想到居然无法战胜心魔，看来还得努力修行才是！"},
	...
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "Wuxiang", "没想到会在这里碰到你们，我们一起前进吧！", 4, 1, 1},
	...
	[31] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "Wuxiang", "这把巨剑是....", 4, 1, 1},
		},
	},
	[32] = {nTime = 1, nNum = 0,
		tbPrelock = {30, 5},
