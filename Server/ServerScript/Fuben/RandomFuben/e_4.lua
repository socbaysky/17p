...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		{	
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第五层 雪山之巅"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "mb", "这群暗箭伤人的狗东西！！", 4, 7, 1},
			--稀有几率
			{"Random", {350000, 30}},
		},
	},
	...
	[3] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "Elite", "乖乖归顺我们无忧教吧！", 4, 7, 1},
			{"NpcBubbleTalk", "mb", "呸！大言不惭！", 4, 7, 1},
		},
	},
	[11] = {nTime = 5, nNum = 0,
		tbPrelock = {3},
	...
	[4] = {nTime = 0, nNum = 7,
		...
		tbUnLockEvent = 
		{
			...
			{"ChangeNpcAi", "guaiwu", "AddAiLockTarget", "mb"},
			{"ChangeNpcAi", "Elite", "AddAiLockTarget", "mb"},	
			{"NpcBubbleTalk", "Elite", "抵抗是没用的！", 4, 7, 1},
			{"NpcBubbleTalk", "mb", "有本事来杀了姑奶奶！", 4, 7, 1},
		},
	},
	[12] = {nTime = 5, nNum = 0,
		tbPrelock = {4},
	...
	[10] = {nTime = 0, nNum = 7,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "BOSS", "不投降只有死路一条！！", 4, 7, 1},
			{"NpcBubbleTalk", "mb", "一群败类速来受死！", 4, 7, 1},	
		},
	},
	[13] = {nTime = 5, nNum = 0,
		tbPrelock = {10},
...
---------------------稀有锁---------------------------------
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "Wuxiang", "没想到会在这里碰到你们，我们一起守护月眉儿吧吧！", 4, 1, 1},
		},
	},
	[31] = {nTime = 1, nNum = 0,
		tbPrelock = {30, 5},
