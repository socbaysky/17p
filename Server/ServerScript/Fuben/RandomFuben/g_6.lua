...
tbFubenSetting.LOCK = 
{
	...
	[1] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{
			...
			{"OpenWindow", "LingJueFengLayerPanel", "Info",3, 9, "第七层 颤栗之地"},
		},
	},
	[2] = {nTime = 10, nNum = 0,
		tbPrelock = {1},
	...
	[7] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "sl", "那我们就来较量一番吧！", 4, 1, 1},
		},
	},
	[8] = {nTime = 0, nNum = 1,
		tbPrelock = {6},
