...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"BlackMsg", "糟糕，没想到会碰到火狐群！"},
			{"SetFubenProgress", 20, "击退火狐"},
