...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 20, "击退猛虎"},
			{"BlackMsg", "没想到会在这里遇到虎群，速速解决牠们吧！"},
...
-------------闯关时间------------------------
	...
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "Yinfang", "没想到会在这里碰到你们，我们一起前进吧！", 4, 1, 1},
		},
	},
	[31] = {nTime = 1, nNum = 0,
		tbPrelock = {30, 4},
