...
tbFubenSetting.LOCK = 
{
	...
	[3] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "这後山怎会出现如此多的机关人？"},
			{"SetFubenProgress", 30, "击退机关人"},
		},
	},
	[4] = {nTime = 0, nNum = 9,
		tbPrelock = {3},
	...
	[5] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", 80, "击退秦沐白"},
			{"BlackMsg", "糟糕，居然遇到了秦沐白！"},
			{"NpcBubbleTalk", "BOSS", "哈哈，真是冤家路窄！你们多次坏我大事，今日就是你们的死期！", 4, 0, 1},
