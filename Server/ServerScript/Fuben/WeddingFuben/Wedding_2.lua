...
tbFubenSetting.szName         = "海岛·红鸾揽月"                                             -- 单纯的名字，后台输出或统计使用
...
tbFubenSetting.LOCK = 
{
    ...
    [1] = {nTime = 1, nNum = 0,
        ...
        tbStartEvent = 
        {
            ...
            {"SetPlayerDeathDoRevive", 5, "您将在 %d 秒後复活", true},
            --{"AddFurniture", 1, "a"}
            --{"AddFurnitureGroup", "a"}
        },
    ...
    [500] = {nTime = 1, nNum = 0,
        ...
        tbStartEvent = 
        {
            ...
            {"SetShowTime", 501, nil, "迎宾："},
            {"SetTargetInfo", "新人点击请柬，邀请亲朋好友"},
        },
        tbUnLockEvent = 
        {
    ...
    [501] = {nTime = 10*60, nNum = 0,
        ...
        tbStartEvent = 
        {
            ...
            {"RaiseEvent", "SendKinNotice", "[FFFE0D]「%s」[-]和[FFFE0D]「%s」[-]举行的[FFFE0D]海岛·红鸾揽月[-]婚礼即将开始，各位侠士可前往[FFFE0D]襄阳城月老[-]处申请进入"},
            {"RaiseEvent", "SendWorldNotice", "[FFFE0D]「%s」[-]和[FFFE0D]「%s」[-]举行的[FFFE0D]海岛·红鸾揽月[-]婚礼即将开始，各位侠士可前往[FFFE0D]襄阳城月老[-]处申请进入"},
        },
        tbUnLockEvent = 
        {
    ...
    [502] = {nTime = 0, nNum = 1,
        ...
        tbUnLockEvent = 
        {
            {"SetShowTime", 503, nil, "婚礼准备："},
            {"SetTargetInfo", "找月老对话开启婚礼"},
        },
    },
    ...
    [503] = {nTime = 1*60, nNum = 0,
        ...
        tbUnLockEvent = 
        {
            ...
            {"SetShowTime", 504, nil, "准备宣誓："},
            {"SetTargetInfo", "相互许下爱的誓言"},
        },
    },
    ...
    [509] = {nTime = 2, nNum = 0,
        ...
        tbUnLockEvent = 
        {
            {"SetShowTime", 600, nil, "准备拜堂："},
            {"SetTargetInfo", "良时将近，准备拜堂"},
        },
    },
    ...
    [2] = {nTime = 1, nNum = 0,
        ...
        {
            --片头字幕
            {"RaiseEvent", "OpenWeddingInterludePanel", "良时已到，婚礼开始"},
        },
    },
    ...
    [6] = {nTime = 32, nNum = 0,
        ...
        tbUnLockEvent = 
        {
           {"RaiseEvent", "MarryCeremonyPlayerBlackMsg", "夫妻对拜"},
        },
    },
    ...
    [100] = {nTime = 40, nNum = 0,
        ...
        tbUnLockEvent = 
        {
            ...
            -- 片尾字幕
            {"RaiseEvent", "OpenWeddingInterludePanel", nil, "天生才子佳人配，只羡鸳鸯不羡仙"},
        },
    },
    ...
    [102] = {nTime = 48, nNum = 0,
        ...
        {
            {"RaiseEvent", "DestroyUi", "WeddingInterludePanel"},
            {"RaiseEvent", "SendWorldNotice", "执子之手，与子偕老！恭喜[FFFE0D]「%s」[-]与[FFFE0D]「%s」[-]喜结良缘，祝两位新人永结同心，白头偕老。"},
            ----------动画结束后把临时删除的NPC加回来
            --添加宴席空桌
            --{"AddFurnitureGroup", "zhuozi"},  
            {"AddNpc", 10, 1, nil, "Marry1_Table", "Marry1_Table1", true, 0, nil, nil, nil},
    ...
    [106] = {nTime = 2, nNum = 0,
        ...
        tbUnLockEvent = 
        {
            {"SetShowTime", 107, nil, "爆竹准备中："},
            {"SetTargetInfo", "欢聚一堂，准备点燃"},
        },
    },
    ...
    [805] = {nTime = 2, nNum = 0,
        ...
        tbUnLockEvent = 
        {
            {"SetShowTime", 704, nil, "宴席准备："},
            {"SetTargetInfo", "佳肴美食，等待开席"},
        },
    },
    ...
    [705] = {nTime = 40, nNum = 0,
        ...
        tbStartEvent = 
        {
            ...
            {"RaiseEvent", "BlackMsgWithRole", "第1道佳肴：姻缘美满，祝[FFFE0D]「%s」[-]和[FFFE0D]「%s」[-]姻缘美满"},
            {"RaiseEvent", "StartTableFood"}  
        },
        tbUnLockEvent = 
        {
            {"SetShowTime", 706, nil, "宴席："},
            {"SetTargetInfo", "第2道佳肴：喜庆满堂"},
        },
    },
    ...
    [706] = {nTime = 40, nNum = 0,
        ...
        tbStartEvent = 
        {
            ...
            {"RaiseEvent", "BlackMsgWithRole", "第2道佳肴：喜庆满堂，祝[FFFE0D]「%s」[-]和[FFFE0D]「%s」[-]喜庆满堂"},
            {"RaiseEvent", "StartTableFood"}  
        },
        tbUnLockEvent = 
        {
            {"SetShowTime", 707, nil, "宴席："},
            {"SetTargetInfo", "第3道佳肴：花好月圆"}, 
        },
    },
    ...
    [707] = {nTime = 40, nNum = 0,
        ...
        tbStartEvent = 
        {
            ...
            {"RaiseEvent", "BlackMsgWithRole", "第3道佳肴：花好月圆，祝[FFFE0D]「%s」[-]和[FFFE0D]「%s」[-]花好月圆"},
            {"RaiseEvent", "StartTableFood"}  
        },
        tbUnLockEvent = 
        {
            {"SetShowTime", 708, nil, "宴席："},
            {"SetTargetInfo", "第4道佳肴：永结连理"}, 
        },
    },
    ...
    [708] = {nTime = 40, nNum = 0,
        ...
        tbStartEvent = 
        {
            ...
            {"RaiseEvent", "BlackMsgWithRole", "第4道佳肴：永结连理，祝[FFFE0D]「%s」[-]和[FFFE0D]「%s」[-]永结连理"},
            {"RaiseEvent", "StartTableFood"}  
        },
        tbUnLockEvent = 
        {
            {"SetShowTime", 709, nil, "宴席："},
            {"SetTargetInfo", "第5道佳肴：百年好合"}, 
        },
    },
    ...
    [709] = {nTime = 40, nNum = 0,
        ...
        tbStartEvent = 
        {
            ...
            {"RaiseEvent", "BlackMsgWithRole", "第5道佳肴：百年好合，祝[FFFE0D]「%s」[-]和[FFFE0D]「%s」[-]百年好合"},
            {"RaiseEvent", "StartTableFood"}  
        },
        tbUnLockEvent = 
        {
            {"RaiseEvent", "EndTableFood"},
            {"SetShowTime", 710, nil, "准备喜糖："},
            {"SetTargetInfo", "新人/月老准备派喜糖"}, 
        },
    },
    ...
    [710] = {nTime = 10, nNum = 0,
        ...
        tbUnLockEvent = 
        {
            {"SetShowTime", 711, nil, "派发喜糖："},
            {"SetTargetInfo", "甜甜蜜蜜，恩恩爱爱"}, 
        },
    },
    ...
    [712] = {nTime = 1, nNum = 0,
        ...
        tbUnLockEvent = 
        {
            {"SetShowTime", 716, nil, "自由时间："},
            {"SetTargetInfo", "婚礼结束，拍照留念"}, 
        },
    },
