...
tbFubenSetting.szName         = "庄园·晚樱连理"                                             -- 单纯的名字，后台输出或统计使用
...
tbFubenSetting.LOCK = 
{
    ...
    [501] = {nTime = 10*60, nNum = 0,
        ...
        tbStartEvent = 
        {
            ...
            {"RaiseEvent", "SendKinNotice", "[FFFE0D]「%s」[-]和[FFFE0D]「%s」[-]举行的[FFFE0D]庄园·晚樱连理[-]婚礼即将开始，各位侠士可前往[FFFE0D]襄阳城月老[-]处申请进入"},
            {"RaiseEvent", "SendWorldNotice", "[FFFE0D]「%s」[-]和[FFFE0D]「%s」[-]举行的[FFFE0D]庄园·晚樱连理[-]婚礼即将开始，各位侠士可前往[FFFE0D]襄阳城月老[-]处申请进入"},
        },
        tbUnLockEvent = 
        {
