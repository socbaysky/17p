...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 0, nNum = 1,
			...
			tbUnLockEvent = 
		{
			...
			{"BlackMsg", "淫贼休走！光天化日之下竟然盗取我家小姐内衣！"},
	...
	[3] = {nTime = 0, nNum = "NpcNum1",
			...
			tbUnLockEvent = 
		{
			...
			{"BlackMsg", "总算是解决掉这些追兵了，暂时到北方躲一躲吧！！"},		
				--{"LeaveAnimationState"},
		},
	},
	...
	[9] = {nTime = 0, nNum = "NpcNum4",
		...
		tbUnLockEvent = 
		{
			...
			{"BlackMsg", "不要和主角光环作对，记住我的名字，我叫萧动尘。"},
