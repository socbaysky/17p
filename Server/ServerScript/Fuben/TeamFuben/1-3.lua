...
tbFubenSetting.szName 					= "熔火霹雳"										-- 单纯的名字，后台输出或统计使用
...
tbFubenSetting.LOCK = 
{
	...
	[2] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", -1,"击败金兵"},
			{"NpcBubbleTalk", "Elite", "来者何人！竟敢擅闯我五色教禁地，真是自寻死路！", 4, 0, 1},
	...
	[4] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			...
			{"NpcBubbleTalk", "Leader", "居然是你们？你们不该来这里的！", 4, 1, 1},
			{"SetFubenProgress", -1,"击败张风"},
	...
	[30] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "Leader", "果然不错！但就凭这样你们还无法通过这里！！", 4, 1, 1},	
			...
			{"BlackMsg", "[FFFE0D]东瀛忍者[-]会不断[FFFE0D]召唤分身[-]，请优先将其击杀！"},
		},
	},
	[31] = {nTime = 0, nNum = 1,
		tbPrelock = {30},
	...
	[7] = {nTime = 0, nNum = "NpcNum16",
		...
		{	
			{"SetFubenProgress", -1,"探索熔火霹雳"},
			{"BlackMsg", "与独孤剑一同前行！"},
			{"NpcBubbleTalk", "Temporary", "多谢诸位出手相助，此处危险重重，不如我们结伴前行吧！", 4, 0, 1},
	...
	[8] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},
			{"SetFubenProgress", -1,"击败方勉"},
			{"SetNpcProtected", "Leader1", 0},
			{"NpcBubbleTalk", "Leader1", "来者何人，竟敢擅闯我五色教禁地！！", 3, 0, 1},
			{"NpcBubbleTalk", "Temporary", "方... 方勉！！！没想到你竟然是五色教的人！！身为中原武林总堂主，你为何要投敌卖国！！", 3, 3, 1},
			{"NpcBubbleTalk", "Leader1", "独孤剑，居然是你！哼，你也无须多言，擅闯我教禁地今日你必死无疑！！", 3, 6, 1},
	...
	[32] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{	
			{"NpcBubbleTalk", "Leader1", "你们无法再进一步！也休想活着离开这里！", 4, 0, 1},	
	...
	[33] = {nTime = 1, nNum = 0,
		...
		tbUnLockEvent = 
		{	
			{"BlackMsg", "地底熔岩即将喷发，请尽速躲入[FFFE0D]安全区域[-]！！"},
	...
	[34] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{	
			{"NpcBubbleTalk", "Leader1", "可恶的家伙，你们已经成功将我激怒！！准备好领死吧！！！", 4, 0, 1},	
	...
	[100] = {nTime = 0, nNum = 1,
		...
		{
			{"ClearTargetPos"},	
			{"BlackMsg", "前方似乎有位姑娘遇到了麻烦！"},
			{"NpcBubbleTalk", "Xiyou", "哈哈哈，独身一人竟敢擅闯我五色教的地盘，真是不知死活！！", 3, 0, 1},
			{"NpcBubbleTalk", "Temporary", "师妹！！你怎麽会在这里！！！", 3, 1, 1},
			{"NpcBubbleTalk", "Quxia", "师兄！！没想到真的是你！！", 3, 3, 1},
			{"NpcBubbleTalk", "Temporary", "师妹，你且退後休息，这家伙就交给我们来对付吧！！", 3, 6, 1},
			{"NpcBubbleTalk", "Xiyou", "哈哈，大言不惭的小子！你们一并领死吧！！！", 3, 9, 1},
	...
	[101] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "Xiyou", "没想到你们倒还有两下子嘛，但这还远远不够！！", 3, 0, 1},
	...
	[102] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{
			{"NpcBubbleTalk", "Xiyou", "可恶的家伙，你们成功把我激怒了，准备好领死吧！！！", 3, 0, 1},
		},
	},
	[103] = {nTime = 0, nNum = 1,
		tbPrelock = {100},
		...
		tbUnLockEvent = 
		{
			...
			{"SetFubenProgress", -1,"探索熔火霹雳"},
			{"SetNpcProtected", "Quxia", 1},
			{"NpcBubbleTalk", "Temporary", "师妹，此事就交给我吧！！你赶紧离开这里！！", 3, 0, 1},
			{"NpcBubbleTalk", "Quxia", "师兄... 切记万事小心！！", 3, 0, 1},
	...
	[20] = {nTime = 0, nNum = 1,
		...
		{	
			...
			{"SetFubenProgress", -1,"击败南宫灭"},
			{"NpcBubbleTalk", "BOSS", "不得不赞叹你们的实力，但你们接下来你们将面对我！", 3, 0, 1},
			{"NpcBubbleTalk", "Temporary", "南宫灭！少在那里说大话了，我们手底下见真章吧！！", 3, 2, 1},
			{"NpcBubbleTalk", "BOSS", "独孤剑，你屡次破坏我教大事，老夫正愁没机会解决掉你，没想到今日你却送上门来了！", 3, 5, 1},
			{"NpcBubbleTalk", "BOSS", "老夫这就送你们去见阎王，领死吧！！！", 3, 8, 1},
		},
	},
	[36] = {nTime = 9, nNum = 0,
		tbPrelock = {20},
	...
	[37] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{	
			{"NpcBubbleTalk", "BOSS", "游戏结束了！就让你们见识一下我机关之术的威力吧！", 4, 1, 1},				
			...
			{"BlackMsg", "玄天武机出现！将其击败後可以驾驶机关攻击敌人！"},
		},
	},
	...
	[40] = {nTime = 0, nNum = 1,
		...
		tbUnLockEvent = 
		{	
			{"NpcBubbleTalk", "BOSS", "不要做徒劳的挣扎了，你们的死亡是必然的结局！", 4, 1, 1},	
