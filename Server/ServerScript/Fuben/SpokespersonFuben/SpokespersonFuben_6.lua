...
tbFubenSetting.LOCK = 
{
    ...
    [2] = {nTime = 0, nNum = 2,
        ...
        tbStartEvent = 
        {
            {"OpenWindow", "LingJueFengLayerPanel", "Info", 3, 9, "新颖小院"},

            {"OpenWindowAutoClose", "QingRenJieDazuoPanel"},

            {"PlayerBubbleTalk", "我们真没来错地方，此处真是人间仙境"},

            --说话
            {"NpcBubbleTalk", "Npc1", "来吧，莫要在这儿站着了，跟我来", 4, 1, 1},
            {"NpcBubbleTalk", "Npc2", "前面有一处地方，保证你们更是喜欢", 4, 3, 1},
    ...
    [3] = {nTime = 10, nNum = 0,
        ...
        {
            --说话
            {"NpcBubbleTalk", "Npc1", "此处风景优美，又有美酒相伴，何不小酌一番", 4, 1, 1},
            {"NpcBubbleTalk", "Npc2", "正是，我们不当电灯泡啦！你们经许多劫难，好好聚聚！", 4, 3, 1},

            --移动
            {"ChangeNpcAi", "Npc1", "Move", "Fuben_6_Npc1_Move_2", 3, 1, 1, 1, 0},
            {"ChangeNpcAi", "Npc2", "Move", "Fuben_6_Npc2_Move_2", 3, 1, 1, 1, 0},

            {"BlackMsg", "或许应当好好赏花饮酒，共用此刻"},   
            
            {"SetFubenProgress", -1, "查看花树"}, 
        },
    },
    [4] = {nTime = 2, nNum = 0,
        tbPrelock = {3},
    ...
    [5] = {nTime = 0, nNum = 1,
        ...
        tbStartEvent = 
        {
            {"BlackMsg", "如此良辰美景，两人独处，何不畅谈一番？"},  
        },
        tbUnLockEvent = 
        {

            {"SetFubenProgress", -1, "赏花谈心"}, 
        },
    },       
    [6] = {nTime =  55, nNum = 0,
        tbPrelock = {5},
