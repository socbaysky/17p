...
tbFubenSetting.szFubenClass   = "KinTrainBase_Normal";                      -- 副本类型
...
tbFubenSetting.LOCK = 
{
	...
	[6] = {nTime = 5, nNum = 0,
        ...
        tbUnLockEvent = 
        {
			...
			{"NpcBubbleTalk", "enemy1", "有宋人闯入！", 2, 2, 1},
			{"NpcBubbleTalk", "enemy2", "有宋人闯入！", 2, 2, 1},
			{"NpcBubbleTalk", "enemy3", "有宋人闯入！", 2, 2, 1},
        },
    },
	[7] = {nTime = 0, nNum = 18,
        tbPrelock = {6},
        ...
        tbUnLockEvent = 
        {
			...
			{"NpcBubbleTalk", "enemy1", "阻止他们！", 2, 2, 1},
			{"NpcBubbleTalk", "enemy2", "阻止他们！", 2, 2, 1},
			{"NpcBubbleTalk", "enemy3", "阻止他们！", 2, 2, 1},
        },
    },
	[8] = {nTime = 0, nNum = 24,
        tbPrelock = {7},
		...
		--	{"AddNpc", 3, 3, 9, "enemy", "enemy_3_1", false, 0, 0, 0, 0},
			...
			{"NpcBubbleTalk", "enemy1", "冲！", 2, 2, 1},
			{"NpcBubbleTalk", "enemy2", "冲！", 2, 2, 1},
			{"NpcBubbleTalk", "enemy3", "冲！", 2, 2, 1},
	...
	[9] = {nTime = 0, nNum = 15,
		...
		--	{"AddNpc", 3, 3, 10, "enemy", "enemy_3_1", false, 0, 0, 0, 0},
			...
			{"NpcBubbleTalk", "enemy1", "吃我一锤！", 2, 2, 1},
			{"NpcBubbleTalk", "enemy2", "吃我一锤！", 2, 2, 1},
			{"NpcBubbleTalk", "enemy3", "吃我一锤！", 2, 2, 1},
	...
	[10] = {nTime = 0, nNum = 12,
		...
		--	{"AddNpc", 3, 3, 11, "enemy", "enemy_3_1", false, 0, 0, 0, 0},
			...
			{"NpcBubbleTalk", "enemy1", "试试我的软蝟甲！", 2, 2, 1},
			{"NpcBubbleTalk", "enemy2", "试试我的软蝟甲！", 2, 2, 1},
			{"NpcBubbleTalk", "enemy3", "试试我的软蝟甲！", 2, 2, 1},
        },
    },
	[11] = {nTime = 0, nNum = 6,
        tbPrelock = {10},
