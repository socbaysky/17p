...
tbFubenSetting.LOCK = 
{
    ...
    [2] = {nTime = 5, nNum = 0,
        ...
        tbStartEvent = 
        {           
            {"SetFubenProgress", -1, "山贼秘窟"},
            {"BlackMsg", "敌人将在5秒後出现，做好准备！"},
        },
        tbUnLockEvent = 
        {                        
        },
