...
tbFubenSetting.LOCK = 
{
    ...
    [4] = {nTime = 0, nNum = 1,
        ...
        {                
            ...
            {"RaiseEvent", "ChangeRoomState", 2, 1, "击败二层头目"},
        },
        tbUnLockEvent = 
        {
            {"DoDeath", "wall_Lv1_1"},
            ...
            {"RaiseEvent", "ChangeRoomState", 2, 1, "前往下一层", true, 5370, 8213},
    ...
    [5] = {nTime = 0, nNum = 1,
        ...
        {    
            ...
            {"RaiseEvent", "ChangeRoomState", 2, 2, "击败二层头目"},
        },
        tbUnLockEvent = 
        {
            {"DoDeath", "wall_Lv1_2"},
            ...
            {"RaiseEvent", "ChangeRoomState", 2, 2, "前往下一层", true, 5831, 13505},
    ...
    [6] = {nTime = 0, nNum = 1,
        ...
        {    
            ...
            {"RaiseEvent", "ChangeRoomState", 2, 3, "击败二层头目"},
        },
        tbUnLockEvent = 
        {
            {"DoDeath", "wall_Lv1_3"},
            ...
            {"RaiseEvent", "ChangeRoomState", 2, 3, "前往下一层", true, 13966, 10155},
    ...
    [7] = {nTime = 0, nNum = 1,
        ...
        {    
            ...
            {"RaiseEvent", "ChangeRoomState", 2, 4, "击败二层头目"},
        },
        tbUnLockEvent = 
        {
            {"DoDeath", "wall_Lv1_4"},
            ...
            {"DelNpc", "guaiwu1_4"},
            {"RaiseEvent", "ChangeRoomState", 2, 4, "前往下一层", true, 13904, 5556},
    ...
    [9] = {nTime = 0, nNum = 1,
        ...
        {    
            ...
            {"RaiseEvent", "ChangeRoomState", 3, 1, "击败三层头目"},
        },
        tbUnLockEvent = 
        {
            {"DoDeath", "wall_Lv2_1"},
            ...
            {"RaiseEvent", "ChangeRoomState", 3, 1, "前往下一层", true, 8172, 10157},
    ...
    [10] = {nTime = 0, nNum = 1,
        ...
        {    
            ...
            {"RaiseEvent", "ChangeRoomState", 3, 2, "击败三层头目"},
        },
        tbUnLockEvent = 
        {
            {"DoDeath", "wall_Lv2_2"},
            ...
            {"RaiseEvent", "ChangeRoomState", 3, 2, "前往下一层", true, 11850, 7678},
    ...
    [12] = {nTime = 0, nNum = 1,
        ...
        {    
            ...
            {"RaiseEvent", "ChangeRoomState", 4, 1, "击败四层首领"},
        },
        tbUnLockEvent = 
        {
			{"DelNpc", "guaiwu3"},
            {"RaiseEvent", "ChangeRoomState", 4, 1, "离开白虎堂", true, 0, 0},
