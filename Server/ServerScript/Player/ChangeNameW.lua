...
function ChangeName:OnDBResponse( dwRoleId, nCode )
    ...
    if nCode ~= 0  then
        ...
        if pPlayer then
            ...
            local szMsg = string.format("少侠「%s」将名字更改为[f9ffa3]「%s」[-]", szOLdName, szNewName)
