...
local tbOrgQuizs = {
	...
	[12] = "昨天帮派烤火活动谁中奖了？", -- 可能无效
	[13] = "昨天傍晚的武林盟主活动本帮派排名多少？", -- 可能无效
	[14] = "中午的武林盟主活动帮派排名多少？", -- 可能无效
	[15] = "帮派的%s现在多少级？",
	[16] = "最晚加入帮派的是谁？",

	[17] = "帮派里谁的武神殿排名最高？", -- 未做
	[18] = "最近的一次门派竞技帮派里谁的排名最高?", -- 未做
	[19] = "帮派里谁今天获得了战场第1名?", -- 可能无效
	[20] = "帮派里谁今天在英雄挑战第10轮获胜?", -- 可能无效

	[21] = "昨天帮派运镖的镖车是什麽颜色?", -- 可能无效
	[22] = "帮派里谁最近登上了通天塔7层?", -- 可能无效
};
...
local tbKinQuizCreator = {
	...
	[7] = function (kinData) -- "以下成员谁的头衔是:",
		...
		local tbHonorInfo = Player.tbHonorLevelSetting[nSelectHonor] or {Name = "无头衔"};
