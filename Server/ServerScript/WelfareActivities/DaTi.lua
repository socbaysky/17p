...
DaTi.tbAnswerCallback = {
    ...
    ["ZhongQiuJie"] =function (pPlayer, ...)
        Activity:OnPlayerEvent(pPlayer, "Act_ZhognQiuJieAnswerCallBack", ...)
    end,
...
DaTi.tbBeginFunc = {
    ...
    ["WeekendQuestion"] = function (self, pPlayer, nQuestionId, nEndTime)
        ...
        if bRet then 
            ...
            local szTips = string.format("%s正在回答题目：%s",pPlayer.szName,tbQuestionInfo.szTitle)
