...
local tbUpdateRankValFuc = {
	...
	["ZhongQiuJie"] = function (pRank, dwID, nScore)
		pRank.UpdateValueByID(dwID, nScore)
	end;
	...
	["JingMai"] = function (pRank, dwID, nVal)
		pRank.UpdateValueByID(dwID, nVal);
	end;
}
...
function RankBoard:UpdateRankVal(szKey, ...)
	...
	local funcUpdate = tbUpdateRankValFuc[szKey] or tbUpdateRankValFuc["Default"] 
	funcUpdate(pRank, ...)
end
