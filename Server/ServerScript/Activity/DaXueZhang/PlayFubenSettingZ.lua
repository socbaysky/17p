...
tbFubenSetting.LOCK = 
{
    ...
    [1] = {nTime = 10, nNum = 0,
        ...
        tbStartEvent = 
        {
            {"RaiseEvent", "ShowPlayTime", 1, "等待开始:"},
        },
    ...
    [2] = {nTime = 3, nNum = 0,
        ...
        { 
            {"OpenWindow", "ReadyGo"},
            {"BlackMsg", "打雪仗即将开始，共比赛[FFFE0D]3轮[-]！"},
        },
        tbUnLockEvent = 
        {
    ...
    [5] = {nTime = 1, nNum = 0,
        ...
        { 
            ...
            {"BlackMsg", "年兽出现了，小心！！"},
            {"NpcBubbleTalk", "NS", "大胆顽童，无端打闹，扰吾清梦！", 4, 1, 1},
        },
        tbUnLockEvent = 
        {
        },
    ...
    [7] = {nTime = 1, nNum = 0,
        ...
        { 
            {"DelNpc", "NS"},
            {"BlackMsg", "[FFFE0D]年兽大喊:[-]别再闹了，我要睡觉！"},
        },
        tbUnLockEvent = 
        {
        },
    ...
    [8] = {nTime = 30, nNum = 0,    --休息阶段1
        ...
        tbStartEvent = 
        {
            {"RaiseEvent", "ShowPlayTime", 8, "休息阶段:"},
    ...
    [9] = {nTime = 3, nNum = 0,
        ...
        { 
            {"OpenWindow", "ReadyGo"},
            {"BlackMsg", "下一轮打雪仗即将开始，共比赛[FFFE0D]3轮[-]！"},
        },
        tbUnLockEvent = 
        {
        },
    ...
    [11] = {nTime = 150, nNum = 0,
        ...
        { 
            {"ChangeFightState", 1}; --开始比赛
            {"RaiseEvent", "ShowPlayTime", 11, "第二轮:"},
            -- 设置更新采集Npc  nNum, nLock, szGroup, szPointName, bRevive, nUpdateTime, nDelayTime
            {"RaiseEvent", "RandomAddGatherNpc", 10, 0, "GatherNpc", "NpcPos", false, 20, 10},
        },
        tbUnLockEvent = 
    ...
    [16] = {nTime = 30, nNum = 0,    --休息阶段2
        ...
        tbStartEvent = 
        {
            {"RaiseEvent", "ShowPlayTime", 16, "休息阶段:"},
            {"ChangeFightState", 0}; --暂停比赛
            {"RaiseEvent", "CloseRandomGatherNpc", "GatherNpc"}, --关闭更新Npc
            {"DelNpc", "GatherNpc"},--删除采集npc
            {"BlackMsg", "休息阶段，暂停比赛！"},
    ...
    [18] = {nTime = 150, nNum = 0,
        ...
        { 
            {"ChangeFightState", 1}; --开始比赛
            {"RaiseEvent", "ShowPlayTime", 18, "最终轮:"},
            -- 设置更新采集Npc  nNum, nLock, szGroup, szPointName, bRevive, nUpdateTime, nDelayTime
            {"RaiseEvent", "RandomAddGatherNpc", 10, 0, "GatherNpc", "NpcPos", false, 20, 10},
        },
        tbUnLockEvent = 
    ...
    [23] = {nTime = 3, nNum = 0,    --结束阶段
        ...
        tbStartEvent = 
        {
            {"RaiseEvent", "ShowPlayTime", 23, "比赛结束:"},
            {"ChangeFightState", 0}; --暂停比赛
            {"RaiseEvent", "CloseRandomGatherNpc", "GatherNpc"}, --关闭更新Npc
            {"DelNpc", "GatherNpc"},--删除采集npc
            {"BlackMsg", "打雪仗结束了，稍候片刻将离开赛场！"},
        },
        tbUnLockEvent = 
        {
        },
    ...
    [24] = {nTime = 10, nNum = 0,
        ...
        tbStartEvent = 
        {
            ...
            {"RaiseEvent", "ShowPlayTime", 24, "离开赛场:"},
        },
        tbUnLockEvent = 
        {
