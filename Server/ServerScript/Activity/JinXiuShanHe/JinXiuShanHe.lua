...
tbAct.tbTrigger    = {  Init = { },
                        ...
                        End = { },
                        SendWorldNotify = { {"WorldMsg", "各位少侠，“锦绣山河普天同庆”双十活动开始了，大家可通过查询“最新消息”了解活动内容!", 20} },
}
tbAct.JOIN_LEVEL   = 20
tbAct.ITEM         = 3029
...
function tbAct:CheckIdentify(pPlayer)
    self:CheckData(pPlayer)
    return pPlayer.GetUserValue(self.GROUP, self.IDENTIFY) < self.IDENTIFY_NUM, "鉴定失败，今日鉴定卡片数量已达上限!"
end
