...
function tbAct:OnTrigger(szTrigger)
	...
	elseif szTrigger == "Start" then
		...
		self.szName  = Lib:IsEmptyStr(szName) and "限时特惠" or szName
...
function tbAct:GetShopWares()
	...
	local tbFile = LoadTabFile(self.tbParam[1], "ddddsssddssssd", "nGoodsId", {"nGoodsId", "nTemplateId", "nPrice", "nLimitNum", "szMoneyType","szShopType","SubType","nSort","nDiscount","szTimeFrame", "szCloseTimeFrame","szOpenTime", "szCloseTime", "nShowLevel"},1,nOutsidePackage);
	return tbFile;
end
