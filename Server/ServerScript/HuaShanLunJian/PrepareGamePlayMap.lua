...
function tbBaseLogic:DoWin(nFightTeamID)
    ...
    self:ForeachAllPlayerFightTeam(nFightTeamID, {self.SendPlayerMsg, self, "您的战队赢得了本次比赛！"});
...
function tbBaseLogic:DoFail(nFightTeamID)
    ...
    self:ForeachAllPlayerFightTeam(nFightTeamID, {self.SendPlayerMsg, self, "您的战队失利了，再接再厉！"});
...
function tbBaseLogic:DoDogfall(nFightTeamID)
    ...
    self:ForeachAllPlayerFightTeam(nFightTeamID, {self.SendPlayerMsg, self, "你们旗鼓相当，打成了平手！"});
