...
function tbBaseLogic:DoWin(nFightTeamID)
    ...
    self:ForeachAllPlayerFightTeam(nFightTeamID, {self.SendPlayerMsg, self, "您赢得了本次比赛！"});
...
function tbBaseLogic:DoFail(nFightTeamID)
    ...
    self:ForeachAllPlayerFightTeam(nFightTeamID, {self.SendPlayerMsg, self, "您失利了，再接再厉！"});
