...
function KinBattle:StartKinBattleFight()
	...
	if nByeKinId > 0 then
		self.tbKinBattleResult[nByeKinId] = {szOtherKinName = "轮空", tbInfo = {1, 1}, nWinCount = 2, nFailCount = 0, bIsFinish = true};
