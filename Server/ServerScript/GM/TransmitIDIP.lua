...
local IDIP_MARKETSTALL_HAD_ALL_FORBIDDEN = -134
...
local ErrMarketStallHadAllForbidden = string.format("%d MarketStall Had All Forbidden", IDIP_MARKETSTALL_HAD_ALL_FORBIDDEN)
...
{
	[BanOfflineRankType.LevelRank] 				 = {nBanType = Forbid.BanType.LevelRank,szRankTitle = "等级排行榜"},
	[BanOfflineRankType.FightPowerRank] 		 = {nBanType = Forbid.BanType.FightPowerRank,szRankTitle = "战力排行榜"},
	[BanOfflineRankType.WuShenRank]			 	 = {nBanType = Forbid.BanType.WuShenRank,szRankTitle = "武神殿排行榜"},
	[BanOfflineRankType.FactionRank]			 = {nBanType = Forbid.BanType.FightPower_Faction,szRankTitle = "门派排行榜"},
	[BanOfflineRankType.EquipRank] 				 = {nBanType = Forbid.BanType.FightPower_Equip,szRankTitle = "洗练排行榜"},
	[BanOfflineRankType.StrengthenRank] 	     = {nBanType = Forbid.BanType.FightPower_Strengthen,szRankTitle = "强化排行榜"},
	[BanOfflineRankType.StoneRank] 				 = {nBanType = Forbid.BanType.FightPower_Stone,szRankTitle = "镶嵌排行榜"},
	[BanOfflineRankType.PartnerRank]			 = {nBanType = Forbid.BanType.FightPower_Partner,szRankTitle = "同伴排行榜"},
	[BanOfflineRankType.CardCollection_1Rank]	 = {nBanType = Forbid.BanType.CardCollection_1,szRankTitle = "凌绝峰收集榜"},
...
tbIDIPInterface.tbClearRank =
{
	...
	Level 	   = "等级排行榜",
	FightPower_Equip = "洗练",
	FightPower_Strengthen = "强化",
	FightPower_Stone = "镶嵌",
	FightPower_Partner = "同伴",
	CardCollection_1 = "凌绝峰收集榜",
}
...
local tbRechargeData =
	{
		...
		[Recharge_Type.YIBENWANLI_6] =
		{
			szCall = "SetYiBenWanLi",
			tbParam = {8, 156},
		},
		[Recharge_Type.YIBENWANLI_7] =
		{
			szCall = "SetYiBenWanLi",
			tbParam = {9, 157},
		},
		[Recharge_Type.WEEK_CARD] =
		{
			szCall = "SetDaysCard",
			tbParam = {1},
		},
		[Recharge_Type.MONTH_CARD] =
		{
			szCall = "SetDaysCard",
			tbParam = {2},
		},
		[Recharge_Type.DAY_CARD_60] =
		{
			szCall = "SetOneDaysCardPlus",
			tbParam = {1},
		},
	}
...
{
	[NewMsgType.Level_1] = "抢购",
	[NewMsgType.Level_2] = "紧急",
	[NewMsgType.Level_3] = "活动",
...
local AuctionShutDownType = 
{
	All 			 = 0; 						-- 所有活动
	WuLinMengZhu 	 = 1; 						-- 武林盟主
	MingJiangTrain	 = 2;						-- 名将试炼
	KinTrain 		 = 3;  						-- 家族试炼
	BaiHuTang		 = 4;						-- 白虎堂
	ShiHuangJiangLin = 5;						-- 始皇降临
	NvDiFuSu		 = 6; 						-- 女帝复苏
	GongChengZhan	 = 7; 						-- 攻城战
	LingDiXingShang  = 8; 						-- 领地行商
	XingJiaoShangRen = 9; 						-- 西域行商
	WorldAuction 	 = 10; 						-- 世界拍卖
	CrossBoss	 	 = 11; 						-- 跨服盟主
}

local AllAuctionShutDownTypeRef = 
{
	[AuctionShutDownType.All] 				= {"Boss","BossLeader_Boss","KinTrain","WhiteTigerFuben_Cross",
	"ImperialTombEmperor","ImperialTombFemaleEmperor","DomainBattle","DomainBattleAct","Dealer","Global","CrossBoss"};
	[AuctionShutDownType.WuLinMengZhu] 		= {"Boss"};
	[AuctionShutDownType.MingJiangTrain]	= {"BossLeader_Boss"};
	[AuctionShutDownType.KinTrain] 			= {"KinTrain"};
	[AuctionShutDownType.BaiHuTang] 		= {"WhiteTigerFuben_Cross"};
	[AuctionShutDownType.ShiHuangJiangLin]  = {"ImperialTombEmperor"};
	[AuctionShutDownType.NvDiFuSu] 			= {"ImperialTombFemaleEmperor"};
	[AuctionShutDownType.GongChengZhan] 	= {"DomainBattle"};
	[AuctionShutDownType.LingDiXingShang]   = {"DomainBattleAct"};
	[AuctionShutDownType.XingJiaoShangRen]  = {"Dealer"};
	[AuctionShutDownType.WorldAuction]		= {"Global"};
	[AuctionShutDownType.CrossBoss]			= {"CrossBoss"};
}

-- 请求加载好友数据的玩家
tbIDIPInterface.tbFriendData = tbIDIPInterface.tbFriendData or {}

-- 配套个人空间
tbIDIPInterface.Type_Achi_Zan = 1 			-- 点赞
tbIDIPInterface.Type_Achi_Gift1 = 2 		-- 送一见倾心
tbIDIPInterface.Type_Achi_Gift2 = 3  		-- 送浓情蜜意
tbIDIPInterface.Type_Achi_Gift3 = 4 		-- 送真爱告白

-- 好声音
local tbGoodVoiceAct = Activity:GetClass("GoodVoice")
tbIDIPInterface.tbGoodVoiceSignUpType = 
{
	Local = 1; 				-- 本服海选
	SimiFinal = 2; 			-- 全服复赛
	Final = 3; 				-- 全服决赛
}
tbIDIPInterface.tbAllGoodVoiceSignUpType = 
{
	[tbIDIPInterface.tbGoodVoiceSignUpType.Local] = tbGoodVoiceAct.STATE_TYPE.LOCAL;
	[tbIDIPInterface.tbGoodVoiceSignUpType.SimiFinal] = tbGoodVoiceAct.STATE_TYPE.SEMI_FINAL;
	[tbIDIPInterface.tbGoodVoiceSignUpType.Final] = tbGoodVoiceAct.STATE_TYPE.FINAL;
}
...
function tbIDIPInterface:IdipDelayCostGold(nPlayerId,nGold, nIsNegative,szSource,szSerial)
	...
	pPlayer.CostGold(nCost, Env.LogWay_IdipDoDelDiamondReq, nil, function (nPlayerId, bSuccess)
			if bSuccess then
				local nDebt = math.abs(nGold) - nCost
				if nIsNegative == 1 and nDebt > 0 then
					Player:AddMoneyDebt(nPlayerId, "Gold", nDebt, Env.LogWay_Money_Debt_Add, 0, true)
				end
			else
				if nIsNegative == 1 then
					Player:AddMoneyDebt(nPlayerId, "Gold", math.abs(nGold), Env.LogWay_Money_Debt_Add, 0, true)
			...
			Log("IDIP_DO_DEL_DIAMOND_REQ IdipDelayCostGold CostGold ", nPlayerId, nGold, nCost, nIsNegative, bSuccess and 1 or 0);
			return true;
		end);
end
...
function tbIDIPInterface.OnCostGoldCallBack(nPlayerId, bSuccess,szBilloNo, szSource, szSerial, nGold, nCost, nIsNegative)
	...
	Log("IDIP_DO_DEL_DIAMOND_REQ OnCostGoldCallBack CostGold", nPlayerId, nGold, nCost, nIsNegative, bSuccess and 1 or 0);
	return true
end
...
function tbIDIPInterface:GetAwardList(nType, nItemId, nItemNum, nExpireTime)
	if nType then
		...
		elseif nType == tbItemType.ZhenQi then
			return {"ZhenQi",nItemNum};
		end
	end
end
...
function tbIDIPInterface:OnSendAttachMailCheckFinish(szAccount, dwPlayerId, nIsMatch,nCmdId, tbReq, nCmdSequence)
	...
	tbMail.From = (szFrom == "" and "系统" or szFrom) 
...
function tbIDIPInterface:IDIP_QUERY_ROLELIST_REQ(nCmdId, tbReq,nCmdSequence)
	Player:DoAccountRoleListRequest(tbReq.OpenId, tbReq.PlatId, Transmit.tbIDIPInterface.OnAccountRoleListResult, Transmit.tbIDIPInterface, nCmdSequence,tbReq,nCmdId)
end
...
function tbIDIPInterface:OnQueryUsrInfoCheckFinish(szAccount, dwPlayerId, nIsMatch,nCmdId, tbReq, nCmdSequence)
	...
	if pPlayer then
		...
		tbRsp.Reiki = pPlayer.GetMoney("ZhenQi");
		tbRsp.Sex = pPlayer.nSex
		TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0, 0, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
			tbReq.Partition, dwPlayerId,  0, "IDIP_QUERY_USR_INFO_REQ","immediately", tbRsp.Sex)
...
function tbIDIPInterface:OnQueryPlayerBaseInfo(tbQueryInfo,nCmdSequence,tbReq)
	...
	if tbQueryInfo and next(tbQueryInfo) then
		...
		tbRsp.Reiki = tbQueryInfo.nZhenQi;
		tbRsp.Sex = pPlayerInfo.nSex
	end

	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0, 0, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
			tbReq.Partition, tbReq.RoleId,  0, "IDIP_QUERY_USR_INFO_REQ","delay", tbRsp.Sex)
...
function tbIDIPInterface:CostMoneyDebt(dwID, szType, nCost)
	local pPlayer = KPlayer.GetPlayerObjById(dwID)
	if not pPlayer then
	   Log("tbIDIPInterface fnCostMoneyDebt no player ", dwID, szType, nCost)
       return 
	end
	local nOrg = pPlayer.GetMoney(szType)
	if not nOrg then
		Log("tbIDIPInterface fnCostMoneyDebt err szType ", dwID, szType, nCost)
        return 
	end
	nCost = math.abs(nCost)
	if nOrg == 0 then
		Player:AddMoneyDebt(dwID, szType, nCost, Env.LogWay_IdIpCostMoneyDept, nil, true)
		return
	end
	local nOrgCost = nCost < nOrg and nCost or nOrg
	if nOrgCost > 0 then
		pPlayer.CostMoney(szType, nOrgCost, Env.LogWay_IdIpCostMoneyDept)
	end
	local nDebt = nCost - nOrg
	if nDebt > 0 then
		Player:AddMoneyDebt(dwID, szType, nDebt, Env.LogWay_IdIpCostMoneyDept, nil, true)
	end
	Log("tbIDIPInterface fnCostMoneyDebt ok ", dwID, szType, nCost, nOrg, nOrgCost, nDebt)
end
...
function tbIDIPInterface:OnUpdatHonhrContributeCheckFinish(szAccount, dwPlayerId, nIsMatch,nCmdId, tbReq, nCmdSequence)
	...
	if pPlayer then
		...
		elseif nValue < 0 then
			self:CostMoneyDebt(dwPlayerId, szType, nValue)
		end
		tbRsp.EndValue = pPlayer.GetMoney(szType)
	else
		local pPlayerInfo = KPlayer.GetRoleStayInfo(tbReq.RoleId);
		if pPlayerInfo then
			local szCmd = "";
			...
			elseif nValue < 0 then
				szCmd = string.format("Transmit.tbIDIPInterface:CostMoneyDebt(%d, '%s', %d)", dwPlayerId, szType, nValue);
			end
			KPlayer.AddDelayCmd(tbReq.RoleId,
				szCmd,
...
function tbIDIPInterface:IDIP_DO_SEND_ATTACH_MAIL_TO_DESIGN_PARTION_LEVEL_PLAYER_REQ(nCmdId, tbReq, nCmdSequence)
	...
	local nNowTime = GetTime()
	local nActiveTime = tonumber(tbReq.Time) or 0			-- 活跃玩家登陆判定时间
	local nOverdueTime = tonumber(tbReq.EndTime) or 0      -- 道具领取有效期：数字（秒）0为永久有效
	if not tonumber(tbReq.Type) or not tonumber(tbReq.ItemNum) or not tonumber(tbReq.Level) or nOverdueTime < 0 or nActiveTime < 0 then
		tbRsp.Result = IDIP_INVALID_PARAM
        tbRsp.RetMsg = ErrInvalidParam
	...
	local bNotValidTime = nOverdueTime == 0 and true or false
	local nItemValidTime 
	if not bNotValidTime then
		nItemValidTime = nNowTime + nOverdueTime
	end
	if bNotValidTime then
		nOverdueTime = nil
	end
	...
	tbMail.nRecyleTime = nOverdueTime
	tbMail.nMinLastLogintTime = nActiveTime
	local bIsHaveItem = nil
	if tbReq.Type == tbItemType.item then
		if not tonumber(tbReq.ItemId) then
			tbRsp.Result = IDIP_INVALID_ITEM_ID
	...
	local tbAward = self:GetAwardList(tbReq.Type,tbReq.ItemId,tbReq.ItemNum,nItemValidTime);
	if not tbAward then
		tbRsp.Result = IDIP_INVALID_ITEM_TYPE
		tbRsp.RetMsg = ErrInValidItemType
	...
	tbMail.tbAttach = {tbAward};
	if nActiveTime > 0 then
		Mail:SendGlobalSystemMailTimeLimit(tbMail)
	else
		Mail:SendGlobalSystemMail(tbMail);
	end
	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, tbReq.ItemId, tbReq.ItemNum, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		tbReq.Partition, tbReq.RoleId,0, "IDIP_DO_SEND_ATTACH_MAIL_TO_DESIGN_PARTION_LEVEL_PLAYER_REQ",tbReq.Level,tbReq.MailTitle,tbReq.MailContent,tbReq.Type,tbReq.Time,tbReq.EndTime)
...
function tbIDIPInterface:OnBanRoleCheckFinish(szAccount, dwPlayerId, nIsMatch,nCmdId, tbReq, nCmdSequence)
	...
	local pPlayer = KPlayer.GetPlayerObjById(dwPlayerId)
	if pPlayer and szReason ~= "" then
		pPlayer.CallClientScript("Ui:OnShowKickMsg", string.format("此角色由於%s已被冻结", szReason));
	end
...
function tbIDIPInterface:IdipAQDelayCostGold(nPlayerId,nGold,nIsNegative,szSource,szSerial)
	...
	pPlayer.CostGold(nCost,Env.LogWay_IdipDoUpdateDiamondReq,nil,function (nPlayerId, bSuccess)
			...
			Log("IDIP_AQ_DO_UPDATE_DIAMOND_REQ IdipAQDelayCostGold CostGold ", nPlayerId, nGold, nCost, nIsNegative, bSuccess and 1 or 0);
			return true;
		end);
end
...
function tbIDIPInterface.OnAQCostGoldCallBack(nPlayerId, bSuccess,szBilloNo, szSource, szSerial, nGold, nCost, nIsNegative)
	...
	Log("IDIP_AQ_DO_UPDATE_DIAMOND_REQ OnAQCostGoldCallBack CostGold ", nPlayerId, nGold, nCost, nIsNegative, bSuccess and 1 or 0);
	return true
end
...
function tbIDIPInterface:IDIP_AQ_QUERY_ROLELIST_REQ(nCmdId, tbReq,nCmdSequence)
	Player:DoAccountRoleListRequest(tbReq.OpenId, tbReq.PlatId, Transmit.tbIDIPInterface.OnQueryRoleList, Transmit.tbIDIPInterface, nCmdSequence,tbReq,nCmdId)
end
...
function tbIDIPInterface:OnRelievePunishCheckFinish(szAccount, dwPlayerId, nIsMatch,nCmdId, tbReq, nCmdSequence)
	...
	local nRelieveJail 		  = tonumber(tbReq.RelieveJail) or 0
	...
	if nRelieveBanJoinRank == 1 then							-- 解除禁止参与排行榜限制（0 否，1 是）
		if Forbid:IsBanning(_,Forbid.BanType.KinRank,pPlayerInfo.dwKinId) then
			szRelieveType = szRelieveType ..",帮派排行榜"
		end
		-- 家族与玩家在线与否无关
	...
	if nRelieveZeroProfit == 1 then								-- 解除零收益状态（0 否，1 是）
		if pPlayer then
			if Forbid:IsForbidAward(pPlayer) then
				szRelieveType = szRelieveType ..",零收益状态"
			end
	...
	if nRelieveJail == 1 then 									-- 解除监禁状态（0 否，1 是）
		if pPlayer then
			if pPlayer.GetPrisonLeftTime() > 0 then
				szRelieveType = szRelieveType ..",监禁状态"
			end
			pPlayer.PushToPrison(0)
		else
			szCmd = szCmd .."me.PushToPrison(0);"
		end
	end
	...
	if pPlayer and szRelieveType and szRelieveType ~="" then
		pPlayer.MsgBox(string.format("解除禁止状态%s",szRelieveType), {{"确定"}, {"取消"}})
	end
...
function tbIDIPInterface:OnBanJoinRankOfflineCheckFinish(szAccount, dwPlayerId, nIsMatch,nCmdId, tbReq, nCmdSequence)
	...
	if pPlayer then
		pPlayer.MsgBox(string.format("您由於%s被禁止上榜，禁止时间%s",szTips, Lib:TimeDesc2(nTime) or ""), {{"确定"}, {"取消"}})
	end
...
function tbIDIPInterface:OnSetBuyStateCheckFinish(szAccount, dwPlayerId, nIsMatch,nCmdId, tbReq, nCmdSequence)
	...
	if pPlayer then
		...
		szCmd = "Transmit.tbIDIPInterface:%s(%d"
		for i=1, #tbParam do
			szCmd = szCmd ..",%d"
		end
		szCmd = szCmd ..")"
		szCmd = string.format(szCmd, szCall, dwPlayerId, unpack(tbParam))
	end
...
function tbIDIPInterface:SetYiBenWanLi(dwID, nGroupIndex, nEventId)
	...
	if pPlayer.GetUserValue(Recharge.SAVE_GROUP, nBuyedKey) == 0 then
		local tbRechargeInfo = Recharge.tbSettingGroup.GrowInvest[nGroupIndex]
		pPlayer.SetUserValue(Recharge.SAVE_GROUP, nBuyedKey, GetTime() + 3600 * 24 * tbRechargeInfo.nLastingDay);
...
-- 周卡月卡
function tbIDIPInterface:SetDaysCard(dwID, nGroupIndex)
	local pPlayer = KPlayer.GetPlayerObjById(dwID)
	if not pPlayer then
		Log("[tbIDIPInterface] fnSetDaysCard not player",dwID)
		return
	end
	local tbInfo = Recharge.tbSettingGroup.DaysCard[nGroupIndex]
	if not tbInfo then
		Log("[tbIDIPInterface] fnSetDaysCard valid param nGroupIndex", dwID, nGroupIndex)
		return
	end
	...
	Recharge:OnBuyDaysCardCallBack(pPlayer, nNewEndTime, tbInfo.nGroupIndex)
end

-- 60元7日礼包
function tbIDIPInterface:SetOneDaysCardPlus(dwID, nGroupIndex)
	local pPlayer = KPlayer.GetPlayerObjById(dwID)
	if not pPlayer then
		Log("[tbIDIPInterface] fnSetOneDaysCardPlus not player", dwID, nGroupIndex)
		return
	end
	local tbBuyInfo = Recharge.tbSettingGroup.DayGiftPlus[nGroupIndex]
	if not tbBuyInfo then
		Log("[tbIDIPInterface] fnSetOneDaysCardPlus valid param nGroupIndex", dwID, nGroupIndex)
		return
	end
	...
	local nNewEndTime = nLocalEndTime + 3600 * 24 * tbBuyInfo.nLastingDay
	Recharge:OnBuyOneDayCardPlusCallBack(pPlayer, nNewEndTime, nGroupIndex)
end
...
function tbIDIPInterface:OnDoUsrSendWineHouseMsgCheckFinish(szAccount, dwPlayerId, nIsMatch,nCmdId, tbReq, nCmdSequence)
    ...
    if nChannel == ChannelType.Kin then
        ...
        ChatMgr:SendPlayerMsg(ChatMgr.ChannelType.Kin, dwPlayerId, pStayInfo.szName, pStayInfo.nFaction, pStayInfo.nPortrait, pStayInfo.nSex, pStayInfo.nLevel, szMsg,tbLinkData, nKinId)
    elseif nChannel == ChannelType.Friend then
        ...
        ChatMgr:SendPlayerMsg(ChatMgr.ChannelType.Friend, dwPlayerId, pStayInfo.szName, pStayInfo.nFaction, pStayInfo.nPortrait, pStayInfo.nSex, pStayInfo.nLevel, szMsg,tbLinkData)
...
function tbIDIPInterface:SetYiBenWanLiNewYear(dwPlayerId, nGroupIndex)
	...
	local tbRechargeInfo = Recharge.tbSettingGroup.GrowInvest[nGroupIndex]
	Recharge:OnBuyInvestCallBack(pPlayer, GetTime() + 3600 * 24 * tbRechargeInfo.nLastingDay, nGroupIndex)
...
function tbIDIPInterface:IDIP_DO_FRESHEN_SERVER_INFO_REQ(nCmdId, tbReq, nCmdSequence)
	...
	local nSwitch = tonumber(tbReq.Switch) or 0
	if nSwitch == 1 then
		-- 服务器刷新资源信息请求
		ChatMgr:ReloadChatHostInfo()
	elseif nSwitch == 2 then
		-- 更新超R白名单接口(已废弃)
	else
		tbRsp.Result = IDIP_INVALID_PARAM
        tbRsp.RetMsg = ErrInvalidParam
	...
	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0, 0, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		tbReq.Partition, 0, 0, "IDIP_DO_FRESHEN_SERVER_INFO_REQ", nSwitch)
...
function tbIDIPInterface:OnDoValuePrettyPinkCheckFinish(szAccount, dwPlayerId, nIsMatch,nCmdId, tbReq, nCmdSequence)
	...
	pPlayer.Msg(string.format("消耗了%d个红粉佳人进行投票！", nDelCount))
...
function tbIDIPInterface:OnQueryClothesInfoCheckFinish(szAccount, dwPlayerId, nIsMatch,nCmdId, tbReq, nCmdSequence)
	...
	if tbEquipInfo then
		...
		if tbWaiHead then
			tbRsp.TireId = tbWaiHead.nShowResId
		elseif tbHead then
			tbRsp.TireId = tbHead.nShowResId
		else
			local _ , tbPartRes = KPlayer.GetNpcResId(pPlayerInfo.nFaction, pPlayerInfo.nSex);
			tbRsp.TireId = tbPartRes[Npc.NpcResPartsDef.npc_part_head] or 0;
		end
	end

	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0, 0, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		tbReq.Partition, tbReq.RoleId, tbRsp.ClothesId, tbRsp.ItemId, "IDIP_QUERY_CLOTHES_INFO_REQ", (pPlayerInfo and "immediately") or "delay", tbRsp.TireId)
...
function tbIDIPInterface:IDIP_DO_SEND_BELL_WIN_REQ(nCmdId, tbReq,nCmdSequence)
	...
	tbAct:OnWinnerResult(nWinnerType, tonumber(tbReq.BePartition), tbReq.Name,
				 ...
				 tonumber(tbReq.ClothesId),  tonumber(tbReq.ItemId), tonumber(tbReq.TireId));

	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, nWinnerType, nFaction, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		tbReq.Partition, tbReq.RoleId, tbReq.BePartition, tbReq.RoleName, tbReq.ClothesId, tbReq.ItemId, tostring(tbReq.TireId), tbReq.Name,
...
function tbIDIPInterface:IDIP_DO_REIKI_VALUE_REQ(nCmdId, tbReq,nCmdSequence)
	Player:DoAccountRoleMatchRequest(tbReq.OpenId,tbReq.RoleId,Transmit.tbIDIPInterface.OnReikiCheckFinish,Transmit.tbIDIPInterface,nCmdId,tbReq,nCmdSequence);
end

-- 扣除货币（szType货币类型<元宝除外> nValue想要扣多少, bIsNegative是否扣到负）
function tbIDIPInterface:DoCostMoneyDebt(pPlayer, szType, nValue, nLogWay, bIsNegative)
	nValue = math.abs(nValue)
	local nCost = self:GetCost(pPlayer, szType, nValue);
	if nCost > 0 then
		pPlayer.CostMoney(szType, nCost, nLogWay);
	end
	local nNegative = nValue - nCost
	if bIsNegative and nNegative > 0 then
		Player:AddMoneyDebt(pPlayer.dwID, szType, nNegative, Env.LogWay_Money_Debt_Add, 0, true)
	end
end

function tbIDIPInterface:OnReikiCheckFinish(szAccount, dwPlayerId, nIsMatch,nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	...
	if nIsMatch == 0 then
		tbRsp.Result = IDIP_PLAYER_NOT_EXIST;
		tbRsp.RetMsg = ErrInValidAccountRoleIdNotMatch;
		self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_REIKI_VALUE_REQ", nCmdSequence)
		return
	end
	local nValue = tonumber(tbReq.Value);
	if not nValue then
	...
	if pPlayer then
		if nValue >= 0 then
			pPlayer.AddMoney("ZhenQi",nValue,Env.LogWay_IdipDoReikiReq);
		elseif nValue < 0 then
			self:DoCostMoneyDebt(pPlayer, "ZhenQi", nValue, Env.LogWay_IdipDoReikiReq, true)
		end
	else
		local pPlayerInfo = KPlayer.GetRoleStayInfo(tbReq.RoleId);
		if pPlayerInfo then
			...
			local nCost = nValue;
			if nCost >= 0 then
				szCmd = string.format("me.AddMoney('ZhenQi', %d, %d)",nCost,Env.LogWay_IdipDoReikiReq);
			elseif nCost < 0 then
				szCmd = string.format("Transmit.tbIDIPInterface:DoCostMoneyDebt(me, 'ZhenQi', %d, Env.LogWay_IdipDoReikiReq, true)", nValue);
			end
			KPlayer.AddDelayCmd(tbReq.RoleId,
				szCmd,
				string.format("%s|%d|%s|%s", 'IDIP_DO_REIKI_VALUE_REQ', nCost, tbReq.Source or "nil", tbReq.Serial or "nil"))
		else
			tbRsp.Result = IDIP_PLAYER_NOT_EXIST
			tbRsp.RetMsg = ErrPlayerNotExist
			self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_REIKI_VALUE_REQ", nCmdSequence)
	...
	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0, tbReq.Value, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		tbReq.Partition, tbReq.RoleId, 0, "IDIP_DO_REIKI_VALUE_REQ", (pPlayer and "immediately") or "delay")

	self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_REIKI_VALUE_REQ", nCmdSequence)
end

function tbIDIPInterface:IDIP_DO_ANTI_ADDICTION_SWITCH_REQ(nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	...
	local nSwitch = tonumber(tbReq.Switch) or 0
	if nSwitch ~= 1 and nSwitch ~= 2 then
		tbRsp.Result = IDIP_INVALID_PARAM
		tbRsp.RetMsg = ErrInvalidParam
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg,"IDIP_DO_ANTI_ADDICTION_SWITCH_REQ", nCmdSequence)
		return
	end
	-- 开启
	if nSwitch == 1 then
		if not AddictionTip.bOpen then
			AddictionTip.bOpen = true;
			AddictionTip:Setup();
			Timer:Register(Env.GAME_FPS, function ()
				...
				for _, pPlayer in pairs(tbAllPlayer) do
					...
					pPlayer.nAddictionPlayerType = AddictionTip.ADULT_TYPE;
					AddictionTip:DoHttpReq(pPlayer, nTimeNow, AddictionTip.MSG_TYPE_GET_USERINFO_SINGLE, {account_id = pPlayer.szAccount, character_id = tostring(pPlayer.dwID)});
				end
			end)
		end
	-- 关闭
	elseif nSwitch == 2 then
		AddictionTip.bOpen = false
	end

	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0,0, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
	        tbReq.Partition, 0, 0, "IDIP_DO_ANTI_ADDICTION_SWITCH_REQ", tbReq.Switch)

	self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_ANTI_ADDICTION_SWITCH_REQ",nCmdSequence)
end

function tbIDIPInterface:GetRefluxCompensationRspList()
	local tbRewardList1 = { 								-- 回归福利奖励列表
			CallUp = 0, 									-- 白银召集令(银两抽卡招募令)
			Chivairous =  0, 								-- 回归侠士称号(回归称号)
			Spy = 0, 										-- 名侠密探令(元宝抽卡招募令)
			Quality = 0, 									-- 修为
			Double = 0, 									-- 双倍重置令
			Vitality = 0, 									-- 回归专属元气
	...
	local tbRewardList2 = { 								-- 回归特权奖励列表
			SaleNum = 0, 									-- 商城打折购买刷新次数
			ResetNum = 0, 									-- 被传功次数重置
			FreeNum = 0, 									-- 免费摇钱树次数
			Double = 0, 									-- 武林盟主奖励翻倍次数
			Task = 0, 										-- 商会任务奖励翻倍次数
	...
	local tbRewardList3 = { 								-- 回归好礼奖励列表
			["6Kpc"] = 0, 									-- 6元超值福利礼包
			["6Return"] = 0, 								-- 6元超值归回礼包
			["30KpcLuxury"] = 0, 							-- 30元超值豪华礼包
			["6ReturnVcion"] = 0, 							-- 6元回归元宝礼包
			["30ReturnVcion"] = 0, 							-- 30元回归元宝礼包
		} 				
	local tbRsp =  {
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
		ReturnPaladin = 2, 									-- 回归资格（1.回流玩家；(有资格)2.非回流玩家（没资格））
		RewardList1_count = 0, 								-- 回归福利奖励列表的最大数量(固定，列表个数)
		RewardList1 = { 									-- 回归福利奖励列表
			tbRewardList1;
		}, 							
		RewardList2_count = 0, 							    -- 回归特权奖励列表的最大数量(固定，列表个数)
		RewardList2 = { 									-- 回归特权奖励列表
			tbRewardList2;
		}, 									
		RewardList3_count = 0, 								-- 回归好礼奖励列表的最大数量(固定，列表个数)
		RewardList3 = { 									-- 回归好礼奖励列表
			tbRewardList3;
		}, 									
	}
	tbRsp.RewardList1_count = Lib:CountTB(tbRsp.RewardList1)
	tbRsp.RewardList2_count = Lib:CountTB(tbRsp.RewardList2)
	tbRsp.RewardList3_count = Lib:CountTB(tbRsp.RewardList3)
	return tbRsp
end

function tbIDIPInterface:IDIP_QUERY_REFLUX_COMPENSATION_REQ(nCmdId, tbReq,nCmdSequence)
	Player:DoAccountRoleMatchRequest(tbReq.OpenId,tbReq.RoleId,Transmit.tbIDIPInterface.OnQueryRefluxCompensation,Transmit.tbIDIPInterface,nCmdId,tbReq,nCmdSequence);
end

function tbIDIPInterface:OnQueryRefluxCompensation(szAccount, dwPlayerId, nIsMatch, nCmdId, tbReq, nCmdSequence)
	local tbRsp = self:GetRefluxCompensationRspList()
	if nIsMatch == 0 then
		tbRsp.Result = IDIP_PLAYER_NOT_EXIST;
		tbRsp.RetMsg = ErrInValidAccountRoleIdNotMatch;
		self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_QUERY_REFLUX_COMPENSATION_REQ", nCmdSequence)
		return
	end
	Player:DoPlayerQueryInfoRequest(dwPlayerId, Transmit.tbIDIPInterface.OnRefluxCompensationQueryPlayerBaseInfo, Transmit.tbIDIPInterface, nCmdSequence, tbReq, dwPlayerId)
end

function tbIDIPInterface:OnRefluxCompensationQueryPlayerBaseInfo(tbQueryInfo, nCmdSequence, tbReq, dwPlayerId)
	tbQueryInfo = tbQueryInfo or {}
	local tbRsp = self:GetRefluxCompensationRspList()
	local nLastOnlineTime
	local nVip = tbQueryInfo.nVipLevel or 0
	local pPlayer = KPlayer.GetPlayerObjById(dwPlayerId);
	-- 在线的话就肯定没有资格
	if not pPlayer then
		local pPlayerInfo = KPlayer.GetRoleStayInfo(dwPlayerId);
		if pPlayerInfo then
			local nLastOnlineTime = pPlayerInfo.nLastOnlineTime or 0
			if nLastOnlineTime > 0 and pPlayerInfo.nLevel >= RegressionPrivilege.Privilege_Lv then
				local nLastOnlineDay = Lib:GetLocalDay(nLastOnlineTime)
				local nNowDay = Lib:GetLocalDay()
				local tbList = RegressionPrivilege:GetPrivilegeByOutDay(nNowDay - nLastOnlineDay, nVip)
				if tbList then
					tbRsp.ReturnPaladin = 1
					tbRsp.RewardList1[1].CallUp = tbList.F_YinLiang or 0
					tbRsp.RewardList1[1].Chivairous = tbList.F_Title or 0
					tbRsp.RewardList1[1].Spy = tbList.F_YuanBao or 0
					tbRsp.RewardList1[1].Quality = tbList.F_XiuWei or 0
					tbRsp.RewardList1[1].Double = tbList.F_ChongZhi or 0
					tbRsp.RewardList1[1].Vitality = tbList.F_YuanQi or 0
					tbRsp.RewardList1[1].ItemId = tbList.F_WaiZhuang or 0
					tbRsp.RewardList2[1].SaleNum = tbList.RefreshShop or 0
					tbRsp.RewardList2[1].ResetNum = tbList.ChuanGong or 0
					tbRsp.RewardList2[1].FreeNum = tbList.MoneyTree or 0
					tbRsp.RewardList2[1].Double = tbList.D_Boss or 0
					tbRsp.RewardList2[1].Task = tbList.D_CommerceTask or 0
					tbRsp.RewardList2[1].Threat = tbList.D_HeroChallenge or 0
					tbRsp.RewardList2[1].Award = tbList.D_RankBattle or 0
					tbRsp.RewardList2[1].EveryDay = tbList.EveryDayTarget or 0
					tbRsp.RewardList3[1]["6Kpc"] = tbList.Recharge_4 or 0
					tbRsp.RewardList3[1]["6Return"] = tbList.Recharge_3 or 0
					tbRsp.RewardList3[1]["30KpcLuxury"] = tbList.Recharge_5 or 0
					tbRsp.RewardList3[1]["6ReturnVcion"] = tbList.Recharge_1 or 0
					tbRsp.RewardList3[1]["30ReturnVcion"] = tbList.Recharge_2 or 0
				end 
			end 
		else
			tbRsp.Result = IDIP_PLAYER_NOT_EXIST
	...
	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0, tbReq.Value, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		tbReq.Partition, tbReq.RoleId, 0, "IDIP_QUERY_REFLUX_COMPENSATION_REQ", (pPlayer and "immediately") or "delay", nLastOnlineTime or 0, nVip, next(tbQueryInfo) and 1 or 0)

	self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_QUERY_REFLUX_COMPENSATION_REQ", nCmdSequence)
end

function tbIDIPInterface:IDIP_DO_SEND_STAR_VOICE_REQ(nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	}
	local nStarNum = tonumber(tbReq.StarNum) or 0    -- 显示明星（1赵丽颖，2林更新）
	local nChannel = tonumber(tbReq.Channel) or 0 	 -- 发送频道（1私聊频道，2世界频道）
	local nVoiceId = tonumber(tbReq.VoiceNum) or 0  -- 播放语音条目
	local szMessage = tbReq.Message 				 -- 显示文字（128字节文本）
	local nChannelType, nFakePlayerId
	if nChannel == 1 then
		nChannelType = ChatMgr.ChannelType.Private
	elseif nChannel == 2 then
		nChannelType = ChatMgr.ChannelType.Public
	end
	if nStarNum == 1 then
		nFakePlayerId = ShengDianAct.nZLY
	elseif nStarNum == 2 then
		nFakePlayerId = ShengDianAct.nLGX
	end
	if not nChannelType or not nFakePlayerId then
		tbRsp.Result = IDIP_INVALID_PARAM
		tbRsp.RetMsg = ErrInvalidParam
		self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_SEND_STAR_VOICE_REQ", nCmdSequence)
		return
	end
	local bRet, szMsg = ShengDianAct:SendMessage(nChannelType, nFakePlayerId, szMessage, nVoiceId)
	if not bRet then
		tbRsp.Result = IDIP_INVALID_PARAM
		tbRsp.RetMsg = ErrInvalidParam
		self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_SEND_STAR_VOICE_REQ", nCmdSequence)
	...
	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0,0, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
	        tbReq.Partition, 0, 0, "IDIP_DO_SEND_STAR_VOICE_REQ", nStarNum, nChannel, nVoiceId, szMessage, szMsg or "ok")

	self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_SEND_STAR_VOICE_REQ",nCmdSequence)
end

function tbIDIPInterface:IDIP_DO_ITEM_SWITCH_REQ(nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	}
	local szItemId = tostring(tbReq.ItemId)
	local nSwitch = tonumber(tbReq.Switch) or -1
	if (nSwitch ~= 0 and nSwitch ~= 1) or Lib:IsEmptyStr(szItemId) then
		tbRsp.Result = IDIP_INVALID_PARAM
		tbRsp.RetMsg = ErrInvalidParam
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_ITEM_SWITCH_REQ", nCmdSequence)
		return
	end
	local nItemId = tonumber(szItemId) or -1
	local tbItemList = {}
	local tbItem = {}
	if nItemId == 0 then
		tbItem = 0
	else
		if MarketStall.bAllForbidden and nSwitch == 1 then
			tbRsp.Result = IDIP_MARKETSTALL_HAD_ALL_FORBIDDEN
			tbRsp.RetMsg = ErrMarketStallHadAllForbidden
			self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_ITEM_SWITCH_REQ", nCmdSequence)
			return
		end
		tbItemList = Lib:SplitStr(szItemId, ";")
		for i, szId in ipairs(tbItemList) do
			local nId = tonumber(szId)
			if not KItem.GetItemBaseProp(nId) then
				tbRsp.Result = IDIP_INVALID_PARAM
				tbRsp.RetMsg = ErrInvalidParam
				self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_ITEM_SWITCH_REQ", nCmdSequence)
				return
	...
	MarketStall:SetForbidden(tbItem, nSwitch == 0 and true or false)

	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0,0, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
	        tbReq.Partition, 0, 0, "IDIP_DO_ITEM_SWITCH_REQ", szItemId, nItemId, nSwitch)

	self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_ITEM_SWITCH_REQ", nCmdSequence)
end

function tbIDIPInterface:IDIP_DO_AUTION_SWITCH_REQ(nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	}
	local nKind = tbReq.Kind or -1
	local tbKind = AllAuctionShutDownTypeRef[nKind]
	local nSwitch = tonumber(tbReq.Switch) or -1
	if (nSwitch ~= 0 and nSwitch ~= 1) or not tbKind then
		tbRsp.Result = IDIP_INVALID_PARAM
		tbRsp.RetMsg = ErrInvalidParam
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_ITEM_SWITCH_REQ", nCmdSequence)
		return
	...
	if nSwitch == 0 then
		Kin.Auction:ForbidAuctionByTypes(tbKind);
	elseif nSwitch == 1 then
		Kin.Auction:ClearAuctionForbidden(tbKind);
	end
	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0,0, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
	        tbReq.Partition, 0, 0, "IDIP_DO_AUTION_SWITCH_REQ", nKind, nSwitch)

	self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_AUTION_SWITCH_REQ",nCmdSequence)
end

function tbIDIPInterface:IDIP_DO_FRIEND_LIST_REQ(nCmdId, tbReq,nCmdSequence)
	Player:DoAccountRoleMatchRequest(tbReq.OpenId,tbReq.RoleId,Transmit.tbIDIPInterface.OnDoQueryFriendListReq,Transmit.tbIDIPInterface,nCmdId,tbReq,nCmdSequence);
end

function tbIDIPInterface:OnDoQueryFriendListReq(szAccount, dwPlayerId, nIsMatch, nCmdId, tbReq, nCmdSequence, bNoLoad)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	...
	if nIsMatch == 0 then
		tbRsp.Result = IDIP_PLAYER_NOT_EXIST;
		tbRsp.RetMsg = ErrInValidAccountRoleIdNotMatch;
		self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_FRIEND_LIST_REQ", nCmdSequence)
		return
	end
	local tbAllFriends, nCount = KFriendShip.GetFriendList(dwPlayerId)
	if not nCount and not bNoLoad then
		self.tbFriendData[dwPlayerId] = {szAccount = szAccount, nCmdId = nCmdId, tbReq = tbReq, nCmdSequence = nCmdSequence}
		KFriendShip.LoadFriendList(dwPlayerId)
	else
		local tbFriendInfo = {}
		for dwID, nImity in pairs(tbAllFriends) do
			local pStayInfo = KPlayer.GetRoleStayInfo(dwID)
			if pStayInfo then
				table.insert(tbFriendInfo, {dwID = dwID, szAccount = pStayInfo.szAccount, nImity = nImity})
			end
		end
		Lib:SortTable(tbFriendInfo, function (a, b) return a.nImity > b.nImity end)
		for i = 1, 10 do
			if tbFriendInfo[i] then
				table.insert(tbRsp.FriendList1, {RoleId = tbFriendInfo[i].dwID, OpenId = tbFriendInfo[i].szAccount})
			end
		end
		tbRsp.FriendList1_count = #tbRsp.FriendList1
		TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0,0, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		        tbReq.Partition, tbReq.RoleId, 0, "IDIP_DO_FRIEND_LIST_REQ")

		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_FRIEND_LIST_REQ", nCmdSequence)
	end
end

function tbIDIPInterface:DoLoadFriendList(dwPlayerId)
	local tbData = self.tbFriendData[dwPlayerId]
	if tbData then
		self:OnDoQueryFriendListReq(tbData.szAccount, dwPlayerId, 1, tbData.nCmdId, tbData.tbReq, tbData.nCmdSequence, true)
		self.tbFriendData[dwPlayerId] = nil
	end
end

function tbIDIPInterface:IDIP_DO_USER_TO_JAIL_REQ(nCmdId, tbReq, nCmdSequence)
	Player:DoAccountRoleMatchRequest(tbReq.OpenId, tbReq.RoleId, Transmit.tbIDIPInterface.OnDoUserToJailReq, Transmit.tbIDIPInterface, nCmdId, tbReq, nCmdSequence);
end

function tbIDIPInterface:OnDoUserToJailReq(szAccount, dwPlayerId, nIsMatch, nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	...
	if nIsMatch == 0 then
		tbRsp.Result = IDIP_PLAYER_NOT_EXIST;
		tbRsp.RetMsg = ErrInValidAccountRoleIdNotMatch;
		self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_USER_TO_JAIL_REQ", nCmdSequence)
		return
	end
	local nTime = tonumber(tbReq.Time) or 0
	local nNowTime = GetTime()
	local nEndTime = nNowTime + nTime
	local szReason = tbReq.Reason
	...
	local pPlayer = KPlayer.GetPlayerObjById(dwPlayerId);
	if pPlayer then
		self:PushPlayer2Jail(pPlayer, nEndTime, szReason)
	else
		local pPlayerInfo = KPlayer.GetRoleStayInfo(dwPlayerId);
		if pPlayerInfo then
			local szCmd = string.format("Transmit.tbIDIPInterface:PushPlayer2Jail(me, %d, %s)", nEndTime, szReason);
			KPlayer.AddDelayCmd(tbReq.RoleId,
				szCmd,
				string.format("%s|%d|%s|%s", 'IDIP_DO_REIKI_VALUE_REQ', nEndTime, tbReq.Source or "nil", tbReq.Serial or "nil"))
		else
			tbRsp.Result = IDIP_PLAYER_NOT_EXIST
			tbRsp.RetMsg = ErrPlayerNotExist
			self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_REIKI_VALUE_REQ", nCmdSequence)
	...
	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0, tbReq.Value, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		tbReq.Partition, tbReq.RoleId, 0, "IDIP_DO_REIKI_VALUE_REQ", (pPlayer and "immediately") or "delay", nTime, nEndTime, szReason)

	self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_REIKI_VALUE_REQ", nCmdSequence)

end

function tbIDIPInterface:PushPlayer2Jail(pPlayer, nEndTime, szReason)
	local nNowTime = GetTime()
	if nEndTime <= nNowTime then
		Log("[tbIDIPInterface] fnPushPlayer2Jail overdue", pPlayer.dwID, pPlayer.szName, nEndTime, szReason)
		return
	end
	pPlayer.PushToPrison(nEndTime)
	Map:CheckPushToPrison(pPlayer)
	if pPlayer.IsInPrison() then
		local pNpc = pPlayer.GetNpc()
	  	if pNpc then
	  		local nLeftTime = pPlayer.GetPrisonLeftTime();
			pNpc.AddSkillState(Player.PRISON_BUFF_ID, 1, 3, math.min(nLeftTime * Env.GAME_FPS, 2000000000), 1, 1);
		end
	end
	pPlayer.MsgBox(szReason, {{"确定"}});
end

function tbIDIPInterface:IDIP_QUERY_ROLE_ROOM_INFO_REQ(nCmdId, tbReq, nCmdSequence)
	Player:DoAccountRoleMatchRequest(tbReq.OpenId, tbReq.RoleId, Transmit.tbIDIPInterface.OnRoleRoomInfoCheckFinish, Transmit.tbIDIPInterface, nCmdId, tbReq, nCmdSequence);
end

function tbIDIPInterface:OnRoleRoomInfoCheckFinish(szAccount, dwPlayerId, nIsMatch, nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	...
	if nIsMatch == 0 then
		tbRsp.Result = IDIP_PLAYER_NOT_EXIST;
		tbRsp.RetMsg = ErrInValidAccountRoleIdNotMatch;
		self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_QUERY_ROLE_ROOM_INFO_REQ", nCmdSequence)
		return
	end
	local pStayInfo = KPlayer.GetRoleStayInfo(dwPlayerId)
	if not pStayInfo then
	...
	local nType = tonumber(tbReq.Type) or 0 				-- 1 点赞，2 送一见倾心，3送浓情蜜意，4 送真爱告白(点赞操作玩家点赞成就加一，任何一种操作玩家人气值加一)
	local nScrore = tonumber(tbReq.Scrore) or 0 			-- 只作用于送礼行为（点赞默认加1）
	local nPlayerType = tonumber(tbReq.PlayerType) or 0 	-- 玩家操作类型 1 发送者 2 接收者
	if (nScrore <= 0 and nType ~= self.Type_Achi_Zan) or (nPlayerType ~= 1 and nPlayerType ~= 2) then
		tbRsp.Result = IDIP_INVALID_PARAM
		tbRsp.RetMsg = ErrInvalidParam
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_QUERY_ROLE_ROOM_INFO_REQ", nCmdSequence)
		return
	end
	if nType == self.Type_Achi_Zan then
		-- 点赞者增加点赞数
		if nPlayerType == 1 then
			Achievement:AddCount(dwPlayerId, "IDIPZan_1", 1)
		elseif nPlayerType == 2 then
			-- 被点赞者增加人气值
			Achievement:AddCount(dwPlayerId, "IDIPPopularity_1", 1)
		end
	elseif nType == self.Type_Achi_Gift1 or nType == self.Type_Achi_Gift2 or nType == self.Type_Achi_Gift3 then
		-- 被送礼物者增加人气值
		if nPlayerType == 2 then
			Achievement:AddCount(dwPlayerId, "IDIPPopularity_1", nScrore)
		end
	else
		tbRsp.Result = IDIP_INVALID_PARAM
		tbRsp.RetMsg = ErrInvalidParam
	...
	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0, tbReq.Value, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		tbReq.Partition, tbReq.RoleId, 0, "IDIP_QUERY_ROLE_ROOM_INFO_REQ", nPlayerType, nType, nScrore)

	self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_QUERY_ROLE_ROOM_INFO_REQ", nCmdSequence)
end

function tbIDIPInterface:IDIP_DO_ITME_PARAMETER_REQ(nCmdId, tbReq, nCmdSequence)
	Player:DoAccountRoleMatchRequest(tbReq.OpenId, tbReq.RoleId, Transmit.tbIDIPInterface.OnItmeParameterCheckFinish, Transmit.tbIDIPInterface, nCmdId, tbReq, nCmdSequence);
end

function tbIDIPInterface:OnItmeParameterCheckFinish(szAccount, dwPlayerId, nIsMatch, nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	...
	if nIsMatch == 0 then
		tbRsp.Result = IDIP_PLAYER_NOT_EXIST;
		tbRsp.RetMsg = ErrInValidAccountRoleIdNotMatch;
		self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_ITME_PARAMETER_REQ", nCmdSequence)
		return
	end
	local szParameter = tbReq.Parameter
	if Lib:IsEmptyStr(szParameter) then
		tbRsp.Result = IDIP_INVALID_PARAM
		tbRsp.RetMsg = ErrInvalidParam
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_ITME_PARAMETER_REQ", nCmdSequence)
		return
	...
	local pPlayer = KPlayer.GetPlayerObjById(dwPlayerId);
	if pPlayer then
		local pItem = self:DoAddItemByStr(pPlayer, szParameter)
		if not pItem then
			tbRsp.Result = IDIP_INVALID_PARAM
			tbRsp.RetMsg = ErrInvalidParam
			self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_ITME_PARAMETER_REQ", nCmdSequence)
		...
		local pPlayerInfo = KPlayer.GetRoleStayInfo(dwPlayerId);
		if pPlayerInfo then
			local szCmd = string.format("Transmit.tbIDIPInterface:DoAddItemByStr(me, '%s')", szParameter);
			KPlayer.AddDelayCmd(dwPlayerId,
				szCmd,
				string.format("%s|%s|%s|%s", 'IDIP_DO_ITME_PARAMETER_REQ', szParameter, tbReq.Source or "nil", tbReq.Serial or "nil"))
		else
			tbRsp.Result = IDIP_PLAYER_NOT_EXIST
			tbRsp.RetMsg = ErrPlayerNotExist
			self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_ITME_PARAMETER_REQ", nCmdSequence)
	...
	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0, tbReq.Value, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		tbReq.Partition, tbReq.RoleId, 0, "IDIP_DO_ITME_PARAMETER_REQ", szParameter)

	self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_ITME_PARAMETER_REQ", nCmdSequence)
end

function tbIDIPInterface:DoAddItemByStr(pPlayer, szParameter)
	local pItem = pPlayer.AddItemByString(szParameter, Env.LogWay_IDIPAddItemByStr)
	if not pItem then
		Log("[tbIDIPInterface] fnDoAddItemByStr fail", pPlayer.dwID, pPlayer.szName, szParameter)
	end
	return pItem
end

function tbIDIPInterface:IDIP_QUERY_SERVERLV_MAX_REQ(nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
		Serverlv = GetMaxLevel() or 0,
	}

	TLog("IDIPFLOW", tbReq.AreaId, 0, 0, tbReq.Value, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		tbReq.Partition, 0, 0, "IDIP_QUERY_SERVERLV_MAX_REQ")

	self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_QUERY_SERVERLV_MAX_REQ", nCmdSequence)
end


function tbIDIPInterface:IDIP_QUERY_ROLE_MAIL_MONEY_REQ(nCmdId, tbReq, nCmdSequence)
	...
	if not nRoleId and szRoleName == "" then
		tbRsp.Result = IDIP_PLAYER_NOT_EXIST
		tbRsp.RetMsg = ErrInValidRoleIdRoleNameNotMatch
		Log("IDIP_QUERY_ROLE_MAIL_MONEY_REQ =======not RoleID and not RoleName")
		self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_QUERY_ROLE_MAIL_MONEY_REQ",nCmdSequence)
		return
	end
	...
	if nRoleId and szRoleName ~= "" then
		if not self:CheckRoleIsFit(nRoleId,tbReq.RoleName) then
			tbRsp.Result = IDIP_PLAYER_NOT_EXIST
			tbRsp.RetMsg = ErrInValidRoleIdRoleNameNotMatch
			Log("IDIP_QUERY_ROLE_MAIL_MONEY_REQ ======= RoleID and RoleName not match", tbReq.RoleId, tbReq.RoleName)
			self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_QUERY_ROLE_MAIL_MONEY_REQ", nCmdSequence)
			return
		end
	end
	...
	Player:DoAccountRoleMatchRequest(tbReq.OpenId,nRoleId,Transmit.tbIDIPInterface.OnQueryRoleMailMoneyCheckFinish,Transmit.tbIDIPInterface,nCmdId,tbReq,nCmdSequence);
end

function tbIDIPInterface:OnQueryRoleMailMoneyCheckFinish(szAccount, dwPlayerId, nIsMatch,nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	...
	Mail:GetPLayerMailListInfo(dwPlayerId,Transmit.tbIDIPInterface.OnQueryRoleMailMoneyInfo,Transmit.tbIDIPInterface,nCmdId,tbReq,nCmdSequence)
end

function tbIDIPInterface:OnQueryRoleMailMoneyInfo(tbAllMails,nCmdId,tbReq,nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	...
	tbAllMails = tbAllMails or {}
	for _, v in pairs(tbAllMails) do
		local tbAttach = v.tbAttach or {}
		for _, j in pairs(tbAttach) do
			if j[1] == "Gold" or j[1] == "gold" then
				tbRsp.Money = tbRsp.Money + j[2]
			end
		end
	end
	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0, 0, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
	        tbReq.Partition, tbReq.RoleId, 0, "IDIP_QUERY_ROLE_MAIL_MONEY_REQ", tbReq.RoleName)

	self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_QUERY_ROLE_MAIL_MONEY_REQ", nCmdSequence)
end

function tbIDIPInterface:IDIP_QUERY_OPENID_ITME_NUM_REQ(nCmdId, tbReq, nCmdSequence)
	Player:DoAccountRoleMatchRequest(tbReq.OpenId, tbReq.RoleId, Transmit.tbIDIPInterface.OnQueryOpenIdItmeNumCheckFinish, Transmit.tbIDIPInterface, nCmdId, tbReq, nCmdSequence);
end

function tbIDIPInterface:OnQueryOpenIdItmeNumCheckFinish(szAccount, dwPlayerId, nIsMatch, nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	...
	if nIsMatch == 0 then
		tbRsp.Result = IDIP_PLAYER_NOT_EXIST;
		tbRsp.RetMsg = ErrInValidAccountRoleIdNotMatch;
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_QUERY_OPENID_ITME_NUM_REQ", nCmdSequence)
		return
	end
	local nItemId = tonumber(tbReq.ItemId) or 0
    if not KItem.GetItemBaseProp(nItemId) then
        tbRsp.Result = IDIP_INVALID_ITEM_ID;
        tbRsp.RetMsg = ErrInValidItemId;
        self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_QUERY_OPENID_ITME_NUM_REQ", nCmdSequence)
        return
    ...
    local nHave = pPlayer.GetItemCountInAllPos(nItemId) or 0;
    tbRsp.ItemNum = nHave
    TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0, 0, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
	        tbReq.Partition, tbReq.RoleId, 0, "IDIP_QUERY_OPENID_ITME_NUM_REQ", nHave)

	self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_QUERY_OPENID_ITME_NUM_REQ", nCmdSequence)
end

function tbIDIPInterface:IDIP_DO_VALUE_GAME_MONEY_REQ(nCmdId, tbReq, nCmdSequence)
	Player:DoAccountRoleMatchRequest(tbReq.OpenId, tbReq.RoleId, Transmit.tbIDIPInterface.OnDoValueGameMoneyCheckFinish, Transmit.tbIDIPInterface, nCmdId, tbReq, nCmdSequence);
end

function tbIDIPInterface:OnDoValueGameMoneyCheckFinish(szAccount, dwPlayerId, nIsMatch, nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	...
	if nIsMatch == 0 then
		tbRsp.Result = IDIP_PLAYER_NOT_EXIST;
		tbRsp.RetMsg = ErrInValidAccountRoleIdNotMatch;
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_VALUE_GAME_MONEY_REQ", nCmdSequence)
		return
	end
	local _, tbRunning = Activity:GetActivityData()
	local tbAct = tbRunning["GoodVoice"] and tbRunning["GoodVoice"].tbInst
	if not tbAct then
		tbRsp.Result = IDIP_ACTIVITY_NOT_START
		tbRsp.RetMsg = ErrActivityNotStart
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_VALUE_PRETTY_PINK_REQ", nCmdSequence)
	...
	local nItemId = tbAct.VOTE_ITEM or 0
	if not KItem.GetItemBaseProp(nItemId) then
        tbRsp.Result = IDIP_INVALID_ITEM_ID;
        tbRsp.RetMsg = ErrInValidItemId;
        self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_QUERY_OPENID_ITME_NUM_REQ", nCmdSequence)
   ...
   local pPlayerInfo = KPlayer.GetRoleStayInfo(dwPlayerId);
	...
	local nValue = tonumber(tbReq.Value) or 0
	if nValue <= 0 then
		tbRsp.Result = IDIP_INVALID_PARAM;
		tbRsp.RetMsg = ErrInvalidParam;
		self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_QUERY_OPENID_ITME_NUM_REQ", nCmdSequence)
	...
	local nCurCount = pPlayer.GetItemCountInAllPos(nItemId)
	local nNeedCount = math.min(nCurCount, nValue)

	local nDelCount = 0
	if nNeedCount ~= 0 then
		nDelCount = pPlayer.ConsumeItemInAllPos(nItemId, nNeedCount, Env.LogWay_BeautyPageant_Vote);
	end
	...
	pPlayer.Msg(string.format("消耗了%d个桃花笺进行投票！", nDelCount))
...
function tbIDIPInterface:IDIP_DO_NOTICE_GOOD_VOICE_SUCCES_REQ(nCmdId, tbReq, nCmdSequence)
	Player:DoAccountRoleMatchRequest(tbReq.OpenId, tbReq.RoleId, Transmit.tbIDIPInterface.OnDoNoticeBellCheckFinish, Transmit.tbIDIPInterface, nCmdId, tbReq,nCmdSequence);
end
...
function tbIDIPInterface:OnDoNoticeBellCheckFinish(szAccount, dwPlayerId, nIsMatch, nCmdId, tbReq, nCmdSequence)
	...
	if nIsMatch == 0 then
		tbRsp.Result = IDIP_PLAYER_NOT_EXIST;
		tbRsp.RetMsg = ErrInValidAccountRoleIdNotMatch;
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_NOTICE_GOOD_VOICE_SUCCES_REQ", nCmdSequence)
		return
	end
	...
	local nKinds = tonumber(tbReq.Kinds)
	local nStateType = self.tbAllGoodVoiceSignUpType[nKinds]

	if not nStateType then
		tbRsp.Result = IDIP_INVALID_PARAM;
		tbRsp.RetMsg = ErrInvalidParam;
		self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_NOTICE_GOOD_VOICE_SUCCES_REQ", nCmdSequence)
		return
	...
	tbAct:OnSignUp(nStateType, dwPlayerId);

	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0, 0, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		tbReq.Partition, tbReq.RoleId, 0, "IDIP_DO_NOTICE_GOOD_VOICE_SUCCES_REQ", nStateType)

	self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_NOTICE_GOOD_VOICE_SUCCES_REQ", nCmdSequence)
end

function tbIDIPInterface:IDIP_DO_SEND_GOOD_VOICE_WIN_REQ(nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result 	= IDIP_SUCCESS,
		RetMsg 	= "ok",
	...
	if not tbAct then
		tbRsp.Result = IDIP_ACTIVITY_NOT_START
		tbRsp.RetMsg = ErrActivityNotStart
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_SEND_GOOD_VOICE_WIN_REQ", nCmdSequence)
		return
	end
	...
	if nFaction <= 0 or nFaction > Faction.MAX_FACTION_COUNT or
	 not tbAct.tbAllWinnerType then
		tbRsp.Result = IDIP_INVALID_PARAM
		tbRsp.RetMsg = ErrInvalidParam
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_SEND_GOOD_VOICE_WIN_REQ", nCmdSequence)
		return
	...
	tbAct:OnWinnerResult(nWinnerType, tonumber(tbReq.BePartition), tbReq.Name,
				 tonumber(tbReq.RoleId), tbReq.RoleName, nFaction,
				 tonumber(tbReq.ClothesId) or 0,  tonumber(tbReq.ItemId) or 0, tbReq.OpenId, tonumber(tbReq.TireId) or 0, tonumber(tbReq.Sex));

	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, nWinnerType, nFaction, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		tbReq.Partition, tbReq.RoleId, tbReq.BePartition, tbReq.RoleName, tbReq.ClothesId, tbReq.ItemId, tostring(tbReq.TireId), tbReq.Name, tbReq.OpenId,
		"IDIP_DO_SEND_GOOD_VOICE_WIN_REQ")

	self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg, "IDIP_DO_SEND_GOOD_VOICE_WIN_REQ", nCmdSequence)
end

function tbIDIPInterface:IDIP_DO_SEND_VOTES_REQ(nCmdId, tbReq, nCmdSequence)
	Player:DoAccountRoleMatchRequest(tbReq.OpenId, tbReq.RoleId, Transmit.tbIDIPInterface.OnDoSendVotesCheckFinish, Transmit.tbIDIPInterface, nCmdId, tbReq,nCmdSequence);
end

function tbIDIPInterface:OnDoSendVotesCheckFinish(szAccount, dwPlayerId, nIsMatch, nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	...
	if nIsMatch == 0 then
		tbRsp.Result = IDIP_PLAYER_NOT_EXIST;
		tbRsp.RetMsg = ErrInValidAccountRoleIdNotMatch;
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_SEND_VOTES_REQ", nCmdSequence)
		return
	end
	...
	local nNum = tonumber(tbReq.Num)
	if not tbAct.tbRankGetCount[nNum] then
		tbRsp.Result = IDIP_INVALID_PARAM
		tbRsp.RetMsg = ErrInvalidParam
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_SEND_VOTES_REQ", nCmdSequence)
		return
	...
	tbAct:OnRankGetResult(dwPlayerId, nNum)

	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0, 0, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		tbReq.Partition, tbReq.RoleId, 0, "IDIP_DO_SEND_VOTES_REQ", nNum)

	self:IDIPDelayResponse(tbRsp.Result,tbRsp,tbRsp.RetMsg,"IDIP_DO_SEND_VOTES_REQ", nCmdSequence)
end

function tbIDIPInterface:IDIP_DO_USER_RANK_NUM_REQ(nCmdId, tbReq, nCmdSequence)
	Player:DoAccountRoleMatchRequest(tbReq.OpenId, tbReq.RoleId, Transmit.tbIDIPInterface.OnDoUserRankNumCheckFinish, Transmit.tbIDIPInterface, nCmdId, tbReq,nCmdSequence);
end

function tbIDIPInterface:OnDoUserRankNumCheckFinish(szAccount, dwPlayerId, nIsMatch, nCmdId, tbReq, nCmdSequence)
	local tbRsp =
	{
		Result = IDIP_SUCCESS,
		RetMsg = "ok",
	...
	if nIsMatch == 0 then
		tbRsp.Result = IDIP_PLAYER_NOT_EXIST;
		tbRsp.RetMsg = ErrInValidAccountRoleIdNotMatch;
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_USER_RANK_NUM_REQ", nCmdSequence)
		return
	end
	...
	local nRank = tonumber(tbReq.Ranking)
	if not tbAct.tbVoteRankAward[nRank] then
		tbRsp.Result = IDIP_INVALID_PARAM
		tbRsp.RetMsg = ErrInvalidParam
		self:IDIPDelayResponse(tbRsp.Result, tbRsp, tbRsp.RetMsg, "IDIP_DO_USER_RANK_NUM_REQ", nCmdSequence)
		return
	...
	tbAct:OnSendVoteRankResult(dwPlayerId, nRank)

	TLog("IDIPFLOW", tbReq.AreaId, tbReq.OpenId, 0, 0, tbReq.Serial, tbReq.Source, nCmdId, tbReq.PlatId,
		tbReq.Partition, tbReq.RoleId, 0, "IDIP_DO_USER_RANK_NUM_REQ", nRank)
