...
function ScheduleTask:SendNewInfomation(szTitle, szKey, szContent, szEndTimeFrame, nEndDay)
	nEndDay = tonumber(nEndDay) or 1;
	local _, nValidTime = TimeFrame:CalcRealOpenDay(szEndTimeFrame, nEndDay);
	szKey = "__SendNewInfomation__" .. szKey;
	NewInformation:AddInfomation(szKey, nValidTime, {szContent}, {szTitle = szTitle});
end
