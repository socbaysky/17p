...
ScriptData.tbUseScriptDataDef =
{
	...
	["JingMai"]				= 1,				-- 经脉
	["RobClueCount"]  		= 1, 				-- 国庆节被抢夺次数， 跨天时清空
	["WuLinDaShiMapInfo"]   = 1,				-- 武林大事地图信息
	["MarketStallWarningMailTime"] = 1,			-- 摆摊上次发送非法交易警告邮件时间
	["MarketStallLimit"] = 1,					-- 摆摊限制信息
	["NewYearChrisWishes"] = 1,					-- 双旦活动许愿

	["DomainBattleCross"] = 1,			--跨服城战
	["GlobalMailTimeLimit"] = 1, 		--限制登录时间的全局邮件
	["GoodVoiceAct"] = 1, 				-- 剑侠好声音
	["WorldCupGuessAct"]           = 1,			--世界杯竞猜
}
