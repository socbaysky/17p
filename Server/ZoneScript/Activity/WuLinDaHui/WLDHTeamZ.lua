...
function WuLinDaHui:SendFightTeamDataFromZC(tbTeamSaveData, nFightTeamID, nServerId, szServerName, nFinalMatchPos, bSynFinalTeamEnd)
    --一个坑是因为本服上存的决赛战队id是新生成的，战队id对应的game type 值是4+nType的。为了存盘需要
    Log("WuLinDaHui:SendFightTeamDataFromZC==", nFightTeamID, nServerId, szServerName, nFinalMatchPos, bSynFinalTeamEnd);
    ...
    tbTeamSaveData[HuaShanLunJian.tbDef.nTeamTypeServerIdx] = nServerId;
